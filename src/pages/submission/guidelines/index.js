...
const Guidelines = () => {
  return (
    <PageContain title="Submission and Proceedings Guidelines">
      ...
      <h2 className="mt-4">Your paper should contain the following elements</h2>
      <h3>1. Title</h3>
      <p>The title should reflect the content of the paper. Avoid fancy or clever titles and do not capitalize each word.</p>

      <h3>2. Authors</h3>
      <p>List all contributing authors with full first and last names. Avoid "et al." in the heading.</p>

      <h3>3. Affiliations/Addresses and Email Addresses</h3>
      <p>Use superscript numbers to link authors to their affiliations. Provide at least one affiliation and email address.</p>

      <h3>4. Abstract</h3>
      <p>Provide a brief summary (5-15 lines) of the paper including its main focus, results, and conclusions.</p>

      <h3>5. Introduction</h3>
      <p>Introduce the subject, provide context, and state the aims of the paper.</p>

      <h3>6. Technical/Detailed Sections</h3>
      <p>Use clear section headings and subsections where necessary. Avoid unnecessary sub-subsections.</p>

      <h3>7. Concluding Section(s)</h3>
      <p>Summarize the results, discuss their implications, and optionally mention future work.</p>

      <h3>8. Acknowledgments</h3>
      <p>Optionally, thank contributors or institutions. Mention project sponsorships here.</p>

      <h3>9. References</h3>
      <p>Ensure every reference cited in the text is included. Use the following formats:</p>
      <ul>
        <li><strong>Journals:</strong> Asher D. J., Arlt R., and Brown P. (2010). “Title of the paper”. Name of the Journal, 27, 32–35.</li>
        <li><strong>Books:</strong> Arlt R. and Rendtel J. (2011). <em>Name of the Book</em>. Publisher Name.</li>
        <li><strong>Proceedings:</strong> Brown P. (2013). “Title”. In Rault J.-L. and Perlerin V., editors, <em>Proceedings of the Name of the Conference</em>, Giron, France, 12-15 October 2014. Publisher Name, pages 124–128.</li>
      </ul>
      <p>Avoid URLs in the reference list as they can become obsolete.</p>

      <h3>10. Figures</h3>
      <p>Figures must be numbered and referenced in the text. Provide captions explaining them.</p>

      <h3>11. Tables</h3>
      <p>Tables must be numbered and referenced in the text. Captions should appear above the table.</p>

      <h3>12. Responsibility of the Author(s)</h3>
      <p>Authors retain copyright. The editors will assist with corrections, but final responsibility lies with the authors.</p>
    </PageContain>
  );
};
