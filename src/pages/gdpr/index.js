  ...
  return (
    <PageContain title="Data Protection and Privacy">
      <div className="mx-md-3">
        ...
        <ul>
          <li className="mb-2">
            The data provided in the registration form, as well as the data updated or added later, provided in connection with your registration for this IMC, and information about the payment of your registration fee are collected and processed solely for the purpose of administering your IMC registration, the proper organization of the conference, informing you about future editions, and making anonymous statistical analyses useful for future IMC organizers. For this, we seek your consent, which is also the legal basis for the processing of your personal data.
          </li>
          <li className="mb-2">
            Your personal data will be disclosed to IMO officers in charge of administering IMC registrations, composing the program of the conference, and editing the proceedings, all acting under the authority of the IMO, with exception of your first and last name, affiliation, and country, which are shown in the participants' list at the <a href='https://www.imo.net' target='_blank' rel='noopener noreferrer'>IMC website</a> Your personal data will also be provided to the local organization, as mentioned on the <a href='https://www.imo.net' target='_blank' rel='noopener noreferrer'>IMC website</a>, for the proper logistic organization of the conference. This may mean that your personal data is transferred to a third country
          </li>
          <li className="mb-2">
            If, for whichever reason, the registration is not accepted by the LOC, all data pertaining to it will be erased. Otherwise, they will be stored for at most ten years.
            You have full access to the data you provided using a link sent to you via email upon registering, and can update or complete most of these data.
          ...
          <li className="mb-2">If you erase, or request the erasing of, personal data, services which depend on these data can and will no longer be provided. </li>
          <li className="mb-2">You have the right to lodge a complaint with a supervisory authority. </li> 
        </ul> 
      </div>
    </PageContain>
  );
