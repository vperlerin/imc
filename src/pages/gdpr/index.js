    ...
    <PageContain title="Data Protection and Privacy">
      <div className="mx-md-3">
        ...
        <ul>
          ...
          <li className="mb-2">
            Your personal data will be disclosed to IMO officers in charge of administering IMC registrations, composing the program of the conference, and editing the proceedings, all acting under the authority of the IMO, with exception of your first and last name, affiliation, and country, which are shown in the participants' list at the <a href='/' rel='noopener noreferrer'>IMC website</a> Your personal data will also be provided to the local organization, as mentioned on the  <a href='/' rel='noopener noreferrer'>IMC website</a>, for the proper logistic organization of the conference. This may mean that your personal data is transferred to a third country
          </li>
          <li className="mb-2">
