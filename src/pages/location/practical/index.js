    ...
    <PageContain title="Pratical Information">
      ...
      <div className="ps-md-3">
        ...
        <ul>
          ...
          <li>A warm coat, especially if you would like to take part in the astronomical observations planned for the evenings/nights, as the weather can be quite harsh, even in September</li>
        </ul>
        <p>
          Please check the{' '}
          <Link
...
{' '}
      ...
      <h3 className="mt-3">Power Sockets</h3>
      <div className="ps-md-3">
      ...
      <h3 className="mt-3">French People</h3>
