...
const Extra = () => {
  return (
    ...
    {/*
        ...
        <ul>
          <li className="mb-3">
            <a className="d-block fw-bolder" href="https://www.fletcherhotelhetwittehuis.nl/en/" target="_blank" rel="noopener noreferrer">Fletcher Hotel-Restaurant Het Witte Huis</a>
            Distance to conference venue 9 min by car, 15 min by bike
          </li>
          <li>
            <a className="d-block fw-bolder" href="https://www.hilton.com/nl/hotels/splsodi-doubletree-royal-parc-soestduinen/" target="_blank" rel="noopener noreferrer"> DoubleTree by Hilton Royal Parc Soestduinen</a>
