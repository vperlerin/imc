...
const routeConfig = [
  ...
  { path: "/admin/participants/online", element: <ProtectedRoute allowedRoles={["admin", "loc"]}><lazyPages.AdminParticipantsOnline /></ProtectedRoute> },
  { path: "/admin/participants/onsite", element: <ProtectedRoute allowedRoles={["admin", "loc"]}><lazyPages.AdminParticipantsOnsite /></ProtectedRoute> },
