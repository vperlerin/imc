...
const I=[{title:"Dashboard",link:"/admin/dashboard"},{title:"Participants",link:"/admin/participants",subLinks:[{title:"On-site",link:"/admin/participants/onsite",allowed:["loc"]},{title:"Online",link:"/admin/participants/online",allowed:["loc"]},{title:"Radio Workshop",link:"/admin/participants/workshops/radio",allowed:["loc"]},{title:"Spectro Workshop",link:"/admin/participants/workshops/spectro",allowed:["loc"]}],allowed:["loc"]},{title:"Contributions",link:"/admin/contributions",subLinks:[{title:"Talks",link:"/admin/contributions/talks",allowed:["loc","soc"]},{title:"Posters",link:"/admin/contributions/posters",allowed:["loc","soc"]}],allowed:["loc","soc"]},{title:"Accommodations",link:"/admin/accomodations",allowed:["loc"]},{title:"Downloads",link:"/admin/downloads",allowed:["loc","soc"]}];
// EXTERNAL MODULE: ./src/utils/event.js
var V=n(1280),P=n(1083);
// EXTERNAL MODULE: ./node_modules/axios/lib/axios.js + 48 modules
// ./src/admin/components/header/menu/index.js
const T=parseInt(u,10)||250,W=e=>{let{cd:t,isAdmin:n,isLoc:i,isSoc:s}=e;const[a,r]=(0,S.useState)(!1),[o,c]=(0,S.useState)(!0),d=(0,D/* useDispatch */.wA)(),u=(0,E/* useLocation */.zy)(),_=(0,E/* useNavigate */.Zp)(),[j,y]=(0,C.useSpring)((()=>({right:-T,config:{tension:350,friction:30}})));(0,S.useEffect)((()=>(a?(c(!1),y.start({right:0}),document.body.classList.add("overflow-hidden"),document.documentElement.classList.add("overflow-hidden")):(y.start({right:-T,onRest:()=>c(!0)}),document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")),()=>{document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")})),[a,y]),(0,S.useEffect)((()=>{const e=()=>{r(!1)};return window.addEventListener("resize",e),()=>{window.removeEventListener("resize",e)}}),[]);const k=()=>{r((e=>!e))},N=e=>{_(e),k()};
return(0,L.jsxs)(L.Fragment,{children:[(0,L.jsx)("button",{className:p,onClick:k,children:(0/* SlMenu */,L.jsx)(m.RAm,{className:x})}),!o&&(0,L.jsx)("div",{className:l()(f),onClick:k,onMouseDown:V/* onStopPropagation */._v,onTouchStart:V/* onStopPropagation */._v}),(0,L.jsx)(C.animated.div,{className:l()(b),style:j,children:(0,L.jsxs)("div",{className:l()(g,"d-flex flex-column h-100"),children:[(0,L.jsx)("button",{className:h,onClick:k,children:(0/* SlClose */,L.jsx)(m.ipV,{className:x})}),(0,L.jsxs)("div",{className:"mb-3",children:[(0,L.jsxs)("div",{className:"m-3 text-center",children:[(0,L.jsxs)("h4",{className:"fw-bolder m-0",children:["IMC ",t.year]}),(0,L.jsx)("small",{className:"m-0",children:"ADMIN AREA"})]}),I.map((e=>{const t=u.pathname.startsWith(e.link)||e.subLinks&&e.subLinks.some((e=>u.pathname.startsWith(e.link)));return n||i&&e?.allowed?.includes("loc")||s&&e?.allowed?.includes("soc")?// Hide the menu item if not allowed 
e.hideFromMenu?void 0:(0,L.jsx)(M,{className:"py-2",isLinkActive:t,goTo:N,title:e.title,url:e.link,children:e.subLinks&&(0,L.jsx)(L.Fragment,{children:e.subLinks.map((e=>{const t=u.pathname===e.link;
return(0/* Link */,L.jsx)(O.N_,{"aria-label":e.title,onClick:k,to:e.link,className:l()(t&&v),title:e.title,children:e.title},e.link)}))})},e.link):null}))]}),(0,L.jsx)("div",{className:l()(w,"mt-auto"),children:(0,L.jsxs)("div",{className:"d-flex flex-column justify-content-center mb-3 p-3 gap-2 px-4",children:[(0,L.jsx)("button",{"aria-label":"Public site",className:"btn btn-outline-success px-3 fw-bolder",onClick:()=>N("/"),title:"Public site",children:"Public site"}),(0,L.jsx)("button",{"aria-label":"Logout",className:"btn btn-outline-danger px-3 fw-bolder",onClick:async()=>{await P/* default */.A.get("https://imc2025.imo.net/php/auth/logout.php",{withCredentials:!0}),d($/* authActions */.I2.logout()),localStorage.removeItem("session"),_("/")},title:"Logout",children:"Logout"})]})})]})})]})};
// EXTERNAL MODULE: ./src/data/conference-data.js + 1 modules
var z=n(7762);// ./src/admin/components/header/index.js
const F=()=>{(0,E/* useNavigate */.Zp)();const e=`${z/* conferenceData */.p.name} ${z/* conferenceData */.p.year}`,t=(0/* authSelectors */,D/* useSelector */.d4)($.Pg.isAdmin),n=(0/* authSelectors */,D/* useSelector */.d4)($.Pg.isLoc),i=(0/* authSelectors */,D/* useSelector */.d4)($.Pg.isSoc);
return(0,L.jsxs)("div",{className:"d-flex align-items-center justify-content-between border-bottom",children:[(0,L.jsx)(W,{cd:z/* conferenceData */.p,isAdmin:t,isLoc:n,isSoc:i}),(0,L.jsx)("nav",{className:"p-0 flex-wrap","aria-label":"Main navigation",children:(0,L.jsx)("div",{className:l()(c,"d-flex flex-row flew-wrap px-2 mb-1 justify-content-between"),children:(0/* Link */,L.jsxs)(O.N_,{"aria-label":"Admin",className:l()("d-flex align-items-center text-dark text-decoration-none gap-2",d),to:"/admin/dashboard",title:"Admin",children:[(0,L.jsx)("img",{src:o,alt:e,className:"rounded-circle border border-2 p-1"}),(0,L.jsxs)("div",{className:"d-flex flex-column",children:[(0,L.jsxs)("h1",{className:"m-0 fw-bolder",children:[z/* conferenceData */.p.name," ",z/* conferenceData */.p.year]}),(0,L.jsx)("h2",{className:"m-0 d-none d-md-block",children:"ADMIN AREA"})]})]})})})]})};
/* harmony default export */
...
return(0,L.jsx)("nav",{"aria-label":"breadcrumb",className:U,children:(0,L.jsxs)("ol",{className:l()("breadcrumb"),children:[(0,L.jsx)("li",{className:"breadcrumb-item lh-0",children:(0/* Link */,L.jsx)(O.N_,{to:"/admin/dashboard",children:(0/* IoHomeOutline */,L.jsx)(R.M14,{className:"me-1"})})}),t.map(((e,n)=>(0,L.jsx)("li",{className:l()("breadcrumb-item",{active:n===t.length-1}),"aria-current":n===t.length-1?"page":void 0,children:n===t.length-1?(0,L.jsx)("b",{children:e.name}):(0/* Link */,L.jsx)(O.N_,{to:e.url,children:e.name})},n)))]})})},H=e=>{let{breadcrumb:t=[],title:n="",rightContent:r,children:o,isMaxWidth:c=!0}=e;const d=n?`${n} | ${z/* conferenceData */.p.name_display} ${z/* conferenceData */.p.year}`:`${z/* conferenceData */.p.name_display} ${z/* conferenceData */.p.year}`;
return(0,L.jsxs)(L.Fragment,{children:[(0/* Helmet */,L.jsxs)(q.mg,{children:[(0,L.jsx)("title",{children:d}),(0,L.jsx)("meta",{name:"robots",content:"noindex"})]}),(0,L.jsxs)("div",{className:l()(i,"position-relative"),children:[(0,L.jsx)(F,{}),(0,L.jsxs)("div",{className:"d-flex flex-row",children:[(0,L.jsx)(W,{cd:z/* conferenceData */.p}),(0,L.jsxs)("div",{className:l()("mx-md-4 my-3 h-100 flex-grow-1 d-flex flex-column px-3 px-md-0",{[`${a} mx-md-auto`]:c}),children:[0!==t.length&&(0,L.jsx)(B,{links:t}),(0,L.jsxs)("div",{className:l()("d-flex justify-content-between align-items-center",s),children:[n&&(0,L.jsx)("h2",{children:n}),r&&(0,L.jsx)("div",{children:r})]}),o]})]})]})]})}}
/***/,
/***/7762:
/***/(e,t,n)=>{
// EXPORTS
...
// EXTERNAL MODULE: ./node_modules/axios/lib/axios.js + 48 modules
var c=n(1083),d=n(7647),m=n(6645),u=n(6540),p=n(2199),h=n(7767),x=n(9785),b=n(7762),f=n(4493),g=n(4972),v=n(4976),w=n(847),_=n(3975),j=n(9156),y=n(5680),k=n(6538),N=n(5058),A=n(6827),S=n(4668),L=n(5846),M=n(4848);
...
// Detect form changes
// Detect form changes
(0,u.useEffect)((()=>{const e=oe((()=>{P(!0)}));return()=>e.unsubscribe()}),[oe]),(0,u.useEffect)((()=>{i||B(`/admin/participants/onsite/${n}/summary`,{replace:!0})}),[i,n,B]),(0,u.useEffect)((()=>{if(!X||0===J.length)return;
...
if(!await le())return E(!1),void $("Please fill in all required fields.");e.talks=se("talks")||[],e.posters=se("posters")||[];const t={...e,total_due:T,paypal_fee:z};try{const e=await c/* default */.A.post(`https://imc2025.imo.net/php/admin/api/update_${ce?"online":"onsite"}_participant.php?id=${n}`,t,{headers:{"Content-Type":"application/json"}});if(!e.data.success)throw new Error(e.data.message||"Failed to update participant.");R((e=>!e)),I("Participant updated successfully!")}catch(e){$(e.message)}finally{E(!1)}})),children:[(0,M.jsx)("ul",{className:s()("nav nav-tabs mb-3 mt-2",r,"flex-column flex-sm-row"),children:[{key:"summary",label:"Billing"},{key:"identity",label:"Identity"},{key:"workshops",label:"Workshops"},...ce?[]:[{key:"arrival",label:"Arrival"}],{key:"contribution",label:"Contribution"},...ce?[{key:"accommodation",label:"Pay. Method"}]:[{key:"accommodation",label:"Acc. & Pay. Method"}],...ce?[]:[{key:"extras",label:"Extras"}],{key:"comments",label:"Comments"},{key:"admin_notes",label:"Marc's notes"}].map((e=>{let{key:t,label:i}=e;
return(0,M.jsx)("li",{className:"nav-item",children:(0,M.jsx)("a",{className:s()("nav-link",U===t&&l),href:`/admin/participants/onsite/${n}/${t}`,onClick:e=>{e.preventDefault(),B(`/admin/participants/onsite/${n}/${t}`)},children:he&&"admin_notes"===t?(0,M.jsxs)("span",{className:"position-relative",children:[(0,M.jsx)("span",{className:"position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger",children:"!"}),i]}):(0,M.jsx)(M.Fragment,{children:i})})},t)}))}),(0,M.jsxs)("div",{className:s()("tab-content mx-auto",o),children:["identity"===i&&(0/* default */,M.jsx)(w.A,{isAdmin:!0,isOnline:ce,register:ne,errors:re,setValue:ae,trigger:le}),"workshops"===i&&(0/* default */,M.jsx)(_.A,{isAdmin:!0,isOnline:ce,conferenceData:b/* conferenceData */.p,register:ne,errors:re,setValue:ae,trigger:le,watch:oe,workshops:H}),"arrival"===i&&!ce&&(0/* default */,M.jsx)(j.A,{isAdmin:!0,conferenceData:b/* conferenceData */.p,register:ne,errors:re,setValue:ae,trigger:le}),"contribution"===i&&(0/* default */,M.jsx)(y.A,{isAdmin:!0,isOnline:ce,conferenceData:b/* conferenceData */.p,control:te,register:ne,errors:re,getValues:se,setValue:ae,watch:oe,trigger:le,sessions:J}),"accommodation"===i&&(0/* default */,M.jsx)(k.A,{isAdmin:!0,isOnline:ce,isEarlyBird:X?.participant.is_early_bird,conferenceData:b/* conferenceData */.p,control:te,register:ne,errors:re,paymentMethods:Y,setValue:ae,registrationTypes:Z,trigger:le}),"extras"===i&&!ce&&(0/* default */,M.jsx)(N.A,{isAdmin:!0,conferenceData:b/* conferenceData */.p,register:ne,errors:re,getValues:se,setValue:ae,trigger:le,watch:oe,control:te}),"comments"===i&&(0,M.jsx)("div",{className:s()(a,"mx-auto"),children:(0/* default */,M.jsx)(A.A,{isAdmin:!0,isOnline:ce,register:ne,errors:re,setValue:ae,trigger:le})}),(0,M.jsxs)("div",{className:s()(a,"mx-auto","summary"===i&&pe?"visible":"invisible h-0 w-0 overflow-hidden"),children:[(0,M.jsxs)("div",{className:"d-flex mt-3 align-items-center justify-content-between w-100 mb-3",children:[(0,M.jsxs)("div",{children:[(0,M.jsxs)("strong",{children:[X?.participant?.first_name?X.participant.first_name.charAt(0).toUpperCase()+X.participant.first_name.slice(1):""," ",X?.participant?.last_name||""]})," ","1"===X.participant.confirmation_sent?(0,M.jsxs)(M.Fragment,{children:["has been confirmed on ",(0,M.jsx)("span",{className:"text-success",children:X.participant.confirmation_date&&(0,L/* formatFullDate */.Lu)(X.participant.confirmation_date)})]}):(0,M.jsx)(M.Fragment,{children:"❌  has NOT been confirmed yet."})]}),"1"!==X.participant.confirmation_sent&&(0,M.jsx)("div",{children:(0/* Link */,M.jsx)(v.N_,{className:"btn btn-outline-success fw-bolder",to:`/admin/participants/${ce?"online":"onsite"}/payment/${n}`,children:"Go to Payments to confirm"})})]}),(0/* default */,M.jsx)(S.A,{isAdmin:!0,isOnline:ce,isEarlyBird:X?.participant.is_early_bird,conferenceData:b/* conferenceData */.p,getValues:se,setValue:ae,setTotal:W,setPaypalFee:F,workshops:H,registrationTypes:Z,paymentMethods:Y,watch:oe})]}),"admin_notes"===i&&(0,M.jsxs)("div",{className:s()(a,"mx-auto mb-3"),children:[(0,M.jsx)("label",{htmlFor:"admin_notes",className:"form-label fw-bold",children:"Admin Notes"}),(0,M.jsx)("textarea",{id:"admin_notes",className:"form-control",placeholder:"Enter your admin notes here",rows:6,...ne("admin_notes")}),re.admin_notes&&(0,M.jsx)("div",{className:"text-danger mt-1",children:re.admin_notes.message})]}),(0,M.jsx)("div",{className:"mt-4 d-flex justify-content-end",children:(0,M.jsx)("button",{type:"submit",className:"btn btn-outline-primary fw-bolder",disabled:D,children:D?"Saving...":"Save Changes"})})]})]})]})};
/* harmony default export */}
/***/}]);