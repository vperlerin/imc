...
// Detect form changes
// Detect form changes
(0,d.useEffect)((()=>{const e=oe((()=>{I(!0)}));return()=>e.unsubscribe()}),[oe]),(0,d.useEffect)((()=>{const e=Number.isInteger(Number(t))&&Number(t)>0;!n&&e&&W(`/admin/participants/onsite/edit/${t}/summary`,{replace:!0})}),[n,t,W]),(0,d.useEffect)((()=>{if(!J||0===H.length)return;const{accommodation:e,arrival:t,contributions:n,extra_options:i,food_other_text:a,food_restrictions:s,participant:r,workshops:o}=J||{},l={},c=r?.dob;if(c){const[e,t,n]=c.split("-");l.dobDay=String(Number(n)),l.dobMonth=String(Number(t)),l.dobYear=e}
