...
/* harmony import */const i={xls:(0/* .FaFileExcel */,n.jsx)(s.Ru,{})},r=e=>{let{link:a,className:t,format:s="xls",title:r="Download"}=e;return a.startsWith("/php/")?(0,n.jsxs)("a",{href:a,className:`btn btn-outline-success d-inline-flex align-items-center gap-2 ${t}`,"aria-label":`Download ${r} in ${s.toUpperCase()} format`,children:[i[s]||null," ",r]}):(0/* .Link */,n.jsxs)(l.N_,{className:`btn btn-outline-success d-inline-flex align-items-center gap-2 ${t}`,to:a,"aria-label":`Download ${r} in ${s.toUpperCase()} format`,children:[i[s]||null," ",r]})}}
/***/}]);