...
const m=e=>{let{typeFilter:t=""}=e;const[s,m]=(0,l.useState)(t||"not_no"),[u,p]=(0,l.useState)(""),[h,x]=(0,l.useState)(null),[b,f]=(0,l.useState)("asc"),{participants:j,loading:g,error:v}=(e=>{const[t,s]=(0,l.useState)([]),[a,n]=(0,l.useState)(!0),[i,c]=(0,l.useState)(null);return(0,l.useEffect)((()=>{if(!e)return n(!1),void c("Type filter is required ('no' or 'not_no').");(async()=>{try{const t=await(0,o/* retry */.L)((()=>r/* default */.A.get("https://imc2025.imo.net/php/api/get_accomodations.php",{params:{type:e}})));if(!t.data.success||!Array.isArray(t.data.data))throw new Error(t.data.message||"Database access error, please try again.");s(t.data.data)}catch(e){c(e.message||"Failed to fetch participants. Please refresh the page.")}finally{n(!1)}})()}),[e]),{participants:t,loading:a,error:i,setParticipants:s}})(s),_="last_name",w=e=>{f(h===e&&"asc"===b?"desc":"asc"),x(e)},N=(0,l.useMemo)((()=>{let e=j?[...j]:[];
// Apply search filter
if(u){const t=u.toLowerCase();e=e.filter((e=>e[_]?.toLowerCase().includes(t)))}
// Apply sorting
return h&&e.sort(((e,t)=>{let s=e[h]??"",a=t[h]??"";
// Convert values properly for sorting
return"created_at"===h?(s=new Date(s).getTime()||0,a=new Date(a).getTime()||0):(s=s.toString().toLowerCase(),a=a.toString().toLowerCase()),"asc"===b?s.localeCompare(a):a.localeCompare(s)})),e}),[j,u,h,b]);
return(0/* default */,d.jsx)(n.A,{breadcrumb:[{url:"/admin/accommodations/",name:"Participants' Accommodations"}],isMaxWidth:!0,title:"Participants' Accommodations",children:g?(0/* default */,d.jsx)(i.A,{}):v?(0,d.jsxs)("p",{className:"text-danger",children:["Error: ",v]}):(0,d.jsxs)(d.Fragment,{children:[(0,d.jsxs)("div",{className:"d-flex flex-column flex-md-row gap-2 mb-3",children:[(0,d.jsxs)("div",{className:"position-relative w-auto",children:[(0,d.jsx)("input",{type:"text",className:"form-control pe-5",placeholder:`Enter ${_.replace("_"," ")}`,value:u,onChange:e=>p(e.target.value)}),(0/* CiSearch */,d.jsx)(a.Xj1,{className:"position-absolute top-50 end-0 translate-middle-y me-2"})]}),(0,d.jsxs)("select",{className:"form-select w-auto",value:s,onChange:e=>m(e.target.value),children:[(0,d.jsx)("option",{value:"not_no",children:"Staying at the hostel"}),(0,d.jsx)("option",{value:"no",children:"No Accommodation"})]}),(0/* default */,d.jsx)(c.A,{className:"ms-auto",link:`https://imc2025.imo.net/php/doc_accommodations.php?type=${s}`})]}),(0,d.jsx)("div",{className:"table-responsive",style:{maxWidth:"calc(100vw - 2rem)"},children:(0,d.jsxs)("table",{className:"table table-striped",children:[(0,d.jsx)("thead",{children:(0,d.jsxs)("tr",{children:[(0,d.jsx)("th",{onClick:()=>w("created_at"),children:"Reg. Date"}),(0,d.jsxs)("th",{className:"sortable",onClick:()=>w("last_name"),children:["Name ","last_name"===h&&("asc"===b?"🔼":"🔽")]}),(0,d.jsxs)("th",{className:"sortable",onClick:()=>w("description"),children:["Accommodation ","description"===h&&("asc"===b?"🔼":"🔽")]})]})}),(0,d.jsx)("tbody",{children:N.length>0?N.map((e=>(0,d.jsxs)("tr",{children:[(0,d.jsx)("td",{children:e.created_at?.split(" ")[0]||"n/a"}),(0,d.jsxs)("td",{children:[e.title," ",e.first_name," ",e.last_name]}),(0,d.jsx)("td",{children:e.registration_type||"n/a"})]},e.participant_id))):(0,d.jsx)("tr",{children:(0,d.jsx)("td",{colSpan:"5",className:"text-center",children:"No participants found."})})})]})})]})})};
...
var A=s(8321),I=s(8983),E=s(1448),D=s(7767),T=s(4976);
...
const z=parseInt(u,10)||250,O=e=>{let{cd:t}=e;const[s,a]=(0,L.useState)(!1),[n,i]=(0,L.useState)(!0),l=(0,E/* useDispatch */.wA)(),r=(0,D/* useLocation */.zy)(),c=(0,D/* useNavigate */.Zp)(),[d,u]=(0,A.useSpring)((()=>({right:-z,config:{tension:350,friction:30}})));(0,L.useEffect)((()=>(s?(i(!1),u.start({right:0}),document.body.classList.add("overflow-hidden"),document.documentElement.classList.add("overflow-hidden")):(u.start({right:-z,onRest:()=>i(!0)}),document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")),()=>{document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")})),[s,u]),(0,L.useEffect)((()=>{const e=()=>{a(!1)};return window.addEventListener("resize",e),()=>{window.removeEventListener("resize",e)}}),[]);const _=()=>{a((e=>!e))},w=e=>{c(e),_()};
return(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)("button",{className:p,onClick:_,children:(0/* SlMenu */,S.jsx)(m.RAm,{className:x})}),!n&&(0,S.jsx)("div",{className:o()(f),onClick:_,onMouseDown:$/* onStopPropagation */._v,onTouchStart:$/* onStopPropagation */._v}),(0,S.jsx)(A.animated.div,{className:o()(b),style:d,children:(0,S.jsxs)("div",{className:o()(j,"d-flex flex-column h-100"),children:[(0,S.jsx)("button",{className:h,onClick:_,children:(0/* SlClose */,S.jsx)(m.ipV,{className:x})}),(0,S.jsxs)("div",{className:"mb-3",children:[(0,S.jsxs)("div",{className:"m-3 text-center",children:[(0,S.jsxs)("h4",{className:"fw-bolder m-0",children:["IMC ",t.year]}),(0,S.jsx)("small",{className:"m-0",children:"ADMIN AREA"})]}),W.map((e=>{const t=r.pathname.startsWith(e.link)||e.subLinks&&e.subLinks.some((e=>r.pathname.startsWith(e.link)));if(!e.hideFromMenu)
