...
var a=n(6942),r=n.n(a),o=n(3464);// ./src/admin/components/header/index.module.scss
// extracted by mini-css-extract-plugin
/* harmony default export */const l="index-module__header--RVFFD",c="index-module__title--gLVc5";
...
return(0,S.jsx)("nav",{"aria-label":"breadcrumb",className:R,children:(0,S.jsxs)("ol",{className:r()("breadcrumb"),children:[(0,S.jsx)("li",{className:"breadcrumb-item lh-0",children:(0/* Link */,S.jsx)(D.N_,{to:"/admin/dashboard",children:(0/* IoHomeOutline */,S.jsx)(q.M14,{className:"me-1"})})}),t.map(((e,n)=>(0,S.jsx)("li",{className:r()("breadcrumb-item",{active:n===t.length-1}),"aria-current":n===t.length-1?"page":void 0,children:n===t.length-1?(0,S.jsx)("b",{children:e.name}):(0/* Link */,S.jsx)(D.N_,{to:e.url,children:e.name})},n)))]})})},B=e=>{let{breadcrumb:t=[],title:n="",rightContent:a,children:o,isMaxWidth:l=!1}=e;const c=n?`${n} | ${z/* conferenceData */.p.name_display} ${z/* conferenceData */.p.year}`:`${z/* conferenceData */.p.name_display} ${z/* conferenceData */.p.year}`;
return(0,S.jsxs)(S.Fragment,{children:[(0/* Helmet */,S.jsxs)(F.mg,{children:[(0,S.jsx)("title",{children:c}),(0,S.jsx)("meta",{name:"robots",content:"noindex"})]}),(0,S.jsxs)("div",{className:r()(i,"position-relative"),children:[(0,S.jsx)(W,{}),(0,S.jsxs)("div",{className:"d-flex flex-row",children:[(0,S.jsx)(T,{cd:z/* conferenceData */.p}),(0,S.jsxs)("div",{className:"mx-md-4 my-3 h-100 flex-grow-1 d-flex flex-column px-3 px-md-0",children:[0!==t.length&&(0,S.jsx)(U,{links:t}),(0,S.jsxs)("div",{className:"d-flex justify-content-between align-items-center",children:[n&&(0,S.jsx)("h2",{children:n}),a&&(0,S.jsx)("div",{children:a})]}),(0,S.jsx)("div",{className:r()(l&&s),children:o})]})]})]})]})}}
/***/,
/***/7762:
/***/(e,t,n)=>{
// EXPORTS
...
const M=e=>{let{isCurOnline:t=!1}=e;const{participantId:n,tab:i}=(0,h/* useParams */.g)(),[M,$]=(0,u.useState)(""),[E,D]=(0,u.useState)(!1),[I,O]=(0,u.useState)(null),[V,P]=(0,u.useState)(!1),[T,z]=(0,u.useState)(0),[W,F]=(0,u.useState)(0),[q,R]=(0,u.useState)([]),[U,B]=(0,u.useState)(!1),[H,Y]=(0,u.useState)([]),Z=i||"identity",G=(0,h/* useNavigate */.Zp)();(0,p/* useBlockNavigation */.V)(V);const{workshops:J,paymentMethods:Q,registrationTypes:X,loading:K,sessions:ee,error:te}=(0,f/* useApiSpecificData */.Q)(),{participant:ne,loading:ie,error:se}=(0,g/* useApiParticipant */.D)(n,t,U,!0),{control:ae,register:re,handleSubmit:oe,getValues:le,setValue:ce,formState:{errors:de},trigger:me,watch:ue}=(0,x/* useForm */.mN)(),pe="1"===ne?.participant?.is_online,he=K||ie||E,xe=[M,se,te].filter(Boolean);
// Paypal fess
// Paypal fess
(0,u.useEffect)((()=>{F(W)}),[W]),
// Detect form changes
// Detect form changes
(0,u.useEffect)((()=>{const e=ue((()=>{P(!0)}));return()=>e.unsubscribe()}),[ue]),(0,u.useEffect)((()=>{i||G(`/admin/participants/onsite/${n}/summary`,{replace:!0})}),[i,n,G]),(0,u.useEffect)((()=>{if(!ne||0===ee.length)return;
// Extract participant data safely
const{participant:e,workshops:t,arrival:n,contributions:i,accommodation:s,extra_options:a}=ne||{},{dob:r,...o}=e||{};
...
// Handle Workshops
if(o&&Object.entries(o).forEach((e=>{let[t,n]=e;null!=n&&ce(t,n)})),t&&Array.isArray(t)){const e=t.map((e=>String(e.id)));ce("workshops",e)}
// Handle Arrival Details safely
// Handle Contributions (Talks & Posters)
if(n&&Object.entries(n).forEach((e=>{let[t,n]=e;null!=n&&ce(t,t.includes("hour")||t.includes("minute")?String(n).padStart(2,"0"):n)})),i&&Array.isArray(i)&&ee.length>0){const e=i.filter((e=>"talk"===e.type)).map((e=>({...e}))),t=i.filter((e=>"poster"===e.type)).map((e=>({...e})));
// Store in state
R(e),Y(t),
...
s?.registration_type_id&&ce("registration_type_id",String(s.registration_type_id)),
// Handle Extra Options safely
a&&(ce("excursion","0"===a.excursion?"false":"true"),ce("buy_tshirt","0"===a.buy_tshirt?"false":"true"),ce("tshirt_size",a.tshirt_size||""))}),[ne,ee,ce,R,Y]);const be=[{url:"/admin/participants/"+(pe?"online":"onsite"),name:pe?"Online Participants":"On-site Participants"},{url:`/admin/participants/${pe?"online":"onsite"}/${n}/${Z}`,name:`${ne?.participant?.first_name?ne.participant.first_name.charAt(0).toUpperCase()+ne.participant.first_name.slice(1):"Participant"} \n        ${ne?.participant?.last_name||""} - \n        ${Z.charAt(0).toUpperCase()+Z.slice(1)}`}],fe=ne&&Q.length>0&&J.length>0&&X.length>0,ge=!!ne?.participant?.admin_notes;
return(0/* default */,L.jsxs)(d.A,{breadcrumb:be,isMaxWidth:!0,children:[(0,L.jsxs)("div",{className:"position-relative fw-bolder",children:[he&&(0/* default */,L.jsx)(m.A,{}),xe.length>0&&(0,L.jsxs)("div",{className:"alert alert-danger fw-bolder",children:[(0,L.jsx)("ul",{className:"mb-0",children:xe.map(((e,t)=>(0,L.jsx)("li",{children:e},t)))}),(0,L.jsxs)("div",{className:"mt-2",children:["If you think this is a mistake please try again or "," "," ",(0/* Link */,L.jsx)(v.N_,{"aria-label":"Contact",to:"/contact",title:"Contact",children:"contact us"}),"."]})]}),I&&!he&&(0,L.jsx)("div",{className:"alert alert-success",children:I})]}),ne&&fe&&!he&&(0,L.jsxs)("form",{onSubmit:oe((async e=>{D(!0),$(null),O(null);// Triggers validation on all fields
if(!await me())return D(!1),void $("Please fill in all required fields.");e.talks=le("talks")||[],e.posters=le("posters")||[];const t={...e,total_due:T,paypal_fee:W};try{const e=await c/* default */.A.post(`https://imc2025.imo.net/php/admin/api/update_${pe?"online":"onsite"}_participant.php?id=${n}`,t,{headers:{"Content-Type":"application/json"}});if(!e.data.success)throw new Error(e.data.message||"Failed to update participant.");B((e=>!e)),O("Participant updated successfully!")}catch(e){$(e.message)}finally{D(!1)}})),children:[(0,L.jsx)("ul",{className:s()("nav nav-tabs mb-3 mt-2",r,"flex-column flex-sm-row"),children:[{key:"summary",label:"Billing"},{key:"identity",label:"Identity"},{key:"workshops",label:"Workshops"},...pe?[]:[{key:"arrival",label:"Arrival"}],{key:"contribution",label:"Contribution"},...pe?[{key:"accommodation",label:"Pay. Method"}]:[{key:"accommodation",label:"Acc. & Pay. Method"}],...pe?[]:[{key:"extras",label:"Extras"}],{key:"comments",label:"Comments"},{key:"admin_notes",label:"Marc's notes"}].map((e=>{let{key:t,label:i}=e;
return(0,L.jsx)("li",{className:"nav-item",children:(0,L.jsx)("a",{className:s()("nav-link",Z===t&&o),href:`/admin/participants/onsite/${n}/${t}`,onClick:e=>{e.preventDefault(),G(`/admin/participants/onsite/${n}/${t}`)},children:ge&&"admin_notes"===t?(0,L.jsxs)("span",{className:"position-relative",children:[(0,L.jsx)("span",{className:"position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger",children:"!"}),i]}):(0,L.jsx)(L.Fragment,{children:i})})},t)}))}),(0,L.jsxs)("div",{className:s()("tab-content mx-auto",l),children:["identity"===i&&(0/* default */,L.jsx)(_.A,{isAdmin:!0,isOnline:pe,register:re,errors:de,setValue:ce,trigger:me}),"workshops"===i&&(0/* default */,L.jsx)(j.A,{isAdmin:!0,isOnline:pe,conferenceData:b/* conferenceData */.p,register:re,errors:de,setValue:ce,trigger:me,watch:ue,workshops:J}),"arrival"===i&&!pe&&(0/* default */,L.jsx)(y.A,{isAdmin:!0,conferenceData:b/* conferenceData */.p,register:re,errors:de,setValue:ce,trigger:me}),"contribution"===i&&(0/* default */,L.jsx)(w.A,{isAdmin:!0,isOnline:pe,conferenceData:b/* conferenceData */.p,control:ae,register:re,errors:de,getValues:le,setValue:ce,watch:ue,trigger:me,sessions:ee}),"accommodation"===i&&(0/* default */,L.jsx)(k.A,{isAdmin:!0,isOnline:pe,isEarlyBird:ne?.participant.is_early_bird,conferenceData:b/* conferenceData */.p,control:ae,register:re,errors:de,paymentMethods:Q,setValue:ce,registrationTypes:X,trigger:me}),"extras"===i&&!pe&&(0/* default */,L.jsx)(N.A,{isAdmin:!0,conferenceData:b/* conferenceData */.p,register:re,errors:de,getValues:le,setValue:ce,trigger:me,watch:ue,control:ae}),"comments"===i&&(0,L.jsx)("div",{className:s()(a,"mx-auto"),children:(0/* default */,L.jsx)(A.A,{isAdmin:!0,isOnline:pe,register:re,errors:de,setValue:ce,trigger:me})}),(0,L.jsxs)("div",{className:s()(a,"mx-auto","summary"===i&&fe?"visible":"invisible h-0 w-0 overflow-hidden"),children:[(0,L.jsxs)("div",{className:"d-flex mt-3 align-items-center justify-content-between w-100 mb-3",children:[(0,L.jsxs)("div",{children:[ne?.participant?.first_name?ne.participant.first_name.charAt(0).toUpperCase()+ne.participant.first_name.slice(1):""," ",ne?.participant?.last_name||"","1"===ne.confirmation_sent?(0,L.jsxs)(L.Fragment,{children:["✅ ","has been confirmed on "," ",ne.confirmation_date&&(0,C/* formatFullDate */.Lu)(ne.confirmation_date)]}):(0,L.jsx)(L.Fragment,{children:"❌  has NOT been confirmed yet."})]}),"1"!==ne.confirmation_sent&&(0,L.jsx)("div",{children:(0/* Link */,L.jsx)(v.N_,{className:"btn btn-outline-success fw-bolder",to:`/admin/participants/${pe?"online":"onsite"}/payment/${n}`,children:"Go to Payments to confirm"})})]}),(0/* default */,L.jsx)(S.A,{isAdmin:!0,isOnline:pe,isEarlyBird:ne?.participant.is_early_bird,conferenceData:b/* conferenceData */.p,getValues:le,setValue:ce,setTotal:z,setPaypalFee:F,workshops:J,registrationTypes:X,paymentMethods:Q,watch:ue})]}),"admin_notes"===i&&(0,L.jsxs)("div",{className:s()(a,"mx-auto mb-3"),children:[(0,L.jsx)("label",{htmlFor:"admin_notes",className:"form-label fw-bold",children:"Admin Notes"}),(0,L.jsx)("textarea",{id:"admin_notes",className:"form-control",placeholder:"Enter your admin notes here",rows:6,...re("admin_notes")}),de.admin_notes&&(0,L.jsx)("div",{className:"text-danger mt-1",children:de.admin_notes.message})]}),(0,L.jsx)("div",{className:"mt-4 d-flex justify-content-end",children:(0,L.jsx)("button",{type:"submit",className:"btn btn-outline-primary fw-bolder",disabled:E,children:E?"Saving...":"Save Changes"})})]})]})]})};
/* harmony default export */}
/***/}]);