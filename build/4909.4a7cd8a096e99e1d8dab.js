...
return(0,c.jsxs)("div",{className:i()(t,"position-relative",s&&" border rounded-2 p-3 "),children:[m&&(0/* default */,c.jsx)(l.A,{}),s&&(0,c.jsx)("h5",{children:(0/* Link */,c.jsx)(o.N_,{to:"/admin/accomodations",children:"Available Rooms by Type"})}),u&&(0,c.jsx)("div",{className:"alert alert-danger fw-bolder",children:u}),!u&&!m&&(0,c.jsx)("div",{className:"d-flex flex-column flex-md-row gap-2",children:n?.filter((e=>"no"!==e.registration_type)).map((e=>{const t=e.registration_type.toLowerCase(),s=0===Math.floor(e.available_rooms);
