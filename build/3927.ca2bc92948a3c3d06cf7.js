...
var I=i(8983),A=i(1448),z=i(8321),E=i(7767),O=i(4976);
...
const D=parseInt(u,10)||250,R=e=>{let{cd:n}=e;const[i,s]=(0,C.useState)(!1),[t,l]=(0,C.useState)(!0),a=(0,A/* useDispatch */.wA)(),r=(0,E/* useLocation */.zy)(),c=(0,E/* useNavigate */.Zp)(),d=(0/* authSelectors */,A/* useSelector */.d4)(I.Pg.isAdmin),u=(0/* authSelectors */,A/* useSelector */.d4)(I.Pg.isLoc),_=(0/* authSelectors */,A/* useSelector */.d4)(I.Pg.isSoc),[v,k]=(0,z.useSpring)((()=>({right:-D,config:{tension:350,friction:30}})));(0,C.useEffect)((()=>(i?(l(!1),k.start({right:0}),document.body.classList.add("overflow-hidden"),document.documentElement.classList.add("overflow-hidden")):(k.start({right:-D,onRest:()=>l(!0)}),document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")),()=>{document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")})),[i,k]),(0,C.useEffect)((()=>{const e=()=>{s(!1)};return window.addEventListener("resize",e),()=>{window.removeEventListener("resize",e)}}),[]);const N=()=>{s((e=>!e))},y=e=>{c(e),N()};
return(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)("button",{className:x,onClick:N,children:(0/* SlMenu */,M.jsx)(m.RAm,{className:h})}),!t&&(0,M.jsx)("div",{className:o()(f),onClick:N,onMouseDown:W/* onStopPropagation */._v,onTouchStart:W/* onStopPropagation */._v}),(0,M.jsx)(z.animated.div,{className:o()(b),style:v,children:(0,M.jsxs)("div",{className:o()(g,"d-flex flex-column h-100"),children:[(0,M.jsx)("button",{className:p,onClick:N,children:(0/* SlClose */,M.jsx)(m.ipV,{className:h})}),(0,M.jsxs)("div",{className:"mb-3",children:[(0,M.jsxs)("div",{className:"m-3 text-center",children:[(0,M.jsxs)("h4",{className:"fw-bolder m-0",children:["IMC ",n.year]}),(0,M.jsx)("small",{className:"m-0",children:"ADMIN AREA"})]}),P.map((e=>{const n=r.pathname.startsWith(e.link)||e.subLinks&&e.subLinks.some((e=>r.pathname.startsWith(e.link)));return d||u&&e?.allowed?.includes("loc")||_&&e?.allowed?.includes("soc")?// Hide the menu item if not allowed 
...
return(0,M.jsx)("nav",{"aria-label":"breadcrumb",className:V,children:(0,M.jsxs)("ol",{className:o()("breadcrumb"),children:[(0,M.jsx)("li",{className:"breadcrumb-item lh-0",children:(0/* Link */,M.jsx)(O.N_,{to:"/admin/dashboard",children:(0/* IoHomeOutline */,M.jsx)(H.M14,{className:"me-1"})})}),n.map(((e,i)=>(0,M.jsx)("li",{className:o()("breadcrumb-item",{active:i===n.length-1}),"aria-current":i===n.length-1?"page":void 0,children:i===n.length-1?(0,M.jsx)("b",{children:e.name}):(0/* Link */,M.jsx)(O.N_,{to:e.url,children:e.name})},i)))]})})},U=e=>{let{breadcrumb:n=[],title:i="",rightContent:a,children:r,isMaxWidth:c=!0}=e;const d=i?`${i} | ${T/* conferenceData */.p.name_display} ${T/* conferenceData */.p.year}`:`${T/* conferenceData */.p.name_display} ${T/* conferenceData */.p.year}`;
return(0,M.jsxs)(M.Fragment,{children:[(0/* Helmet */,M.jsxs)(F.mg,{children:[(0,M.jsx)("title",{children:d}),(0,M.jsx)("meta",{name:"robots",content:"noindex"})]}),(0,M.jsxs)("div",{className:o()(s,"position-relative"),children:[(0,M.jsx)(q,{}),(0,M.jsxs)("div",{className:"d-flex flex-row",children:[(0,M.jsx)(R,{cd:T/* conferenceData */.p}),(0,M.jsxs)("div",{className:o()("mx-md-4 my-3 h-100 flex-grow-1 d-flex flex-column px-3 px-md-0",{[`${l} mx-md-auto`]:c}),children:[0!==n.length&&(0,M.jsx)(B,{links:n}),(0,M.jsxs)("div",{className:o()("d-flex justify-content-between align-items-center",t),children:[i&&(0,M.jsx)("h2",{children:i}),a&&(0,M.jsx)("div",{children:a})]}),r]})]})]})]})}}
/***/,
/***/7762:
/***/(e,n,i)=>{
// EXPORTS
