...
const l=()=>{const[e,s]=(0,r.useState)([]),[t,l]=(0,r.useState)([]),[i,o]=(0,r.useState)([]),[d,c]=(0,r.useState)([]),[m,u]=(0,r.useState)(!0),[h,p]=(0,r.useState)(null),b=(0,r.useCallback)((async()=>{u(!0),p(null);try{const e=await(async()=>{const e=await(0,a/* .retry */.L)((()=>n/* ["default"] */.A.get("https://imc2026.imo.net/php/get_specific_data.php")));if(!e?.data?.success)throw new Error(e?.data?.message||"Failed to fetch specific IMC data. Please, refresh the page.");return e.data.data||{}})();s(e.workshops||[]),l(e.payment_methods||[]),o(e.registration_types||[]),c(e.sessions||[])}catch(e){p(e.message||"Failed to fetch specific IMC data. Please, refresh the page.")}finally{u(!1)}}),[]);return(0,r.useEffect)((()=>{b()}),[b]),{error:h,loading:m,paymentMethods:t,refetchSpecificData:b,registrationTypes:i,sessions:d,workshops:e}}}
/***/,
/***/4972:
/***/(e,s,t)=>{
/* harmony export */t.d(s,{
