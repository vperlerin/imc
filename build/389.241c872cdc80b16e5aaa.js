...
return(0,L.jsx)("nav",{"aria-label":"breadcrumb",className:U,children:(0,L.jsxs)("ol",{className:l()("breadcrumb"),children:[(0,L.jsx)("li",{className:"breadcrumb-item lh-0",children:(0/* Link */,L.jsx)(O.N_,{to:"/admin/dashboard",children:(0/* IoHomeOutline */,L.jsx)(R.M14,{className:"me-1"})})}),t.map(((e,n)=>(0,L.jsx)("li",{className:l()("breadcrumb-item",{active:n===t.length-1}),"aria-current":n===t.length-1?"page":void 0,children:n===t.length-1?(0,L.jsx)("b",{children:e.name}):(0/* Link */,L.jsx)(O.N_,{to:e.url,children:e.name})},n)))]})})},H=e=>{let{breadcrumb:t=[],title:n="",rightContent:r,children:o,isMaxWidth:c=!0}=e;const d=n?`${n} | ${W/* conferenceData */.p.name_display} ${W/* conferenceData */.p.year}`:`${W/* conferenceData */.p.name_display} ${W/* conferenceData */.p.year}`;
return(0,L.jsxs)(L.Fragment,{children:[(0/* Helmet */,L.jsxs)(q.mg,{children:[(0,L.jsx)("title",{children:d}),(0,L.jsx)("meta",{name:"robots",content:"noindex"})]}),(0,L.jsxs)("div",{className:l()(i,"position-relative"),children:[(0,L.jsx)(F,{}),(0,L.jsxs)("div",{className:"d-flex flex-row",children:[(0,L.jsx)(z,{cd:W/* conferenceData */.p}),(0,L.jsxs)("div",{className:l()("mx-md-4 my-3 h-100 flex-grow-1 d-flex flex-column px-3 px-md-0",{[`${a} mx-md-auto`]:c}),children:[0!==t.length&&(0,L.jsx)(B,{links:t}),(0,L.jsxs)("div",{className:l()("d-flex justify-content-between align-items-center",s),children:[n&&(0,L.jsx)("h2",{children:n}),r&&(0,L.jsx)("div",{children:r})]}),o]})]})]})]})}}
/***/,
/***/7762:
/***/(e,t,n)=>{
// EXPORTS
