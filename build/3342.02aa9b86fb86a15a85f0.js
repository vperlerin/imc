...
/* harmony import */const i=function(){let e=arguments.length>0&&void 0!==arguments[0]&&arguments[0];const[t,a]=(0,n.useState)([]),[i,r]=(0,n.useState)(!0),[c,o]=(0,n.useState)(null);// Re-run if confirmedOnly changes
...
/* harmony import */const h=()=>{const[e,t]=(0,r.useState)([]),[a,h]=(0,r.useState)(""),[u,p]=(0,r.useState)("last_name"),[x,j]=(0,r.useState)(null),[f,g]=(0,r.useState)(!1),[b,N]=(0,r.useState)(!1),[_,y]=(0,r.useState)(""),[v,w]=(0,r.useState)(""),{participants:C,loading:S,error:k,setParticipants:D}=(0,c/* .useApiOnlineParticipants */.$)(),{deleteParticipant:A,errorDelete:F,isDeleting:$}=(0,o/* .useApiDeleteParticipant */.A)(D,t);(0,r.useEffect)((()=>{if(a){const e=a.toLowerCase();t(C.filter((t=>(t[u]?String(t[u]).toLowerCase():"").includes(e))))}else t(C)}),[a,u,C]);
// Calculate totals
const L=C.length,P=C.filter((e=>"1"===e.confirmation_sent)).length;
return(0/* ["default"] */,m.jsxs)(n.A,{breadcrumb:[{url:"/admin/participants/online",name:"Online Participants"}],isMaxWidth:!0,title:"ONLINE Participants",rightContent:(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)("strong",{children:"Confirmed:"})," ",(0,m.jsx)("strong",{className:"text-success",children:P})," / ",L]}),children:[v&&(0,m.jsx)("div",{className:"alert alert-danger fw-bolder",children:v}),_&&(0,m.jsx)("div",{className:"alert alert-success fw-bolder",children:_}),k&&(0,m.jsx)("p",{className:"alert alert-danger fw-bolder",children:k}),S||$?(0/* ["default"] */,m.jsx)(l.A,{}):(0,m.jsxs)(m.Fragment,{children:[F&&(0,m.jsx)("p",{className:"alert alert-danger",children:F}),(0,m.jsxs)("div",{className:"d-flex flex-column flex-md-row gap-2 mb-3",children:[(0,m.jsxs)("select",{className:"form-select w-auto",value:u,onChange:e=>p(e.target.value),children:[(0,m.jsx)("option",{value:"last_name",children:"Search by Last Name"}),(0,m.jsx)("option",{value:"email",children:"Search by Email"})]}),(0,m.jsxs)("div",{className:"position-relative w-auto",children:[(0,m.jsx)("input",{type:"text",className:"form-control pe-5",placeholder:`Enter ${u.replace("_"," ")}`,value:a,onChange:e=>h(e.target.value)}),(0/* .CiSearch */,m.jsx)(s.Xj1,{className:"position-absolute top-50 end-0 translate-middle-y me-2"})]}),(0/* ["default"] */,m.jsx)(i.A,{className:"ms-auto",link:"https://imc2025.imo.net/php/doc_participants.php"})]}),(0/* ["default"] */,m.jsx)(d.A,{participants:e,onDelete:e=>{j(e),g(!0)}})]}),(f||b)&&(0,m.jsx)("div",{className:"modal-backdrop fade show"}),f&&x&&(0,m.jsx)("div",{className:"modal show d-block",children:(0,m.jsx)("div",{className:"modal-dialog",children:(0,m.jsxs)("div",{className:"modal-content",children:[(0,m.jsxs)("div",{className:"modal-header",children:[(0,m.jsx)("h5",{className:"modal-title",children:"Cancel Registration"}),(0,m.jsx)("button",{type:"button",className:"btn-close",onClick:()=>g(!1)})]}),(0,m.jsxs)("div",{className:"modal-body",children:[!1,"Are you sure you want to permanently delete all data related to this participant?"]}),(0,m.jsxs)("div",{className:"modal-footer",children:[(0,m.jsx)("button",{className:"btn btn-outline-secondary fw-bolder",onClick:()=>g(!1),children:"Cancel"}),!1,(0,m.jsx)("button",{className:"btn btn-outline-danger fw-bolder ms-auto",onClick:()=>{g(!1),N(!0)},children:"Hard Delete"})]})]})})}),b&&(0,m.jsx)("div",{className:"modal show d-block",children:(0,m.jsx)("div",{className:"modal-dialog",children:(0,m.jsxs)("div",{className:"modal-content",children:[(0,m.jsxs)("div",{className:"modal-header",children:[(0,m.jsx)("h5",{className:"modal-title",children:"Confirm Permanent Deletion"}),(0,m.jsx)("button",{type:"button",className:"btn-close",onClick:()=>N(!1)})]}),(0,m.jsx)("div",{className:"modal-body",children:(0,m.jsxs)("p",{children:[(0,m.jsx)("strong",{children:"Are you absolutely sure?"})," This action cannot be undone."]})}),(0,m.jsxs)("div",{className:"modal-footer",children:[(0,m.jsx)("button",{className:"btn btn-outline-danger  fw-bolder",onClick:()=>{(async e=>{if(x)try{const t=await A(x,e);t?.data?.success?y(t.data.message||"Participant deleted successfully!"):w(t?.data?.message||"Impossible to delete the participant for now, please try again later.")}catch(e){w("An unexpected error occurred while deleting the participant.")}})("hard"),N(!1)},children:"Yes, Delete"}),(0,m.jsx)("button",{className:"btn btn-outline-secondary fw-bolder",onClick:()=>N(!1),children:"No"})]})]})})})]})};
/* harmony default export */}
/***/,
/***/7806:
/***/(e,t,a)=>{
