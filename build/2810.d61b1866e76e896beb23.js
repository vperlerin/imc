...
// Selected Workshops
const{selected:x,totalPrice:f}=((e=[],t)=>{if(!Array.isArray(e))return{selected:[],totalPrice:0};const a=e.map((e=>({title:e.title,price:l(t?e.price_online:e.price,0)}))),s=a.reduce(((e,t)=>e+t.price),0);return{selected:a,totalPrice:s}})(d,e),b="1"===m?.buy_tshirt||"true"===m?.buy_tshirt?l(t?.costs?.tshirts?.price,0):0,y=(0,s/* .offersOnsitePosterPrint */.a)(t),j=(p||[]).filter((e=>"1"===e.print||"true"===e.print)),N=y?j.length:0,g=N*l(t?.poster_print?.price,0),_="paypal"===String(o?.payment_method_name||"Unknown").toLowerCase();
// T-shirt Cost
// Total Calculation
let w=u+f+b+g;const v=_?i(w)-w:0;w+=v;
// Online Conference Cost Calculation
const C=l(t?.costs?.online,0);let k=f+C;const S=_?i(k)-k:0;return k+=S,(0,n.jsxs)("div",{className:"p-2 border rounded flex-shrink-0",children:[(0,n.jsx)("h4",{className:"mb-3",children:"Invoice Summary"}),(0,n.jsxs)("table",{className:"table table-striped table-hover",children:[(0,n.jsx)("thead",{children:(0,n.jsxs)("tr",{children:[(0,n.jsx)("th",{scope:"col",children:"Description"}),(0,n.jsx)("th",{scope:"col",className:"text-end",children:"Price"})]})}),(0,n.jsxs)("tbody",{children:[e?(0,n.jsxs)("tr",{children:[(0,n.jsx)("td",{className:"ps-3 text-muted",children:"Online Conference Registration"}),(0,n.jsxs)("td",{className:"text-end",children:[C.toFixed(2),"€"]})]}):(0,n.jsxs)("tr",{children:[(0,n.jsxs)("td",{className:"ps-3 text-muted",children:["Conference Registration ",h]}),(0,n.jsxs)("td",{className:"text-end",children:[u.toFixed(2),"€"]})]}),x.map(((e,t)=>(0,n.jsxs)("tr",{children:[(0,n.jsx)("td",{className:"ps-3 text-muted",children:e.title}),(0,n.jsxs)("td",{className:"text-end",children:[e.price.toFixed(2),"€"]})]},t))),y&&N>0&&(0,n.jsxs)("tr",{children:[(0,n.jsxs)("td",{className:"ps-3 text-muted",children:["Printed Poster",N>1?"s":""," x ",N]}),(0,n.jsxs)("td",{className:"text-end",children:[g.toFixed(2),"€"]})]}),b>0&&m?.tshirt_size&&(0,n.jsxs)("tr",{children:[(0,n.jsxs)("td",{className:"ps-3 text-muted",children:["T-Shirt (",m.tshirt_size,")"]}),(0,n.jsxs)("td",{className:"text-end",children:[b.toFixed(2),"€"]})]}),_&&(0,n.jsxs)("tr",{children:[(0,n.jsx)("td",{className:"ps-3 text-muted",children:"PayPal Fee (3.4% + 0.35€)"}),(0,n.jsxs)("td",{className:"text-end",children:[e?S.toFixed(2):v.toFixed(2),"€"]})]}),(0,n.jsxs)("tr",{children:[(0,n.jsx)("td",{children:(0,n.jsx)("strong",{children:"TOTAL"})}),(0,n.jsx)("td",{className:"text-end",children:(0,n.jsxs)("strong",{children:[(e?k:w).toFixed(2),"€"]})})]})]})]})]})}}
/***/,
/***/2810:
/***/(e,t,a)=>{
// ESM COMPAT FLAG
...
const O=parseInt(p,10)||250,R=({cd:e})=>{const[t,a]=(0,S.useState)(!1),[s,n]=(0,S.useState)(!0),i=(0,$/* useDispatch */.wA)(),l=(0,M/* useLocation */.zy)(),o=(0,M/* useNavigate */.Zp)(),c=(0/* authSelectors */,$/* useSelector */.d4)(A.Pg.isAdmin),d=(0/* authSelectors */,$/* useSelector */.d4)(A.Pg.isLoc),p=(0/* authSelectors */,$/* useSelector */.d4)(A.Pg.isSoc),[g,_]=(0,I.useSpring)((()=>({right:-O,config:{tension:350,friction:30}})));(0,S.useEffect)((()=>(t?(n(!1),_.start({right:0}),document.body.classList.add("overflow-hidden"),document.documentElement.classList.add("overflow-hidden")):(_.start({right:-O,onRest:()=>n(!0)}),document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")),()=>{document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")})),[t,_]),(0,S.useEffect)((()=>{const e=()=>{a(!1)};return window.addEventListener("resize",e),()=>{window.removeEventListener("resize",e)}}),[]);const w=()=>{a((e=>!e))},v=e=>{o(e),w()};
