...
var r=n(4178),o=n(1083),l=n(7647),c=n(6645),d=n(6540),m=n(2199),u=n(7767),p=n(9785),h=n(7762),x=n(4493),b=n(4972),f=n(4976),g=n(847),_=n(3975),w=n(9156),y=n(8299),v=n(5680),j=n(6538),N=n(5058),k=n(6827),A=n(4668),C=n(5846),$=n(4848);
// EXTERNAL MODULE: ./node_modules/axios/lib/axios.js + 48 modules
// ./src/admin/pages/participants/single/index.js
const D=({isCurOnline:e=!1})=>{const{participantId:t,tab:n}=(0,u/* useParams */.g)(),[i,D]=(0,d.useState)(""),[T,M]=(0,d.useState)(!1),[S,L]=(0,d.useState)(null),[E,I]=(0,d.useState)(!1),[O,F]=(0,d.useState)(0),[P,V]=(0,d.useState)(0),[U,z]=(0,d.useState)(!1),Z=n||"identity",q=(0,u/* useNavigate */.Zp)();(0,m/* useBlockNavigation */.V)(E);const{workshops:W,paymentMethods:B,registrationTypes:Y,loading:R,sessions:H,error:G}=(0,x/* useApiSpecificData */.Q)(),{participant:Q,loading:X,error:J}=(0,b/* useApiParticipant */.D)(t,e,U,!0),{control:K,register:ee,handleSubmit:te,getValues:ne,setValue:ie,formState:{errors:ae},reset:se,trigger:re,watch:oe}=(0,p/* useForm */.mN)(),le="1"===Q?.participant?.is_online,ce=R||X||T,de=[i,J,G].filter(Boolean);
// Paypal fess
// Paypal fess
(0,d.useEffect)((()=>{V(P)}),[P]),
// Detect form changes
// Detect form changes
(0,d.useEffect)((()=>{const e=oe((()=>{I(!0)}));return()=>e.unsubscribe()}),[oe]),(0,d.useEffect)((()=>{const e=Number.isInteger(Number(t))&&Number(t)>0;!n&&e&&q(`/admin/participants/onsite/edit/${t}/summary`,{replace:!0})}),[n,t,q]),(0,d.useEffect)((()=>{if(!Q||0===H.length)return;const{accommodation:e,arrival:t,contributions:n,extra_options:i,food_other_text:a,food_restrictions:s,participant:r,workshops:o}=Q||{},l={},c=r?.dob;if(c){const[e,t,n]=c.split("-");l.dobDay=String(Number(n)),l.dobMonth=String(Number(t)),l.dobYear=e}
...
// ----- extras
i&&(l.excursion="0"===i.excursion?"false":"true",l.buy_tshirt="0"===i.buy_tshirt?"false":"true",l.tshirt_size=i.tshirt_size||""),l.food_restrictions=Array.isArray(s)?s:[],l.food_restrictions_other=a??"",se(l,{keepDirty:!1,keepTouched:!1}),I(!1)}),[Q,H,se]);const me=[{url:"/admin/participants/"+(le?"online":"onsite"),name:le?"Online Participants":"On-site Participants"},{url:`/admin/participants/${le?"online":"onsite"}/${t}/${Z}`,name:`${Q?.participant?.first_name?Q.participant.first_name.charAt(0).toUpperCase()+Q.participant.first_name.slice(1):"Participant"} \n        ${Q?.participant?.last_name||""} - \n        ${Z.charAt(0).toUpperCase()+Z.slice(1)}`}],ue=Q&&B.length>0&&W.length>0&&Y.length>0,pe=!!Q?.participant?.admin_notes;
return(0/* default */,$.jsxs)(l.A,{breadcrumb:me,isMaxWidth:!0,children:[(0,$.jsxs)("div",{className:"position-relative fw-bolder",children:[ce&&(0/* default */,$.jsx)(c.A,{}),de.length>0&&(0,$.jsx)("div",{className:"alert alert-danger fw-bolder",children:(0,$.jsx)("ul",{className:"mb-0",children:de.map(((e,t)=>(0,$.jsx)("li",{children:e},t)))})}),S&&!ce&&(0,$.jsx)("div",{className:"alert alert-success",children:S})]}),Q&&ue&&!ce&&(0,$.jsxs)("form",{onSubmit:te((async e=>{M(!0),D(null),L(null);// Triggers validation on all fields
if(!await re())return M(!1),void D("Please fill in all required fields.");e.talks=ne("talks")||[],e.posters=ne("posters")||[];const n={...e,total_due:O,paypal_fee:P};try{const e=await o/* default */.A.post(`https://imc2026.imo.net/php/admin/api/update_${le?"online":"onsite"}_participant.php?id=${t}`,n,{headers:{"Content-Type":"application/json"}});if(!e.data.success)throw new Error(e.data.message||"Failed to update participant.");z((e=>!e)),L("Participant updated successfully!")}catch(e){D(e.message)}finally{M(!1)}})),children:[(0,$.jsx)("ul",{className:a()("nav nav-tabs mb-3 mt-2",r/* default */.A.tab,"flex-column flex-sm-row"),children:[{key:"summary",label:"Billing"},{key:"identity",label:"Identity"},{key:"workshops",label:"Workshops"},...le?[]:[{key:"arrival",label:"Arrival"}],{key:"contribution",label:"Contribution"},...le?[{key:"accommodation",label:"Pay. Method"}]:[{key:"accommodation",label:"Acc. & Pay. Method"}],...le?[]:[{key:"extras",label:"Extras"}],{key:"comments",label:"Comments"},{key:"admin_notes",label:"Marc's notes"}].map((({key:e,label:n})=>(0,$.jsx)("li",{className:"nav-item",children:(0,$.jsx)("a",{className:a()("nav-link",Z===e&&r/* default */.A.active),href:`/admin/participants/onsite/edit/${t}/${e}`,onClick:n=>{n.preventDefault(),q(`/admin/participants/onsite/edit/${t}/${e}`)},children:pe&&"admin_notes"===e?(0,$.jsxs)("span",{className:"position-relative",children:[(0,$.jsx)("span",{className:"position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger",children:"!"}),n]}):(0,$.jsx)($.Fragment,{children:n})})},e)))}),(0,$.jsxs)("div",{className:a()("tab-content mx-auto",r/* default */.A.contentMxw),children:["identity"===n&&(0,$.jsxs)($.Fragment,{children:[(0/* default */,$.jsx)(g.A,{isAdmin:!0,isOnline:le,register:ee,errors:ae,setValue:ie,trigger:re}),(0/* default */,$.jsx)(y.A,{isAdmin:!0,register:ee,setValue:ie,errors:ae,trigger:re,initialData:Q?.participant,watch:oe})]}),"workshops"===n&&(0/* default */,$.jsx)(_.A,{isAdmin:!0,isOnline:le,conferenceData:h/* conferenceData */.p,register:ee,errors:ae,setValue:ie,trigger:re,watch:oe,workshops:W}),"arrival"===n&&!le&&(0/* default */,$.jsx)(w.A,{isAdmin:!0,conferenceData:h/* conferenceData */.p,register:ee,errors:ae,setValue:ie,trigger:re}),"contribution"===n&&(0/* default */,$.jsx)(v.A,{isAdmin:!0,isOnline:le,conferenceData:h/* conferenceData */.p,control:K,register:ee,errors:ae,getValues:ne,setValue:ie,watch:oe,trigger:re,sessions:H}),"accommodation"===n&&(0/* default */,$.jsx)(j.A,{isAdmin:!0,isOnline:le,isEarlyBird:1===Q?.participant.is_early_bird||"1"===Q?.participant.is_early_bird,conferenceData:h/* conferenceData */.p,control:K,register:ee,errors:ae,paymentMethods:B,setValue:ie,registrationTypes:Y,trigger:re}),"extras"===n&&!le&&(0/* default */,$.jsx)(N.A,{isAdmin:!0,conferenceData:h/* conferenceData */.p,register:ee,errors:ae,getValues:ne,setValue:ie,trigger:re,watch:oe,control:K}),"comments"===n&&(0,$.jsx)("div",{className:a()(s,"mx-auto"),children:(0/* default */,$.jsx)(k.A,{isAdmin:!0,isOnline:le,register:ee,errors:ae,setValue:ie,trigger:re})}),(0,$.jsxs)("div",{className:a()(s,"mx-auto","summary"===n&&ue?"visible":"invisible h-0 w-0 overflow-hidden"),children:[(0,$.jsxs)("div",{className:"d-flex mt-3 align-items-center justify-content-between w-100 mb-3",children:[(0,$.jsxs)("div",{children:[(0,$.jsxs)("strong",{children:[Q?.participant?.first_name?Q.participant.first_name.charAt(0).toUpperCase()+Q.participant.first_name.slice(1):""," ",Q?.participant?.last_name||""]})," ","1"===Q.participant.confirmation_sent?(0,$.jsxs)($.Fragment,{children:["has been confirmed on ",(0,$.jsx)("span",{className:"text-success",children:Q.participant.confirmation_date&&(0,C/* formatFullDate */.Lu)(Q.participant.confirmation_date)})]}):(0,$.jsx)($.Fragment,{children:"❌  has NOT been confirmed yet."})]}),"1"!==Q.participant.confirmation_sent&&(0,$.jsx)("div",{children:(0/* Link */,$.jsx)(f.N_,{className:"btn btn-outline-success fw-bolder",to:`/admin/participants/${le?"online":"onsite"}/payment/${t}`,children:"Go to Payments to confirm"})})]}),(0/* default */,$.jsx)(A.A,{isAdmin:!0,isOnline:le,isEarlyBird:1===Q?.participant.is_early_bird||"1"===Q?.participant.is_early_bird,conferenceData:h/* conferenceData */.p,getValues:ne,setValue:ie,setTotal:F,setPaypalFee:V,workshops:W,registrationTypes:Y,paymentMethods:B,watch:oe})]}),"admin_notes"===n&&(0,$.jsxs)("div",{className:a()(s,"mx-auto mb-3"),children:[(0,$.jsx)("label",{htmlFor:"admin_notes",className:"form-label fw-bold",children:"Admin Notes"}),(0,$.jsx)("textarea",{id:"admin_notes",className:"form-control",placeholder:"Enter your admin notes here",rows:6,...ee("admin_notes")}),ae.admin_notes&&(0,$.jsx)("div",{className:"text-danger mt-1",children:ae.admin_notes.message})]}),(0,$.jsx)("div",{className:"mt-4 d-flex justify-content-end",children:(0,$.jsx)("button",{type:"submit",className:"btn btn-outline-primary fw-bolder",disabled:T,children:T?"Saving...":"Save Changes"})})]})]})]})};
...
var T=n(8983),M=n(1448),S=n(8321),L=n(7767),E=n(4976);
...
var O=n(1280),F=n(1083);
// EXTERNAL MODULE: ./node_modules/axios/lib/axios.js + 48 modules
// ./src/admin/components/header/menu/index.js
const P=parseInt(u,10)||250,V=({cd:e})=>{const[t,n]=(0,C.useState)(!1),[i,a]=(0,C.useState)(!0),s=(0,M/* useDispatch */.wA)(),r=(0,L/* useLocation */.zy)(),l=(0,L/* useNavigate */.Zp)(),c=(0/* authSelectors */,M/* useSelector */.d4)(T.Pg.isAdmin),d=(0/* authSelectors */,M/* useSelector */.d4)(T.Pg.isLoc),u=(0/* authSelectors */,M/* useSelector */.d4)(T.Pg.isSoc),[y,v]=(0,S.useSpring)((()=>({right:-P,config:{tension:350,friction:30}})));(0,C.useEffect)((()=>(t?(a(!1),v.start({right:0}),document.body.classList.add("overflow-hidden"),document.documentElement.classList.add("overflow-hidden")):(v.start({right:-P,onRest:()=>a(!0)}),document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")),()=>{document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")})),[t,v]),(0,C.useEffect)((()=>{const e=()=>{n(!1)};return window.addEventListener("resize",e),()=>{window.removeEventListener("resize",e)}}),[]);const j=()=>{n((e=>!e))},N=e=>{l(e),j()};
return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)("button",{className:p,onClick:j,children:(0/* SlMenu */,$.jsx)(m.RAm,{className:x})}),!i&&(0,$.jsx)("div",{className:o()(f),onClick:j,onMouseDown:O/* onStopPropagation */._v,onTouchStart:O/* onStopPropagation */._v}),(0,$.jsx)(S.animated.div,{className:o()(b),style:y,children:(0,$.jsxs)("div",{className:o()(g,"d-flex flex-column h-100"),children:[(0,$.jsx)("button",{className:h,onClick:j,children:(0/* SlClose */,$.jsx)(m.ipV,{className:x})}),(0,$.jsxs)("div",{className:"mb-3",children:[(0,$.jsxs)("div",{className:"m-3 text-center",children:[(0,$.jsxs)("h4",{className:"fw-bolder m-0",children:["IMC ",e.year]}),(0,$.jsx)("small",{className:"m-0",children:"ADMIN AREA"})]}),I.map((e=>{const t=r.pathname.startsWith(e.link)||e.subLinks&&e.subLinks.some((e=>r.pathname.startsWith(e.link)));return c||d&&e?.allowed?.includes("loc")||u&&e?.allowed?.includes("soc")?// Hide the menu item if not allowed 
e.hideFromMenu?void 0:(0,$.jsx)(D,{className:"py-2",isLinkActive:t,goTo:N,title:e.title,url:e.link,children:e.subLinks&&(0,$.jsx)($.Fragment,{children:e.subLinks.filter((e=>c||d&&e?.allowed?.includes("loc")||u&&e?.allowed?.includes("soc"))).map((e=>{const t=r.pathname===e.link;
return(0/* Link */,$.jsx)(E.N_,{"aria-label":e.title,onClick:j,to:e.link,className:o()(t&&_),title:e.title,children:e.title},e.link)}))})},e.link):null}))]}),(0,$.jsx)("div",{className:o()(w,"mt-auto"),children:(0,$.jsxs)("div",{className:"d-flex flex-column justify-content-center mb-3 p-3 gap-2 px-4",children:[(0,$.jsx)("button",{"aria-label":"Public site",className:"btn btn-outline-success px-3 fw-bolder",onClick:()=>N("/"),title:"Public site",children:"Public site"}),(0,$.jsx)("button",{"aria-label":"Logout",className:"btn btn-outline-danger px-3 fw-bolder",onClick:async()=>{await F/* default */.A.get("https://imc2026.imo.net/php/auth/logout.php",{withCredentials:!0}),s(T/* authActions */.I2.logout()),localStorage.removeItem("session"),l("/")},title:"Logout",children:"Logout"})]})})]})})]})};
// EXTERNAL MODULE: ./src/data/conference-data.js + 1 modules
var U=n(7762);// ./src/admin/components/header/index.js
const z=()=>{const e=`${U/* conferenceData */.p.name} ${U/* conferenceData */.p.year}`,t=(0/* authSelectors */,M/* useSelector */.d4)(T.Pg.isLoc),n=(0/* authSelectors */,M/* useSelector */.d4)(T.Pg.isSoc),i=t?"/admin/accommodations":n?"/admin/contributions/talks":"/admin/dashboard";
