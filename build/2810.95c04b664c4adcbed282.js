...
var s=a(6942),i=a.n(s),l=a(8027),r=a(6540),o=a(5846),c=a(7762),d=a(4848);// ./src/admin/components/admin-table/index.js
const m=c/* conferenceData */.p?.costs?.rooms??[],p=new Set(m.map((e=>String(e?.type??"").toLowerCase().trim())).filter(Boolean)),u=String(m.find((e=>"no"===String(e?.type??"").toLowerCase().trim()))?.type??"no").toLowerCase(),h=e=>{const t=String(e??"").toLowerCase().trim();return p.has(t)?t:u},x=({participants:e,withActions:t=!0,customActions:a=null,onDelete:s=null,onCanBePublicChange:c=null,canBePublicSavingId:m=null,isOnsite:p=!1})=>{const[u,x]=(0,r.useState)(null),[f,b]=(0,r.useState)("asc"),y=e=>{u===e?b("asc"===f?"desc":"asc"):(x(e),b("asc"))},j=[...e].sort(((e,t)=>{if(!u)return 0;let a=e[u],n=t[u];
...
"confirmation_sent"===u&&(a="1"===a?1:0,n="1"===n?1:0),"can_be_public"===u&&(a="1"===a||1===a?1:0,n="1"===n||1===n?1:0),a<n?"asc"===f?-1:1:a>n?"asc"===f?1:-1:0})),_=9+(c?1:0)+(p?1:0)+(t||a?1:0);
return(0,d.jsx)("div",{className:"table-responsive",style:{maxWidth:"calc(100vw - 2rem)"},children:(0,d.jsxs)("table",{className:"table table-striped",children:[(0,d.jsx)("thead",{children:(0,d.jsxs)("tr",{children:[(0,d.jsx)("th",{className:n,onClick:()=>y("id"),children:"#"}),(0,d.jsx)("th",{className:n,onClick:()=>y("created_at"),children:"Reg. Date"}),(0,d.jsx)("th",{className:n,onClick:()=>y("last_name"),children:"Name"}),c&&(0,d.jsx)("th",{className:n,title:"Show name on /community/participants",onClick:()=>y("can_be_public"),children:"Public list"}),(0,d.jsx)("th",{className:n,onClick:()=>y("total_due"),children:"Total"}),(0,d.jsx)("th",{className:n,onClick:()=>y("total_paid"),children:"Paid"}),(0,d.jsx)("th",{className:n,onClick:()=>y("due_amount"),children:"Due"}),(0,d.jsx)("th",{className:n,onClick:()=>y("payment_method"),children:"Method"}),p&&(0,d.jsx)("th",{className:n,title:"Accommodation",onClick:()=>y("accommodation_type"),children:"Acc."}),(0,d.jsx)("th",{className:n,onClick:()=>y("confirmation_sent"),children:"Confirmed"}),(0,d.jsx)("th",{className:n,onClick:()=>y("confirmation_date"),children:"Conf. Email"}),(t||a)&&(0,d.jsx)("th",{})]})}),(0,d.jsx)("tbody",{children:j.length>0?j.map((e=>{const n=parseFloat(e.total_due)||0,r=parseFloat(e.total_paid)||0,u=parseFloat(e.paypal_fee||0),x="paypal"===e.payment_method_name?.toLowerCase(),f=x?n+u-r:n-r;
return(0,d.jsxs)("tr",{className:"cancelled"===e.status?"text-warning ":"",children:[(0,d.jsx)("td",{children:e.id}),(0,d.jsx)("td",{children:e.created_at.split(" ")[0]}),(0,d.jsxs)("td",{children:[e.title," ",e.first_name," ",e.last_name]}),c&&(0,d.jsx)("td",{children:(0,d.jsx)("input",{type:"checkbox",className:"form-check-input",title:"Show name on public participants page",checked:"1"===e.can_be_public||1===e.can_be_public,disabled:m===e.id,onChange:t=>c(e,t.target.checked)})}),(0,d.jsxs)("td",{children:[x?(n+u).toFixed(2):n.toFixed(2),"€"]}),(0,d.jsxs)("td",{children:[r.toFixed(2),"€"]}),(0,d.jsxs)("td",{className:i()({"text-success":0===f}),children:[f.toFixed(2),"€"]}),(0,d.jsx)("td",{children:e.payment_method_name||"n/a"}),p&&(0,d.jsx)("td",{children:h(e.accommodation_type)}),(0,d.jsx)("td",{children:"1"===e.confirmation_sent?"✅":"❌"}),(0,d.jsx)("td",{className:i()("cancelled"===e.status?"text-warning":e?.confirmation_date&&"text-success"),children:"cancelled"===e.status?"CANCELLED":e.confirmation_date?(0,o/* formatFullDate */.Lu)(e.confirmation_date):"❌"}),t&&s&&(0,d.jsx)("td",{children:(0,d.jsxs)("div",{className:"d-flex gap-2 justify-content-end",children:["cancelled"===e.status?(0,d.jsx)("a",{href:`/admin/participants/${e.is_online?"online":"onsite"}/payment/${e.id}`,className:"btn btn-sm btn-outline-success fw-bolder",children:"Reimbursements"}):(0,d.jsx)("a",{href:`/admin/participants/${e.is_online?"online":"onsite"}/payment/${e.id}`,className:"btn btn-sm btn-outline-success fw-bolder",children:"Payments"}),(0,d.jsx)("a",{href:`/admin/participants/${e.is_online?"online":"onsite"}/edit/${e.id}`,className:"btn btn-sm btn-outline-primary fw-bolder",children:"Edit"}),(0,d.jsx)("button",{className:"btn btn-sm btn-outline-danger d-inline-flex align-items-center",onClick:()=>(e=>{s?.(e)})(e),title:"Delete Payment",children:(0/* FaRegTrashAlt */,d.jsx)(l.H8h,{})})]})}),a&&"cancelled"!==e.status&&(0,d.jsx)(d.Fragment,{children:a})]},e.id)})):(0,d.jsx)("tr",{children:(0,d.jsx)("td",{colSpan:_,className:"text-center",children:"No participants found."})})})]})})}}
/***/,
/***/914:
/***/(e,t,a)=>{
...
// Selected Workshops
const{selected:f,totalPrice:b}=((e=[],t)=>{if(!Array.isArray(e))return{selected:[],totalPrice:0};const a=e.map((e=>({title:e.title,price:r(t?e.price_online:e.price,0)}))),n=a.reduce(((e,t)=>e+t.price),0);return{selected:a,totalPrice:n}})(m,e),y="1"===p?.buy_tshirt||"true"===p?.buy_tshirt?r(t?.costs?.tshirts?.price,0):0,j=(0,n/* .offersOnsitePosterPrint */.a)(t),_=(u||[]).filter((e=>"1"===e.print||"true"===e.print)),g=j?_.length:0,N=g*r(t?.poster_print?.price,0),w="paypal"===String(c?.payment_method_name||"Unknown").toLowerCase();
// T-shirt Cost
// Total Calculation
let v=h+b+y+N;const C=w?l(v)-v:0;v+=C;
// Online Conference Cost Calculation
const k=r(t?.costs?.online,0);let S=b+k;const F=w?l(S)-S:0;return S+=F,(0,i.jsxs)("div",{className:"p-2 border rounded flex-shrink-0",children:[(0,i.jsx)("h4",{className:"mb-3",children:"Invoice Summary"}),(0,i.jsxs)("table",{className:"table table-striped table-hover",children:[(0,i.jsx)("thead",{children:(0,i.jsxs)("tr",{children:[(0,i.jsx)("th",{scope:"col",children:"Description"}),(0,i.jsx)("th",{scope:"col",className:"text-end",children:"Price"})]})}),(0,i.jsxs)("tbody",{children:[e?(0,i.jsxs)("tr",{children:[(0,i.jsx)("td",{className:"ps-3 text-muted",children:"Online Conference Registration"}),(0,i.jsxs)("td",{className:"text-end",children:[k.toFixed(2),"€"]})]}):(0,i.jsxs)("tr",{children:[(0,i.jsxs)("td",{className:"ps-3 text-muted",children:["Conference Registration ",x]}),(0,i.jsxs)("td",{className:"text-end",children:[h.toFixed(2),"€"]})]}),f.map(((e,t)=>(0,i.jsxs)("tr",{children:[(0,i.jsx)("td",{className:"ps-3 text-muted",children:e.title}),(0,i.jsxs)("td",{className:"text-end",children:[e.price.toFixed(2),"€"]})]},t))),j&&g>0&&(0,i.jsxs)("tr",{children:[(0,i.jsxs)("td",{className:"ps-3 text-muted",children:["Printed Poster",g>1?"s":""," x ",g]}),(0,i.jsxs)("td",{className:"text-end",children:[N.toFixed(2),"€"]})]}),y>0&&p?.tshirt_size&&(0,i.jsxs)("tr",{children:[(0,i.jsxs)("td",{className:"ps-3 text-muted",children:["T-Shirt (",p.tshirt_size,")"]}),(0,i.jsxs)("td",{className:"text-end",children:[y.toFixed(2),"€"]})]}),w&&(0,i.jsxs)("tr",{children:[(0,i.jsx)("td",{className:"ps-3 text-muted",children:"PayPal Fee (3.4% + 0.35€)"}),(0,i.jsxs)("td",{className:"text-end",children:[e?F.toFixed(2):C.toFixed(2),"€"]})]}),(0,i.jsxs)("tr",{children:[(0,i.jsx)("td",{children:(0,i.jsx)("strong",{children:"TOTAL"})}),(0,i.jsx)("td",{className:"text-end",children:(0,i.jsxs)("strong",{children:[(e?S:v).toFixed(2),"€"]})})]})]})]})]})}}
/***/,
/***/2810:
/***/(e,t,a)=>{
// ESM COMPAT FLAG
...
const n=JSON.parse('{"year":2026,"num":"45th","welcome":"Bienvenue !","thank_you":"Merci !","name":"IMC","name_display":"International Meteor Conference","dates":{"start":"2026-09-24","end":"2026-09-27"},"location":"Barcelonnette, France","hotel":"Pôle d\'accueil universitaire Séolane","consulate":"French consulate","deadlines":{"reg":"2026-08-10","paper":"2026-10-31","full_reimbursement_before":"2026-06-30","half_reimbursement_before":"2026-08-10","early_birds":"2026-06-30"},"poster_dim":"A0 size (84.1cm x 118.9cm  / 33.1″ x 46.8″)","poster_print":{"desc":"Maximum size A0 (84.1cm x 118.9cm / 33.1″ x 46.8″), uploaded in PDF, deadline for sending September 1.","size":"A0 size (84.1cm x 118.9cm / 33.1″ x 46.8″)"},"sessions":["Video meteor work","Radio meteor work","Visual meteor work","Meteor physics and dynamics","Meteor stream analyses and modelling","Meteor related software and hardware","Ongoing meteor work","Miscellaneous"],"costs":{"after_early_birds":30,"admin":"15€","online":20,"rooms":[{"price":280,"description":"Triple room in the IMC host","total":15,"beds":3,"sort_order":1,"type":"triple"},{"price":320,"description":"Double room in the IMC host","total":16,"beds":2,"sort_order":2,"type":"double"},{"price":350,"description":"Single room in the IMC host","total":2,"beds":1,"sort_order":3,"type":"single"},{"price":350,"description":"Single room for a person with reduced mobility in the IMC host","total":1,"beds":1,"sort_order":4,"type":"single_accessible"},{"price":200,"description":"No accommodation","sort_order":5,"type":"no"}],"tshirts":{"models":["men","women"],"sizes":["XS","S","M","L","XL","XXL","XXXL"],"price":15},"printed_proceedings":20},"co_organizer":[{"abbr":"IMO","name":"International Meteor Organization","website":"https://imo.net"},{"name":"Fripon Vigie-Ciel","website":"https://www.fripon.org/"}],"contact":[{"q":"a question about the website or a technical difficulty","email":"vperlerin@gmail.com","name":"V. Perlerin"},{"q":"a question about the conference or accommodation","email":"imc2026@imo.net","name":"IMC 2026 Team"},{"q":"a question about payment or your registration","email":"marc.gyssens@uhasselt.be","name":"IMO Treasurer"},{"q":"a question about any other topic","email":"imc2026@imo.net","name":"IMC 2026 Team"}],"with_excursion":false}')}// ./src/data/conference-data.js
/***/,
/***/8075:
