...
return(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)("button",{className:x,onClick:N,children:(0/* SlMenu */,M.jsx)(m.RAm,{className:p})}),!n&&(0,M.jsx)("div",{className:o()(f),onClick:N,onMouseDown:E/* onStopPropagation */._v,onTouchStart:E/* onStopPropagation */._v}),(0,M.jsx)(P.animated.div,{className:o()(b),style:j,children:(0,M.jsxs)("div",{className:o()(g,"d-flex flex-column h-100"),children:[(0,M.jsx)("button",{className:h,onClick:N,children:(0/* SlClose */,M.jsx)(m.ipV,{className:p})}),(0,M.jsxs)("div",{className:"mb-3",children:[(0,M.jsxs)("div",{className:"m-3 text-center",children:[(0,M.jsxs)("h4",{className:"fw-bolder m-0",children:["IMC ",e.year]}),(0,M.jsx)("small",{className:"m-0",children:"ADMIN AREA"})]}),$.map((e=>{const i=a.pathname.startsWith(e.link)||e.subLinks&&e.subLinks.some((e=>a.pathname.startsWith(e.link)));return c||d&&e?.allowed?.includes("loc")||u&&e?.allowed?.includes("soc")?// Hide the menu item if not allowed 
