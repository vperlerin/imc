...
const D=Array.isArray(h/* conferenceData */.p?.workshops)&&h/* conferenceData */.p.workshops.length>0,S=({isCurOnline:e=!1})=>{const{participantId:t,tab:n}=(0,u/* useParams */.g)(),[i,S]=(0,d.useState)(""),[T,M]=(0,d.useState)(!1),[L,E]=(0,d.useState)(null),[I,O]=(0,d.useState)(!1),[P,F]=(0,d.useState)(0),[V,U]=(0,d.useState)(0),[z,Z]=(0,d.useState)(!1),q=n||"identity",W=(0,u/* useNavigate */.Zp)();(0,m/* useBlockNavigation */.V)(I);const{workshops:Y,paymentMethods:B,registrationTypes:R,loading:X,sessions:H,error:G}=(0,x/* useApiSpecificData */.Q)(),{participant:J,loading:Q,error:K}=(0,b/* useApiParticipant */.D)(t,e,z,!0),{control:ee,register:te,handleSubmit:ne,getValues:ie,setValue:ae,formState:{errors:se},reset:re,trigger:oe,watch:le}=(0,p/* useForm */.mN)(),ce="1"===J?.participant?.is_online,de=X||Q||T,me=[i,K,G].filter(Boolean);
// Detect form changes
// Detect form changes
