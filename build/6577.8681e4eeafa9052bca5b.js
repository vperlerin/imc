...
// ----- extras
i&&(l.excursion="0"===i.excursion?"false":"true",l.buy_tshirt="0"===i.buy_tshirt?"false":"true",l.tshirt_size=i.tshirt_size||""),l.food_restrictions=Array.isArray(s)?s:[],l.food_restrictions_other=a??"",oe(l,{keepDirty:!1,keepTouched:!1}),F(!1)}),[Q,G,oe]);const he=[{url:"/admin/participants/"+(de?"online":"onsite"),name:de?"Online Participants":"On-site Participants"},{url:`/admin/participants/${de?"online":"onsite"}/${t}/${W}`,name:`${Q?.participant?.first_name?Q.participant.first_name.charAt(0).toUpperCase()+Q.participant.first_name.slice(1):"Participant"} \n        ${Q?.participant?.last_name||""} - \n        ${W.charAt(0).toUpperCase()+W.slice(1)}`}],xe=Q&&R.length>0&&X.length>0,be=!!Q?.participant?.admin_notes;
...
const P=parseInt(u,10)||250,V=({cd:e})=>{const[t,n]=(0,$.useState)(!1),[i,a]=(0,$.useState)(!0),s=(0,T/* useDispatch */.wA)(),r=(0,L/* useLocation */.zy)(),l=(0,L/* useNavigate */.Zp)(),c=(0/* authSelectors */,T/* useSelector */.d4)(S.Pg.isAdmin),d=(0/* authSelectors */,T/* useSelector */.d4)(S.Pg.isLoc),u=(0/* authSelectors */,T/* useSelector */.d4)(S.Pg.isSoc),[y,v]=(0,M.useSpring)((()=>({right:-P,config:{tension:350,friction:30}})));(0,$.useEffect)((()=>(t?(a(!1),v.start({right:0}),document.body.classList.add("overflow-hidden"),document.documentElement.classList.add("overflow-hidden")):(v.start({right:-P,onRest:()=>a(!0)}),document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")),()=>{document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")})),[t,v]),(0,$.useEffect)((()=>{const e=()=>{n(!1)};return window.addEventListener("resize",e),()=>{window.removeEventListener("resize",e)}}),[]);const j=()=>{n((e=>!e))},N=e=>{l(e),j()};
