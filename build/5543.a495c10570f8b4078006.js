/*! For license information please see 5543.a495c10570f8b4078006.js.LICENSE.txt */
(self.webpackChunkimc2025=self.webpackChunkimc2025||[]).push([[5543],{
/***/115:
/***/e=>{
...
/***/(e,t,r)=>{"use strict";
// EXPORTS
r.d(t,{Kq:()=>/* reexport */l,wA:()=>/* reexport */m,d4:()=>/* reexport */b});
 ...
 * }
 */var g,b=v(),S=r(961);// ./node_modules/react-redux/es/index.js
// Enable batched updates in our subscriptions for use
// with standard React renderers (ReactDOM, React Native)
g=S.unstable_batchedUpdates,a=g}
/***/,
/***/2799:
/***/(e,t)=>{"use strict";
 ...
 */(v,{replace:f,state:d,target:h,preventScrollReset:g,relative:o,viewTransition:b});
...
//#region Hooks
////////////////////////////////////////////////////////////////////////////////
var g,b;function S(e){let t=a.useRef(f(e)),r=a.useRef(!1),n=(0,s/* .useLocation */.zy)(),o=a.useMemo((()=>
 ...
 */
function d(e,t){let{relative:r}=void 0===t?{}:t;h()||(0,a/* .UNSAFE_invariant */.Oi)(!1);let{basename:n,navigator:i}=o.useContext(c),{hash:s,pathname:u,search:l}=b(e,{relative:r}),f=u;
 ...
 */
function g(){let{matches:e}=o.useContext(f),t=e[e.length-1];return t?t.params:{}}
/**
 * Resolves the pathname of the given `to` value against the current location.
 *
 * @see https://reactrouter.com/v6/hooks/use-resolved-path
 */function b(e,t){let{relative:r}=void 0===t?{}:t,{future:n}=o.useContext(c),{matches:i}=o.useContext(f),{pathname:s}=m(),u=JSON.stringify((0,a/* .UNSAFE_getResolveToMatches */.yD)(i,n.v7_relativeSplatPath));return o.useMemo((()=>(0,a/* .resolveTo */.Gh)(e,JSON.parse(u),s,"path"===r)),[e,u,s,r])}
/**
...
function S(e,t,r,n){h()||(0,a/* .UNSAFE_invariant */.Oi)(!1);let{navigator:s,static:u}=o.useContext(c),{matches:p}=o.useContext(f),d=p[p.length-1],y=d?d.params:{},v=(d&&d.pathname,d?d.pathnameBase:"/");d&&d.route;let g,b=m();if(t){var S;let e="string"==typeof t?(0,a/* .parsePath */.Rr)(t):t;"/"===v||(null==(S=e.pathname)?void 0:S.startsWith(v))||(0,a/* .UNSAFE_invariant */.Oi)(!1),g=e}else g=b;let C=g.pathname||"/",x=C;if("/"!==v){
...
let e=v.replace(/^\//,"").split("/");x="/"+C.replace(/^\//,"").split("/").slice(e.length).join("/")}let w=!u&&r&&r.matches&&r.matches.length>0?r.matches:(0,a/* .matchRoutes */.ue)(e,{pathname:x});let T=E(w&&w.map((e=>Object.assign({},e,{params:Object.assign({},y,e.params),pathname:(0,a/* .joinPaths */.HS)([v,
// Re-encode pathnames that were decoded inside matchRoutes
s.encodeLocation?s.encodeLocation(e.pathname).pathname:e.pathname]),pathnameBase:"/"===e.pathnameBase?v:(0,a/* .joinPaths */.HS)([v,
// Re-encode pathnames that were decoded inside matchRoutes
s.encodeLocation?s.encodeLocation(e.pathnameBase).pathname:e.pathnameBase])}))),p,r,n);
// When a user passes in a `locationArg`, the associated routes need to
// be wrapped in a new `LocationContext.Provider` in order for `useLocation`
// to use the scoped location instead of the global location.
return t&&T?o.createElement(l.Provider,{value:{location:i({pathname:"/",search:"",hash:"",state:null,key:"default"},g),navigationType:a/* .Action */.rc.Pop}},T):T}function C(){let e=
/**
 ...
 */
function M(e){let{to:t,replace:r,state:n,relative:i}=e;h()||(0,a/* .UNSAFE_invariant */.Oi)(!1);let{future:s,static:u}=o.useContext(c),{matches:l}=o.useContext(f),{pathname:p}=m(),d=v(),y=(0,a/* .resolveTo */.Gh)(t,(0,a/* .UNSAFE_getResolveToMatches */.yD)(l,s.v7_relativeSplatPath),p,"path"===i),g=JSON.stringify(y);return o.useEffect((()=>d(JSON.parse(g),{replace:r,state:n,relative:i})),[d,g,i,r,n]),null}
/**
...
let d=t.replace(/^\/*/,"/"),m=o.useMemo((()=>({basename:d,navigator:u,static:f,future:i({v7_relativeSplatPath:!1},p)})),[d,p,u,f]);"string"==typeof n&&(n=(0,a/* .parsePath */.Rr)(n));let{pathname:y="/",search:v="",hash:g="",state:b=null,key:S="default"}=n,C=o.useMemo((()=>{let e=(0,a/* .stripBasename */.pb)(y,d);return null==e?null:{location:{pathname:e,search:v,hash:g,state:b,key:S},navigationType:s}}),[d,y,v,g,b,S,s]);return null==C?null:o.createElement(c.Provider,{value:m},o.createElement(l.Provider,{children:r,value:C}))}
/**
...
/***/,
/***/8989:
/***/(e,t)=>{"use strict";var r=60103,n=60106,o=60107,a=60108,i=60114,s=60109,u=60110,c=60112,l=60113,f=60120,p=60115,d=60116,h=60121,m=60122,y=60117,v=60129,g=60131;
