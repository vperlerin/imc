...
var s=a(6942),l=a.n(s),i=a(8027),c=a(6540),r=a(5846),o=a(7762),d=a(4848);// ./src/admin/components/admin-table/index.js
...
return(0,d.jsxs)("tr",{className:"cancelled"===e.status?"text-warning ":"",children:[(0,d.jsx)("td",{children:e.id}),(0,d.jsx)("td",{className:"text-nowrap",children:e.created_at.split(" ")[0]}),(0,d.jsxs)("td",{children:[e.title," ",e.first_name," ",e.last_name]}),o&&(0,d.jsx)("td",{children:(0,d.jsx)("input",{type:"checkbox",className:"form-check-input",title:"Show name on public participants page",checked:"1"===e.can_be_public||1===e.can_be_public,disabled:m===e.id,onChange:t=>o(e,t.target.checked)})}),(0,d.jsxs)("td",{children:[x?(n+h).toFixed(2):n.toFixed(2),"€"]}),(0,d.jsxs)("td",{children:[c.toFixed(2),"€"]}),(0,d.jsxs)("td",{className:l()({"text-success":0===f,"text-danger":f<0}),children:[f.toFixed(2),"€"]}),(0,d.jsx)("td",{children:e.payment_method_name||"n/a"}),u&&(0,d.jsx)("td",{children:p(e.accommodation_type)}),(0,d.jsx)("td",{children:"1"===e.confirmation_sent?"✅":"❌"}),(0,d.jsx)("td",{className:l()("cancelled"===e.status?"text-warning":e?.confirmation_date&&"text-success"),children:"cancelled"===e.status?"CANCELLED":e.confirmation_date?(0,r/* formatFullDate */.Lu)(e.confirmation_date):"❌"}),t&&s&&(0,d.jsx)("td",{children:(0,d.jsxs)("div",{className:"d-flex gap-2 justify-content-end",children:["cancelled"===e.status?(0,d.jsx)("a",{href:`/admin/participants/${e.is_online?"online":"onsite"}/payment/${e.id}`,className:"btn btn-sm btn-outline-success fw-bolder",children:"Reimbursements"}):(0,d.jsx)("a",{href:`/admin/participants/${e.is_online?"online":"onsite"}/payment/${e.id}`,className:"btn btn-sm btn-outline-success fw-bolder",children:"Payments"}),(0,d.jsx)("a",{href:`/admin/participants/${e.is_online?"online":"onsite"}/edit/${e.id}`,className:"btn btn-sm btn-outline-primary fw-bolder",children:"Edit"}),(0,d.jsx)("button",{className:"btn btn-sm btn-outline-danger d-inline-flex align-items-center",onClick:()=>(e=>{s?.(e)})(e),title:"Delete Payment",children:(0/* FaRegTrashAlt */,d.jsx)(i.H8h,{})})]})}),a&&"cancelled"!==e.status&&(0,d.jsx)(d.Fragment,{children:a})]},e.id)})):(0,d.jsx)("tr",{children:(0,d.jsx)("td",{colSpan:N,className:"text-center",children:"No participants found."})})})]})})}}
/***/,
/***/1503:
/***/(e,t,a)=>{a.r(t),
...
/* harmony import */const b=()=>{const{tab:e}=(0,p/* .useParams */.g)(),[t,a]=(0,d.useState)(e||"unconfirmed"),[s,b]=(0,d.useState)([]),[j,g]=(0,d.useState)(""),[N,_]=(0,d.useState)("last_name"),[y,w]=(0,d.useState)(null),[C,v]=(0,d.useState)(!1),[k,D]=(0,d.useState)(!1),[S,$]=(0,d.useState)(""),[T,F]=(0,d.useState)(""),[A,U]=(0,d.useState)(""),[P,L]=(0,d.useState)(null),E=(0,p/* .useNavigate */.Zp)(),{participants:Z,loading:I,error:Y,setParticipants:B}=(0,u/* .useApiOnsiteParticipants */.E)(!1,!0),{deleteParticipant:M,errorDelete:O,isDeleting:R}=(0,h/* .useApiDeleteParticipant */.A)(B,b);
...
return(0/* ["default"] */,f.jsxs)(c.A,{breadcrumb:[{url:"/admin/participants/onsite",name:"On-site Participants"}],isMaxWidth:!0,title:"ON-SITE Participants",rightContent:(0,f.jsx)(f.Fragment,{children:(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)("strong",{children:"Confirmed:"})," ",(0,f.jsx)("strong",{className:"text-success",children:V})," ","| ",(0,f.jsx)("strong",{children:"Unconfirmed:"})," ",(0,f.jsx)("strong",{className:"text-warning",children:W})," ","| ",(0,f.jsx)("strong",{children:"Cancelled:"})," ",(0,f.jsx)("strong",{className:"text-danger",children:H})," ","| ",(0,f.jsx)("strong",{children:"Total:"})," ",(0,f.jsx)("strong",{children:Z.length})]})}),children:[T&&(0,f.jsx)("div",{className:"alert alert-danger fw-bolder",children:T}),S&&(0,f.jsx)("div",{className:"alert alert-success fw-bolder",children:S}),Y&&(0,f.jsx)("p",{className:"alert alert-danger fw-bolder",children:Y}),A&&(0,f.jsx)("div",{className:"alert alert-danger fw-bolder",children:A}),I||R?(0/* ["default"] */,f.jsx)(r.A,{}):(0,f.jsxs)(f.Fragment,{children:[O&&(0,f.jsx)("p",{className:"alert alert-danger",children:O}),(0,f.jsxs)("div",{className:"d-flex flex-column flex-md-row gap-2 mb-3",children:[(0,f.jsxs)("select",{className:"form-select w-auto",value:N,onChange:e=>_(e.target.value),children:[(0,f.jsx)("option",{value:"last_name",children:"Search by Last Name"}),(0,f.jsx)("option",{value:"email",children:"Search by Email"})]}),(0,f.jsxs)("div",{className:"position-relative w-auto",children:[(0,f.jsx)("input",{type:"text",className:"form-control pe-5",placeholder:`Enter ${N.replace("_"," ")}`,value:j,onChange:e=>g(e.target.value)}),(0/* .CiSearch */,f.jsx)(m.Xj1,{className:"position-absolute top-50 end-0 translate-middle-y me-2"})]}),(0/* ["default"] */,f.jsx)(x.A,{className:"ms-auto",link:"https://imc2026.imo.net/php/doc_participants.php"})]}),(0,f.jsxs)("ul",{className:l()("nav nav-tabs mb-3 mt-2",i/* ["default"] */.A.tab,"flex-column flex-sm-row w-100"),children:[(0,f.jsx)("li",{className:"nav-item",children:(0,f.jsxs)("a",{className:`nav-link ${"unconfirmed"===t?i/* ["default"] */.A.active:""}`,href:"/admin/participants/onsite",onClick:e=>{e.preventDefault(),E("/admin/participants/onsite")},children:["Unconfirmed",W>0&&(0,f.jsx)("span",{className:"badge text-bg-warning ms-2",children:W})]})}),(0,f.jsx)("li",{className:"nav-item",children:(0,f.jsxs)("a",{className:`nav-link ${"confirmed"===t?i/* ["default"] */.A.active:""}`,href:"/admin/participants/onsite/confirmed",onClick:e=>{e.preventDefault(),E("/admin/participants/onsite/confirmed")},children:["Confirmed",V>0&&(0,f.jsx)("span",{className:"badge text-bg-success ms-2",children:V})]})}),(0,f.jsx)("li",{className:"nav-item",children:(0,f.jsxs)("a",{className:`nav-link ${"cancelled"===t?i/* ["default"] */.A.active:""}`,href:"/admin/participants/onsite/cancelled",onClick:e=>{e.preventDefault(),E("/admin/participants/onsite/cancelled")},children:["Cancelled",H>0&&(0,f.jsx)("span",{className:"badge text-bg-danger ms-2",children:H})]})})]}),(0/* ["default"] */,f.jsx)(n.A,{participants:s,onDelete:e=>{w(e),v(!0)},onCanBePublicChange:async(e,t)=>{U(""),L(e.id);try{const{data:a}=await o/* ["default"] */.A.post(`https://imc2026.imo.net/php/admin/api/set_participant_can_be_public.php?id=${e.id}`,{can_be_public:t});if(a?.success){const a=t?1:0;B((t=>t.map((t=>t.id===e.id?{...t,can_be_public:a}:t))))}else U(a?.message||"Could not update public listing preference.")}catch(e){U(e.response?.data?.message||"Could not update public listing preference.")}finally{L(null)}},canBePublicSavingId:P,isOnsite:!0})]}),(C||k)&&(0,f.jsx)("div",{className:"modal-backdrop fade show"}),C&&y&&(0,f.jsx)("div",{className:"modal show d-block",children:(0,f.jsx)("div",{className:"modal-dialog",children:(0,f.jsxs)("div",{className:"modal-content",children:[(0,f.jsxs)("div",{className:"modal-header",children:[(0,f.jsx)("h5",{className:"modal-title",children:"Cancel Registration"}),(0,f.jsx)("button",{type:"button",className:"btn-close",onClick:()=>v(!1)})]}),(0,f.jsx)("div",{className:"modal-body",children:(0,f.jsxs)(f.Fragment,{children:[(0,f.jsxs)("p",{children:["Are you sure you want to cancel ",(0,f.jsxs)("b",{children:[y.first_name," ",y.last_name]}),"'s registration?"]}),(0,f.jsx)("p",{children:(0,f.jsx)("strong",{children:"Choose:"})}),(0,f.jsxs)("ul",{children:[(0,f.jsxs)("li",{children:[(0,f.jsx)("strong",{className:"text-warning",children:"Soft Delete:"})," Keeps record but marks as 'cancelled' - so we can keep track of the reimbursement."]}),(0,f.jsxs)("li",{children:[(0,f.jsx)("strong",{className:"text-danger",children:"Hard Delete:"})," Permanently removes data."]})]})]})}),(0,f.jsxs)("div",{className:"modal-footer",children:[(0,f.jsx)("button",{className:"btn btn-outline-secondary fw-bolder",onClick:()=>v(!1),children:"Cancel"}),(0,f.jsx)("button",{className:"btn btn-outline-warning fw-bolder",onClick:()=>q("soft"),children:"Soft Delete"}),(0,f.jsx)("button",{className:"btn btn-outline-danger fw-bolder ms-auto",onClick:()=>{v(!1),D(!0)},children:"Hard Delete"})]})]})})}),k&&(0,f.jsx)("div",{className:"modal show d-block",children:(0,f.jsx)("div",{className:"modal-dialog",children:(0,f.jsxs)("div",{className:"modal-content",children:[(0,f.jsxs)("div",{className:"modal-header",children:[(0,f.jsx)("h5",{className:"modal-title",children:"Confirm Permanent Deletion"}),(0,f.jsx)("button",{type:"button",className:"btn-close",onClick:()=>D(!1)})]}),(0,f.jsx)("div",{className:"modal-body",children:(0,f.jsxs)("p",{children:[(0,f.jsx)("strong",{children:"Are you absolutely sure?"})," This action cannot be undone."]})}),(0,f.jsxs)("div",{className:"modal-footer",children:[(0,f.jsx)("button",{className:"btn btn-outline-danger  fw-bolder",onClick:()=>{q("hard"),D(!1)},children:"Yes, Delete"}),(0,f.jsx)("button",{className:"btn btn-outline-secondary fw-bolder",onClick:()=>D(!1),children:"No"})]})]})})})]})};
...
/* harmony export */A:()=>i
/* harmony export */});
/* harmony import */var n=a(8027),s=(a(6540),a(4976),a(4848));
/* harmony import */const l={xls:(0/* .FaFileExcel */,s.jsx)(n.Ru,{className:"mt-1"})},i=({className:e,format:t="xls",link:a,subTitle:n="",title:i="Download"})=>(0,s.jsxs)("a",{href:a,className:`btn btn-outline-success d-inline-flex align-items-start gap-2 ${e}`,"aria-label":`Download ${i} in ${t.toUpperCase()} format`,children:[l[t]||null,(0,s.jsxs)("div",{className:"d-flex flex-column align-items-start",children:[i,n&&(0,s.jsx)("span",{className:"text-muted fw-normal",children:n})]})]})}
/***/}]);