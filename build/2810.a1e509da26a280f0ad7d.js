"use strict";(self.webpackChunkimc2025=self.webpackChunkimc2025||[]).push([[2810],{
/***/578:
/***/(e,t,a)=>{
// EXPORTS
...
// T-shirt Cost
// Total Calculation
let j=m+h+x+b;const N=y?n(j)-j:0;j+=N;
// Online Conference Cost Calculation
const g=t.costs.online;let _=h+g;const w=y?n(_)-_:0;return _+=w,(0,s.jsxs)("div",{className:"p-2 border rounded flex-shrink-0",children:[(0,s.jsx)("h4",{className:"mb-3",children:"Invoice Summary"}),(0,s.jsxs)("table",{className:"table table-striped table-hover",children:[(0,s.jsx)("thead",{children:(0,s.jsxs)("tr",{children:[(0,s.jsx)("th",{scope:"col",children:"Description"}),(0,s.jsx)("th",{scope:"col",className:"text-end",children:"Price"})]})}),(0,s.jsxs)("tbody",{children:[e?(0,s.jsxs)("tr",{children:[(0,s.jsx)("td",{className:"ps-3 text-muted",children:"Online Conference Registration"}),(0,s.jsxs)("td",{className:"text-end",children:[g.toFixed(2),"€"]})]}):(0,s.jsxs)("tr",{children:[(0,s.jsxs)("td",{className:"ps-3 text-muted",children:["Conference Registration ",p]}),(0,s.jsxs)("td",{className:"text-end",children:[m.toFixed(2),"€"]})]}),u.map(((e,t)=>(0,s.jsxs)("tr",{children:[(0,s.jsx)("td",{className:"ps-3 text-muted",children:e.title}),(0,s.jsxs)("td",{className:"text-end",children:[e.price.toFixed(2),"€"]})]},t))),f>0&&(0,s.jsxs)("tr",{children:[(0,s.jsxs)("td",{className:"ps-3 text-muted",children:["Printed Poster",f>1?"s":""," x ",f]}),(0,s.jsxs)("td",{className:"text-end",children:[b.toFixed(2),"€"]})]}),x>0&&c?.tshirt_size&&(0,s.jsxs)("tr",{children:[(0,s.jsxs)("td",{className:"ps-3 text-muted",children:["T-Shirt (",c.tshirt_size,")"]}),(0,s.jsxs)("td",{className:"text-end",children:[x.toFixed(2),"€"]})]}),y&&(0,s.jsxs)("tr",{children:[(0,s.jsx)("td",{className:"ps-3 text-muted",children:"PayPal Fee (3.4% + 0.35€)"}),(0,s.jsxs)("td",{className:"text-end",children:[e?w.toFixed(2):N.toFixed(2),"€"]})]}),(0,s.jsxs)("tr",{children:[(0,s.jsx)("td",{children:(0,s.jsx)("strong",{children:"TOTAL"})}),(0,s.jsx)("td",{className:"text-end",children:(0,s.jsxs)("strong",{children:[e?_.toFixed(2):j.toFixed(2),"€"]})})]})]})]})]})}}
/***/,
/***/2810:
/***/(e,t,a)=>{
// ESM COMPAT FLAG
...
const v=({isCurOnline:e=!1})=>{const{participantId:t}=(0,h/* useParams */.g)(),[a,r]=(0,d.useState)(!1),[v,C]=(0,d.useState)(""),[k,S]=(0,d.useState)(null),[F,P]=(0,d.useState)(null),[A,M]=(0,d.useState)(null),[I,$]=(0,d.useState)(null),[T,D]=(0,d.useState)(null),[L,E]=(0,d.useState)(!1),[O,R]=(0,d.useState)(!1),[U,W]=(0,d.useState)(!1),[z,Z]=(0,d.useState)(""),[q,H]=(0,d.useState)(!1),{workshops:V,paymentMethods:B,registrationTypes:Y,loading:J,sessions:G,error:Q}=(0,N/* useApiSpecificData */.Q)(),{participant:X,loading:K,error:ee}=(0,g/* useApiParticipant */.D)(t,e,L),{payments:te,loading:ae,error:se,refetchPayments:ne}=j(t),{addPayment:ie}=(e=>{const[t,a]=(0,d.useState)(!1),[s,n]=(0,d.useState)(null),{refetchPayments:i}=j(e);return{addPayment:(0,d.useCallback)((async t=>{if(e){a(!0),n(null);try{const e=await(0,y/* retry */.L)((()=>b/* default */.A.post("https://imc2025.imo.net/php/admin/api/add_payment.php",{paymentData:t},{headers:{"Content-Type":"application/json"}})));if(e.data.success)return await i(),{success:!0,message:"Payment added successfully!"};throw new Error(e.data.message||"Failed to add payment.")}catch(e){return n(e.message||"Error adding payment."),{success:!1,message:e.message}}finally{a(!1)}}}),[e,i]),loading:t,error:s}})(t),{deletePayment:le,loading:re,error:oe}=(e=>{const[t,a]=(0,d.useState)(!1),[s,n]=(0,d.useState)(null),{refetchPayments:i}=j(e);return{deletePayment:(0,d.useCallback)((async t=>{if(e&&t){a(!0),n(null);try{const e=await(0,y/* retry */.L)((()=>b/* default */.A.delete("https://imc2025.imo.net/php/admin/api/delete_payment.php",{data:{payment_id:t},headers:{"Content-Type":"application/json"}})));if(e.data.success)return await i(),{success:!0,message:"Payment deleted successfully!"};throw new Error(e.data.message||"Failed to delete payment.")}catch(e){return n(e.message||"Error deleting payment."),{success:!1,message:e.message}}finally{a(!1)}}}),[e,i]),loading:t,error:s}})(t),{confirmParticipant:ce,isConfirming:de,errorConfirm:me}=(()=>{const[e,t]=(0,d.useState)(null),[a,s]=(0,d.useState)(!1);return{confirmParticipant:async(e,a)=>{if(!e)return null;s(!0),t(null);try{return(await b/* default */.A.post("https://imc2025.imo.net/php/admin/api/confirm.php",{id:e,...a})).data}catch(e){const a=e.response?.data?.message||"An unexpected error occurred.";return t(a),{success:!1,message:a}}finally{s(!1)}},errorConfirm:e,isConfirming:a}})(),{formState:{errors:pe},register:ue,handleSubmit:he,isSubmitting:xe,setValue:fe,watch:be,reset:ye}=(0,f/* useForm */.mN)({defaultValues:{amount:"",paymentMethodId:"",paymentDate:(new Date).toISOString().split("T")[0],adminNote:""}}),je=J||K||xe||ae,Ne=ee||Q||se||k;
// Default Payment Method
// Default Payment Method
(0,d.useEffect)((()=>{X&&X.participant&&fe("paymentMethodId",X.participant.payment_method_id||"")}),[X,fe]),
// Default Amount
// Default Amount
(0,d.useEffect)((()=>{if(X?.participant){const e=parseFloat(X.participant.total_due||0),t=parseFloat(X.participant.paypal_fee||0),a=parseFloat(X.participant.total_paid||0),s=X.participant.payment_method_name?e+t-a:e-a;fe("amount",s.toFixed(2))}}),[X,fe]);
// Refecht Participant
// Refecht Participant
(0,d.useEffect)((()=>{E((e=>!e))}),[te]);
// Confirm
const ge=()=>{$(null),S(null);const e=(()=>{if(!X?.participant)return 0;const e=parseFloat(X.participant.total_due||0),t=parseFloat(X.participant.paypal_fee||0),a=parseFloat(X.participant.total_paid||0);return X.participant.payment_method_name?e+t-a:e-a})();if(e>0){let t=`Marc, you are about to confirm ${`${X?.participant?.first_name} ${X?.participant?.last_name}`} <strong>${we?"ONLINE":"ONSITE"}</strong> registration.`;t+=` <div class="text-danger fw-bolder border rounded-2 p-2 m-3 border-danger">${X?.participant?.first_name} still needs to pay ${e.toFixed(2)}€</div>`,t+="<p>Are you sure you want to continue?</p>",Z(t),R(!0)}else W(!0)},_e=()=>{ye({amount:"",paymentMethodId:"",paymentDate:(new Date).toISOString().split("T")[0],adminNote:""}),D(null)},we="1"===X?.participant?.is_online,ve=[{url:"/admin/participants/"+(we?"online":"onsite"),name:we?"Online Participants":"On-site Participants"},{url:`/admin/participants/${we?"online":"onsite"}/payment/${t}`,name:`${X?.participant?.first_name||"Participant"} ${X?.participant?.last_name||""}'s Payments`}],Ce=`\n    Dear ${X?.participant?.first_name} ${X?.participant?.last_name},<br><br>\n    Your participation in the IMC ${x/* conferenceData */.p.year} has now been confirmed.<br><br>\n    Should your plans change, please contact us immediately: https://imc${x/* conferenceData */.p.year}.imo.net/contact<br> \n    Notice that in such a case, the cancellation policy of the Disclaimer and Service Agreement applies: https://imc${x/* conferenceData */.p.year}.imo.net/disclaimer<br><br>\n    ${v}\n    Thank you!<br>\n    We look forward to meeting you at ${x/* conferenceData */.p.location}.<br><br>\n    The IMC ${x/* conferenceData */.p.year} Team.\n  `,ke=async()=>{if(a){H(!0);try{if(!(await(0,_/* sendEmail */.Z)({subject:`IMC ${x/* conferenceData */.p.year} Confirmation`,message:Ce,to:X.participant.email,toName:"IMC Confirmed Participant",fromName:"IMC 2025",replyTo:"no-reply@imc2025.imo.net",replyName:"no-reply",bcc:"vperlerin@gmail.com".split(",").map((e=>({email:e,name:"BCC Recipient"})))})).success)return void P("Impossible to send the an email for the moment. Please, try again later");await ce(t,{confirmation_sent:!0,confirmation_date:!0}),R(!1),W(!1),
// Refecht participant
E((e=>!e))}catch(e){P("Failed to confirm the participant. Pleaase, try again later.")}finally{H(!1)}}else r(!0)},Se="0"!==X?.participant.confirmation_sent&&0!==X?.participant.confirmation_sent,Fe=!!X?.participant.confirmation_date,Pe=(0,w.jsx)(w.Fragment,{children:(0,w.jsxs)("td",{children:[!Se&&!Fe&&(0,w.jsx)("div",{className:"d-flex gap-2 justify-content-end",children:(0,w.jsx)("button",{className:"btn btn-sm btn-outline-success fw-bolder",onClick:ge,children:"CONFIRM"})}),Se&&!Fe&&(0,w.jsx)("div",{className:"d-flex gap-2 justify-content-end",children:(0,w.jsxs)("button",{className:"btn btn-sm btn-outline-success fw-bolder",onClick:ge,children:["SEND ",(0/* IoIosMail */,w.jsx)(s.lSi,{})]})})]})});
// Reset form fields 
return(0/* default */,w.jsxs)(c.A,{breadcrumb:ve,isMaxWidth:!0,children:[je&&(0/* default */,w.jsx)(m.A,{}),Ne&&(0,w.jsx)("div",{className:"alert alert-danger fw-bolder",children:Ne}),I&&(0,w.jsx)("div",{className:"alert alert-success fw-bolder",children:I}),!je&&(0,w.jsxs)(w.Fragment,{children:[!K&&(0/* default */,w.jsx)(i.A,{participants:[X?.participant],customActions:Pe}),(0,w.jsxs)("div",{className:"d-flex flex-column flex-md-row gap-3 align-items-strecht",children:[(0,w.jsxs)("div",{className:"border p-3 rounded-2 flex-grow-1",children:[(0,w.jsx)("h4",{className:"mb-3",children:T?"Edit":"Add a New Payment/Reimbursement"}),(0,w.jsxs)("form",{onSubmit:he((async e=>{$(null),S(null);const a={participant_id:t,amount:parseFloat(e.amount),payment_method_id:e.paymentMethodId,payment_date:e.paymentDate,admin_note:e.adminNote||null},s=await ie(a);s.success?($("Payment added successfully!"),_e(),await ne()):S(s.message)})),children:[(0,w.jsxs)("div",{className:"mb-3 row",children:[(0,w.jsx)("label",{className:"col-sm-3 col-form-label fw-bold",children:"Amount (€)"}),(0,w.jsxs)("div",{className:"col-sm-5",children:[(0,w.jsx)("input",{type:"number",className:o()("form-control",p/* default */.A.md50),...ue("amount",{required:!0}),step:"0.01"}),pe.amount&&(0,w.jsx)("span",{className:"text-danger",children:"Amount is required."})]})]}),(0,w.jsxs)("div",{className:"mb-3 row",children:[(0,w.jsx)("label",{className:"col-sm-3 col-form-label fw-bold",children:"Payment Method"}),(0,w.jsxs)("div",{className:"col-sm-6",children:[(0,w.jsxs)("select",{className:"form-select",...ue("paymentMethodId",{required:!0}),children:[(0,w.jsx)("option",{value:"",children:"Select a payment/Reimbursement method"}),B.map((e=>(0,w.jsx)("option",{value:e.id,children:e.method},e.id)))]}),pe.paymentMethodId&&(0,w.jsx)("span",{className:"text-danger",children:"Payment method is required."})]})]}),(0,w.jsxs)("div",{className:"mb-3 row",children:[(0,w.jsx)("label",{className:"col-sm-3 col-form-label fw-bold",children:"Payment Date"}),(0,w.jsx)("div",{className:"col-sm-6",children:(0,w.jsx)("input",{type:"date",className:"form-control",...ue("paymentDate",{required:!0})})})]}),(0,w.jsxs)("div",{className:"mb-3 row",children:[(0,w.jsx)("label",{className:"col-sm-3 col-form-label fw-bold",children:"Admin Note (Optional)"}),(0,w.jsx)("div",{className:"col-sm-9",children:(0,w.jsx)("textarea",{className:"form-control",...ue("adminNote"),rows:"2"})})]}),(0,w.jsx)("div",{className:"text-end",children:(0,w.jsx)("button",{type:"submit",className:"btn btn-outline-primary fw-bolder",disabled:xe,children:xe?"Processing...":T?"Update Payment":"Add Payment"})})]})]}),(0/* default */,w.jsx)(u.A,{isOnline:we,conferenceData:x/* conferenceData */.p,participantData:X,workshops:V,registrationTypes:Y,paymentMethods:B})]}),te&&te.length>0&&!(1===te.length&&0===parseFloat(te[0].amount))&&(0,w.jsxs)("div",{className:"border p-3 rounded-2 mt-3",children:[(0,w.jsx)("h4",{className:"mb-3",children:"Payments in record"}),(A||oe)&&(0,w.jsx)("div",{className:"alert alert-danger fw-bolder",children:A||oe}),(0,w.jsxs)("table",{className:"table table-bordered table-striped",children:[(0,w.jsx)("thead",{children:(0,w.jsxs)("tr",{children:[(0,w.jsx)("th",{children:"Date"}),(0,w.jsx)("th",{children:"Amount (€)"}),(0,w.jsx)("th",{children:"Method"}),(0,w.jsx)("th",{children:"Admin Note"}),(0,w.jsx)("th",{})]})}),(0,w.jsx)("tbody",{children:te.map((e=>0!==parseFloat(e.amount)?(0,w.jsxs)("tr",{children:[(0,w.jsx)("td",{children:e.payment_date.split(" ")[0]||"n/a"}),(0,w.jsx)("td",{children:parseFloat(e.amount).toFixed(2)}),(0,w.jsx)("td",{children:e.payment_method}),(0,w.jsx)("td",{children:e.admin_note||"No note"}),(0,w.jsx)("td",{children:(0,w.jsx)("div",{className:"position-relative",children:(0,w.jsxs)("button",{className:"btn btn-outline-danger d-inline-flex align-items-center",onClick:()=>(async e=>{if(!window.confirm("Are you sure you want to delete this payment?"))return;const t=await le(e);t.success?($("Payment deleted successfully!"),
// Refecht participant
E((e=>!e)),await ne()):M(t.message)})(e.id),children:[re&&(0/* default */,w.jsx)(m.A,{}),(0/* FaRegTrashAlt */,w.jsx)(n.H8h,{})]})})})]},e.id):null))})]})]}),(O||U)&&(0,w.jsx)("div",{className:"modal-backdrop fade show"}),O&&(0,w.jsx)("div",{className:"modal modal-lg show d-block",children:(0,w.jsx)("div",{className:"modal-dialog",children:(0,w.jsxs)("div",{className:"modal-content",children:[(0,w.jsxs)("div",{className:"modal-header",children:[(0,w.jsx)("h5",{className:"modal-title",children:"CONFIRMATION"}),(0,w.jsx)("button",{type:"button",className:"btn-close",onClick:()=>R(!1)})]}),(0,w.jsx)("div",{className:"modal-body",children:(0,w.jsx)("div",{dangerouslySetInnerHTML:{__html:z}})}),(0,w.jsxs)("div",{className:"modal-footer",children:[(0,w.jsx)("button",{className:"btn btn-outline-danger fw-bolder",onClick:()=>R(!1),children:"Cancel"}),(0,w.jsx)("button",{className:"btn btn-outline-success fw-bolder",onClick:()=>{R(!1),W(!0)},children:"Yes"})]})]})})}),U&&(0,w.jsx)("div",{className:"modal modal-lg show d-block",children:(0,w.jsx)("div",{className:"modal-dialog",children:(0,w.jsxs)("div",{className:"modal-content",children:[(0,w.jsxs)("div",{className:"modal-header",children:[(0,w.jsx)("h5",{className:"modal-title",children:"CONFIRMATION"}),(0,w.jsx)("button",{type:"button",className:"btn-close",onClick:()=>W(!1)})]}),(0,w.jsxs)("div",{className:"modal-body",children:[me&&(0,w.jsx)("div",{className:"text-danger fw-bolder",children:me}),F&&!me&&(0,w.jsx)("div",{className:"text-danger fw-bolder",children:F}),de||q&&(0/* default */,w.jsx)(m.A,{}),!a&&(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)("p",{className:"fw-bolder",children:"Marc, make your choice: "}),(0,w.jsxs)("div",{className:"d-flex w-100 gap-3 mt-3",children:[!Se&&!Fe&&(0,w.jsxs)("button",{className:"fw-bolder btn btn-outline-success",onClick:ke,disabled:de,children:["CONFIRM & SEND ",(0/* IoIosMail */,w.jsx)(s.lSi,{})]}),Se&&!Fe||!Se&&!Fe&&(0,w.jsx)("button",{className:"fw-bolder btn btn-outline-success",onClick:async()=>{H(!0);try{await ce(t,{confirmation_sent:!0}),R(!1),W(!1),
// Refecht participant
E((e=>!e))}catch(e){P("Failed to confirm the participant. Pleaase, try again later.")}finally{H(!1)}},disabled:de,children:"CONFIRM"}),Se&&!Fe&&(0,w.jsxs)("button",{className:"fw-bolder btn btn-outline-success",onClick:async()=>{if(a){H(!0);try{if(!(await(0,_/* sendEmail */.Z)({subject:`IMC ${x/* conferenceData */.p.year} Confirmation`,message:Ce,to:X.participant.email,toName:"IMC Confirmed Participant",fromName:"IMC 2025",replyTo:"no-reply@imc2025.imo.net",replyName:"no-reply",bcc:"vperlerin@gmail.com".split(",").map((e=>({email:e,name:"BCC Recipient"})))})).success)return void P("Impossible to send the an email for the moment. Please, try again later");await ce(t,{confirmation_date:!0}),R(!1),W(!1),
// Refecht participant
E((e=>!e))}catch(e){P("Failed to confirm the participant. Pleaase, try again later.")}finally{H(!1)}}else r(!0)},disabled:de,children:["SEND ",(0/* IoIosMail */,w.jsx)(s.lSi,{})]}),me&&(0,w.jsx)("div",{className:"text-danger",children:me})]})]}),a&&(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)("div",{children:(0,w.jsxs)("div",{className:"my-3 d-flex flex-column flex-md-row gap-3 align-items-strecht",children:[(0,w.jsxs)("div",{className:l.col,children:["Below is the email that is going to be sent:",(0,w.jsx)("div",{className:"bg-white text-black p-3 rounded mt-2",dangerouslySetInnerHTML:{__html:Ce}})]}),(0,w.jsxs)("div",{className:l.col,children:["Use the input below if you want to add text",(0,w.jsx)("textarea",{className:`form-control mt-2 ${l.textarea}`,rows:"3",value:v.replace(/<br>$/,"").replace(/<br>/g,"\n"),onChange:e=>C(e.target.value.replace(/\n/g,"<br>")+"<br>"),placeholder:"Add extra message here..."})]})]})}),(0,w.jsxs)("div",{className:"d-flex gap-3 justify-content-end",children:[(0,w.jsx)("button",{className:"btn btn-outline-neutral fw-bolder",onClick:()=>r(!1),children:"Cancel"}),(0,w.jsxs)("button",{className:"btn btn-outline-success fw-bolder",onClick:ke,disabled:de,children:["SEND NOW ",(0/* IoIosMail */,w.jsx)(s.lSi,{})]})]})]})]})]})})})]})]})};
/* harmony default export */}
/***/,
/***/3318:
/***/(e,t,a)=>{
...
/* harmony export */});const s=(e,{interval:t=100,retries:a=14}={})=>new Promise(((n,i)=>{e().then(n).catch((l=>{setTimeout((()=>{a?s(e,{interval:1.5*t,retries:a-1}).then(n,i):i(l)}),t)}))}));
/***/},
/***/3464:
...
return(0,n.useEffect)((()=>{(async()=>{try{const e=await(0,s/* .retry */.L)((()=>i/* ["default"] */.A.get("https://imc2025.imo.net/php/get_specific_data.php")));if(!e.data.success)throw new Error(e.data.message||"Failed to fetch specific IMC data. Please, refresh the page.");t(e.data.data.workshops||[]),l(e.data.data.payment_methods||[]),o(e.data.data.registration_types||[]),d(e.data.data.sessions||[])}catch(e){h(e.message||"Failed to fetch specific IMC data. Please, refresh the page.")}finally{p(!1)}})()}),[]),{workshops:e,paymentMethods:a,registrationTypes:r,sessions:c,loading:m,error:u}};
/***/},
/***/4972:
/***/(e,t,a)=>{
/* harmony export */a.d(t,{
...
/* harmony export */});
// ---- Utilities ----
const s=e=>{const t=Number(e);if(t>=11&&t<=13)return"th";switch(t%10){case 1:return"st";case 2:return"nd";case 3:return"rd";default:return"th"}},n=e=>{if(e instanceof Date)return new Date(e.getTime());if("number"==typeof e)return new Date(e);if("string"==typeof e){
...
const t=new Date(e);if(!Number.isNaN(t))return t;const a=new Date(e.replace(" ","T"));if(!Number.isNaN(a))return a}return new Date(NaN)},i=e=>e instanceof Date&&!Number.isNaN(e)
// Get parts safely, defaulting to UTC for consistency with pure dates
,l=(e,{locale:t="en-US",timeZone:a="UTC"}={})=>({day:Number(new Intl.DateTimeFormat(t,{day:"numeric",timeZone:a}).format(e)),monthName:new Intl.DateTimeFormat(t,{month:"long",timeZone:a}).format(e),weekday:new Intl.DateTimeFormat(t,{weekday:"long",timeZone:a}).format(e),year:Number(new Intl.DateTimeFormat(t,{year:"numeric",timeZone:a}).format(e))}),r=(e,t,{locale:a="en-US",timeZone:r="UTC"}={})=>{const o=n(e),c=n(t);if(!i(o)||!i(c))return"";const d=l(o,{locale:a,timeZone:r}),m=l(c,{locale:a,timeZone:r});return d.monthName===m.monthName&&o.getUTCFullYear()===c.getUTCFullYear()?`${d.monthName} ${d.day}${s(d.day)} - ${m.day}${s(m.day)}`:`${d.monthName} ${d.day}${s(d.day)} - ${m.monthName} ${m.day}${s(m.day)}`;
// Different months (or years)
},o=(e,t=!0,a=!1,r={})=>((e,t=!1,a=!0,r=!1,{locale:o="en-US",timeZone:c="UTC"}={})=>{const d=n(e);if(!i(d))return"";// or return a fallback like "—"
const{day:m,monthName:p,weekday:u,year:h}=l(d,{locale:o,timeZone:c});return`${t?`${u}, `:""}${m}${s(m)}${a?` ${p}`:""}${r?` ${h}`:""}`})(e,!0,t,a,r),c=(e,t,a=!0,s=!0,{locale:l="en-US",timeZone:r="UTC"}={})=>{const c=n(e);if(!i(c))return"";const d=(m=c,p=t,new Date(Date.UTC(m.getUTCFullYear(),m.getUTCMonth(),m.getUTCDate()+Number(p))));var m,p;return o(d,a,s,{locale:l,timeZone:r})};
...
// EXTERNAL MODULE: ./node_modules/classnames/index.js
var l=a(6942),r=a.n(l),o=a(3464);// ./src/admin/components/header/index.module.scss
// extracted by mini-css-extract-plugin
...
var A=a(8983),M=a(1448),I=a(8321),$=a(7767),T=a(4976);
...
const O=parseInt(p,10)||250,R=({cd:e})=>{const[t,a]=(0,S.useState)(!1),[s,n]=(0,S.useState)(!0),i=(0,M/* useDispatch */.wA)(),l=(0,$/* useLocation */.zy)(),o=(0,$/* useNavigate */.Zp)(),c=(0/* authSelectors */,M/* useSelector */.d4)(A.Pg.isAdmin),d=(0/* authSelectors */,M/* useSelector */.d4)(A.Pg.isLoc),p=(0/* authSelectors */,M/* useSelector */.d4)(A.Pg.isSoc),[g,_]=(0,I.useSpring)((()=>({right:-O,config:{tension:350,friction:30}})));(0,S.useEffect)((()=>(t?(n(!1),_.start({right:0}),document.body.classList.add("overflow-hidden"),document.documentElement.classList.add("overflow-hidden")):(_.start({right:-O,onRest:()=>n(!0)}),document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")),()=>{document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")})),[t,_]),(0,S.useEffect)((()=>{const e=()=>{a(!1)};return window.addEventListener("resize",e),()=>{window.removeEventListener("resize",e)}}),[]);const w=()=>{a((e=>!e))},v=e=>{o(e),w()};
...
// extracted by mini-css-extract-plugin
/* harmony default export */const q="breadcrumb-module__nav--atkeN",H=({links:e=[]})=>(0/* authSelectors */,M/* useSelector */.d4)(A.Pg.isAdmin)?(0,F.jsx)("nav",{"aria-label":"breadcrumb",className:q,children:(0,F.jsxs)("ol",{className:r()("breadcrumb"),children:[(0,F.jsx)("li",{className:"breadcrumb-item lh-0",children:(0/* Link */,F.jsx)(T.N_,{to:"/admin/dashboard",children:(0/* IoHomeOutline */,F.jsx)(Z.M14,{className:"me-1"})})}),e.map(((t,a)=>(0,F.jsx)("li",{className:r()("breadcrumb-item",{active:a===e.length-1}),"aria-current":a===e.length-1?"page":void 0,children:a===e.length-1?(0,F.jsx)("b",{children:t.name}):(0/* Link */,F.jsx)(T.N_,{to:t.url,children:t.name})},a)))]})}):null,V=({breadcrumb:e=[],title:t="",rightContent:a,children:l,isMaxWidth:o=!0})=>{const c=t?`${t} | ${U/* conferenceData */.p.name_display} ${U/* conferenceData */.p.year}`:`${U/* conferenceData */.p.name_display} ${U/* conferenceData */.p.year}`;
return(0,F.jsxs)(F.Fragment,{children:[(0/* Helmet */,F.jsxs)(z.mg,{children:[(0,F.jsx)("title",{children:c}),(0,F.jsx)("meta",{name:"robots",content:"noindex"})]}),(0,F.jsxs)("div",{className:r()(s,"position-relative"),children:[(0,F.jsx)(W,{}),(0,F.jsxs)("div",{className:"d-flex flex-row",children:[(0,F.jsx)(R,{cd:U/* conferenceData */.p}),(0,F.jsxs)("div",{className:r()("mx-md-4 my-3 h-100 flex-grow-1 d-flex flex-column px-3 px-md-0",{[`${i} mx-md-auto`]:o}),children:[0!==e.length&&(0,F.jsx)(H,{links:e}),(!!t||!!a)&&(0,F.jsxs)("div",{className:r()("d-flex justify-content-between align-items-center",n),children:[t&&(0,F.jsx)("h2",{children:t}),a&&(0,F.jsx)("div",{children:a})]}),l]})]})]})]})}}
/***/,
/***/7762:
/***/(e,t,a)=>{
// EXPORTS
