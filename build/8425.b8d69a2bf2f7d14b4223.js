...
const R=()=>{const e=`${z/* conferenceData */.p.name} ${z/* conferenceData */.p.year}`;
return(0,S.jsxs)("div",{className:"d-flex align-items-center justify-content-between border-bottom",children:[(0,S.jsx)(P,{cd:z/* conferenceData */.p}),(0,S.jsx)("nav",{className:"p-0 flex-wrap","aria-label":"Main navigation",children:(0,S.jsx)("div",{className:o()(c,"d-flex flex-row flew-wrap px-2 mb-1 justify-content-between"),children:(0/* Link */,S.jsxs)(F.N_,{"aria-label":"Admin",className:o()("d-flex align-items-center text-dark text-decoration-none gap-2",d),to:"/admin/dashboard",title:"Admin",children:[(0,S.jsx)("img",{src:r,alt:e,className:"rounded-circle border border-2 p-1"}),(0,S.jsxs)("div",{className:"d-flex flex-column",children:[(0,S.jsxs)("h1",{className:"m-0 fw-bolder",children:[z/* conferenceData */.p.name," ",z/* conferenceData */.p.year]}),(0,S.jsx)("h2",{className:"m-0 d-none d-md-block",children:"ADMIN AREA"})]})]})})})]})};
/* harmony default export */
...
return(0,S.jsx)("nav",{"aria-label":"breadcrumb",className:V,children:(0,S.jsxs)("ol",{className:o()("breadcrumb"),children:[(0,S.jsx)("li",{className:"breadcrumb-item lh-0",children:(0/* Link */,S.jsx)(F.N_,{to:"/admin/dashboard",children:(0/* IoHomeOutline */,S.jsx)(H.M14,{className:"me-1"})})}),t.map(((e,n)=>(0,S.jsx)("li",{className:o()("breadcrumb-item",{active:n===t.length-1}),"aria-current":n===t.length-1?"page":void 0,children:n===t.length-1?(0,S.jsx)("b",{children:e.name}):(0/* Link */,S.jsx)(F.N_,{to:e.url,children:e.name})},n)))]})})},B=e=>{let{breadcrumb:t=[],title:n="",rightContent:l,children:r,isMaxWidth:c=!0}=e;const d=n?`${n} | ${z/* conferenceData */.p.name_display} ${z/* conferenceData */.p.year}`:`${z/* conferenceData */.p.name_display} ${z/* conferenceData */.p.year}`;
return(0,S.jsxs)(S.Fragment,{children:[(0/* Helmet */,S.jsxs)(q.mg,{children:[(0,S.jsx)("title",{children:d}),(0,S.jsx)("meta",{name:"robots",content:"noindex"})]}),(0,S.jsxs)("div",{className:o()(s,"position-relative"),children:[(0,S.jsx)(R,{}),(0,S.jsxs)("div",{className:"d-flex flex-row",children:[(0,S.jsx)(P,{cd:z/* conferenceData */.p}),(0,S.jsxs)("div",{className:o()("mx-md-4 my-3 h-100 flex-grow-1 d-flex flex-column px-3 px-md-0",{[`${i} mx-md-auto`]:c}),children:[0!==t.length&&(0,S.jsx)(U,{links:t}),(0,S.jsxs)("div",{className:o()("d-flex justify-content-between align-items-center",a),children:[n&&(0,S.jsx)("h2",{children:n}),l&&(0,S.jsx)("div",{children:l})]}),r]})]})]})]})}}
/***/,
/***/7762:
/***/(e,t,n)=>{
// EXPORTS
