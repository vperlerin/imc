...
"confirmation_sent"===u&&(a="1"===a?1:0,n="1"===n?1:0),"can_be_public"===u&&(a="1"===a||1===a?1:0,n="1"===n||1===n?1:0),a<n?"asc"===f?-1:1:a>n?"asc"===f?1:-1:0})),g=9+(c?1:0)+(p?1:0)+(t||a?1:0);
...
return(0,d.jsxs)("tr",{className:"cancelled"===e.status?"text-warning ":"",children:[(0,d.jsx)("td",{children:e.id}),(0,d.jsx)("td",{className:"text-nowrap",children:e.created_at.split(" ")[0]}),(0,d.jsxs)("td",{children:[e.title," ",e.first_name," ",e.last_name]}),c&&(0,d.jsx)("td",{children:(0,d.jsx)("input",{type:"checkbox",className:"form-check-input",title:"Show name on public participants page",checked:"1"===e.can_be_public||1===e.can_be_public,disabled:m===e.id,onChange:t=>c(e,t.target.checked)})}),(0,d.jsxs)("td",{children:[x?(n+u).toFixed(2):n.toFixed(2),"€"]}),(0,d.jsxs)("td",{children:[r.toFixed(2),"€"]}),(0,d.jsxs)("td",{className:i()({"text-success":0===f,"text-danger":f<0}),children:[f.toFixed(2),"€"]}),(0,d.jsx)("td",{children:e.payment_method_name||"n/a"}),p&&(0,d.jsx)("td",{children:h(e.accommodation_type)}),(0,d.jsx)("td",{children:"1"===e.confirmation_sent?"✅":"❌"}),(0,d.jsx)("td",{className:i()("cancelled"===e.status?"text-warning":e?.confirmation_date&&"text-success"),children:"cancelled"===e.status?"CANCELLED":e.confirmation_date?(0,o/* formatFullDate */.Lu)(e.confirmation_date):"❌"}),t&&s&&(0,d.jsx)("td",{children:(0,d.jsxs)("div",{className:"d-flex gap-2 justify-content-end",children:["cancelled"===e.status?(0,d.jsx)("a",{href:`/admin/participants/${e.is_online?"online":"onsite"}/payment/${e.id}`,className:"btn btn-sm btn-outline-success fw-bolder",children:"Reimbursements"}):(0,d.jsx)("a",{href:`/admin/participants/${e.is_online?"online":"onsite"}/payment/${e.id}`,className:"btn btn-sm btn-outline-success fw-bolder",children:"Payments"}),(0,d.jsx)("a",{href:`/admin/participants/${e.is_online?"online":"onsite"}/edit/${e.id}`,className:"btn btn-sm btn-outline-primary fw-bolder",children:"Edit"}),(0,d.jsx)("button",{className:"btn btn-sm btn-outline-danger d-inline-flex align-items-center",onClick:()=>(e=>{s?.(e)})(e),title:"Delete Payment",children:(0/* FaRegTrashAlt */,d.jsx)(l.H8h,{})})]})}),a&&"cancelled"!==e.status&&(0,d.jsx)(d.Fragment,{children:a})]},e.id)})):(0,d.jsx)("tr",{children:(0,d.jsx)("td",{colSpan:g,className:"text-center",children:"No participants found."})})})]})})}}
/***/,
/***/914:
/***/(e,t,a)=>{
...
// Selected Workshops
const{selected:f,totalPrice:b}=((e=[],t)=>{if(!Array.isArray(e))return{selected:[],totalPrice:0};const a=e.map((e=>({title:e.title,price:r(t?e.price_online:e.price,0)}))),n=a.reduce(((e,t)=>e+t.price),0);return{selected:a,totalPrice:n}})(m,e),y="1"===p?.buy_tshirt||"true"===p?.buy_tshirt?r(t?.costs?.tshirts?.price,0):0,j=(0,n/* .offersOnsitePosterPrint */.a)(t),g=(u||[]).filter((e=>"1"===e.print||"true"===e.print)),_=j?g.length:0,N=_*r(t?.poster_print?.price,0),w="paypal"===String(c?.payment_method_name||"Unknown").toLowerCase();
// T-shirt Cost
// Total Calculation
let v=h+b+y+N;const C=w?l(v)-v:0;v+=C;
// Online Conference Cost Calculation
const k=r(t?.costs?.online,0);let S=b+k;const F=w?l(S)-S:0;return S+=F,(0,i.jsxs)("div",{className:"p-2 border rounded flex-shrink-0",children:[(0,i.jsx)("h4",{className:"mb-3",children:"Invoice Summary"}),(0,i.jsxs)("table",{className:"table table-striped table-hover",children:[(0,i.jsx)("thead",{children:(0,i.jsxs)("tr",{children:[(0,i.jsx)("th",{scope:"col",children:"Description"}),(0,i.jsx)("th",{scope:"col",className:"text-end",children:"Price"})]})}),(0,i.jsxs)("tbody",{children:[e?(0,i.jsxs)("tr",{children:[(0,i.jsx)("td",{className:"ps-3 text-muted",children:"Online Conference Registration"}),(0,i.jsxs)("td",{className:"text-end",children:[k.toFixed(2),"€"]})]}):(0,i.jsxs)("tr",{children:[(0,i.jsxs)("td",{className:"ps-3 text-muted",children:["Conference Registration ",x]}),(0,i.jsxs)("td",{className:"text-end",children:[h.toFixed(2),"€"]})]}),f.map(((e,t)=>(0,i.jsxs)("tr",{children:[(0,i.jsx)("td",{className:"ps-3 text-muted",children:e.title}),(0,i.jsxs)("td",{className:"text-end",children:[e.price.toFixed(2),"€"]})]},t))),j&&_>0&&(0,i.jsxs)("tr",{children:[(0,i.jsxs)("td",{className:"ps-3 text-muted",children:["Printed Poster",_>1?"s":""," x ",_]}),(0,i.jsxs)("td",{className:"text-end",children:[N.toFixed(2),"€"]})]}),y>0&&p?.tshirt_size&&(0,i.jsxs)("tr",{children:[(0,i.jsxs)("td",{className:"ps-3 text-muted",children:["T-Shirt (",p.tshirt_size,")"]}),(0,i.jsxs)("td",{className:"text-end",children:[y.toFixed(2),"€"]})]}),w&&(0,i.jsxs)("tr",{children:[(0,i.jsx)("td",{className:"ps-3 text-muted",children:"PayPal Fee (3.4% + 0.35€)"}),(0,i.jsxs)("td",{className:"text-end",children:[e?F.toFixed(2):C.toFixed(2),"€"]})]}),(0,i.jsxs)("tr",{children:[(0,i.jsx)("td",{children:(0,i.jsx)("strong",{children:"TOTAL"})}),(0,i.jsx)("td",{className:"text-end",children:(0,i.jsxs)("strong",{children:[(e?S:v).toFixed(2),"€"]})})]})]})]})]})}}
/***/,
/***/2810:
/***/(e,t,a)=>{
// ESM COMPAT FLAG
...
const O=parseInt(p,10)||250,R=({cd:e})=>{const[t,a]=(0,S.useState)(!1),[n,s]=(0,S.useState)(!0),i=(0,$/* useDispatch */.wA)(),l=(0,M/* useLocation */.zy)(),o=(0,M/* useNavigate */.Zp)(),c=(0/* authSelectors */,$/* useSelector */.d4)(A.Pg.isAdmin),d=(0/* authSelectors */,$/* useSelector */.d4)(A.Pg.isLoc),p=(0/* authSelectors */,$/* useSelector */.d4)(A.Pg.isSoc),[_,N]=(0,I.useSpring)((()=>({right:-O,config:{tension:350,friction:30}})));(0,S.useEffect)((()=>(t?(s(!1),N.start({right:0}),document.body.classList.add("overflow-hidden"),document.documentElement.classList.add("overflow-hidden")):(N.start({right:-O,onRest:()=>s(!0)}),document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")),()=>{document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")})),[t,N]),(0,S.useEffect)((()=>{const e=()=>{a(!1)};return window.addEventListener("resize",e),()=>{window.removeEventListener("resize",e)}}),[]);const w=()=>{a((e=>!e))},v=e=>{o(e),w()};
return(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)("button",{className:u,onClick:w,children:(0/* SlMenu */,F.jsx)(m.RAm,{className:x})}),!n&&(0,F.jsx)("div",{className:r()(b),onClick:w,onMouseDown:D/* onStopPropagation */._v,onTouchStart:D/* onStopPropagation */._v}),(0,F.jsx)(I.animated.div,{className:r()(f),style:_,children:(0,F.jsxs)("div",{className:r()(y,"d-flex flex-column h-100"),children:[(0,F.jsx)("button",{className:h,onClick:w,children:(0/* SlClose */,F.jsx)(m.ipV,{className:x})}),(0,F.jsxs)("div",{className:"mb-3",children:[(0,F.jsxs)("div",{className:"m-3 text-center",children:[(0,F.jsxs)("h4",{className:"fw-bolder m-0",children:["IMC ",e.year]}),(0,F.jsx)("small",{className:"m-0",children:"ADMIN AREA"})]}),L.map((e=>{const t=l.pathname.startsWith(e.link)||e.subLinks&&e.subLinks.some((e=>l.pathname.startsWith(e.link)));return c||d&&e?.allowed?.includes("loc")||p&&e?.allowed?.includes("soc")?// Hide the menu item if not allowed 
