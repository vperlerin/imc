...
return(0,L.jsx)("nav",{"aria-label":"breadcrumb",className:V,children:(0,L.jsxs)("ol",{className:r()("breadcrumb"),children:[(0,L.jsx)("li",{className:"breadcrumb-item lh-0",children:(0/* Link */,L.jsx)($.N_,{to:"/admin/dashboard",children:(0/* IoHomeOutline */,L.jsx)(H.M14,{className:"me-1"})})}),t.map(((e,s)=>(0,L.jsx)("li",{className:r()("breadcrumb-item",{active:s===t.length-1}),"aria-current":s===t.length-1?"page":void 0,children:s===t.length-1?(0,L.jsx)("b",{children:e.name}):(0/* Link */,L.jsx)($.N_,{to:e.url,children:e.name})},s)))]})})},B=e=>{let{breadcrumb:t=[],title:s="",rightContent:l,children:o,isMaxWidth:c=!0}=e;const d=s?`${s} | ${z/* conferenceData */.p.name_display} ${z/* conferenceData */.p.year}`:`${z/* conferenceData */.p.name_display} ${z/* conferenceData */.p.year}`;
return(0,L.jsxs)(L.Fragment,{children:[(0/* Helmet */,L.jsxs)(F.mg,{children:[(0,L.jsx)("title",{children:d}),(0,L.jsx)("meta",{name:"robots",content:"noindex"})]}),(0,L.jsxs)("div",{className:r()(a,"position-relative"),children:[(0,L.jsx)(q,{}),(0,L.jsxs)("div",{className:"d-flex flex-row",children:[(0,L.jsx)(R,{cd:z/* conferenceData */.p}),(0,L.jsxs)("div",{className:r()("mx-md-4 my-3 h-100 flex-grow-1 d-flex flex-column px-3 px-md-0",{[`${i} mx-md-auto`]:c}),children:[0!==t.length&&(0,L.jsx)(U,{links:t}),(0,L.jsxs)("div",{className:r()("d-flex justify-content-between align-items-center",n),children:[s&&(0,L.jsx)("h2",{children:s}),l&&(0,L.jsx)("div",{children:l})]}),o]})]})]})]})}}
/***/,
/***/7762:
/***/(e,t,s)=>{
// EXPORTS
...
/* harmony import */const l={xls:(0/* .FaFileExcel */,i.jsx)(a.Ru,{})},r=e=>{let{link:t,className:s,format:a="xls",title:r="Download"}=e;return t.startsWith("/php/")?(0,i.jsxs)("a",{href:t,className:`btn btn-outline-success d-inline-flex align-items-center gap-2 ${s}`,"aria-label":`Download ${r} in ${a.toUpperCase()} format`,children:[l[a]||null," ",r]}):(0/* .Link */,i.jsxs)(n.N_,{className:`btn btn-outline-success d-inline-flex align-items-center gap-2 ${s}`,to:t,"aria-label":`Download ${r} in ${a.toUpperCase()} format`,children:[l[a]||null," ",r]})}}
/***/}]);