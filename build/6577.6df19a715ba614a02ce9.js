...
const S=({isCurOnline:e=!1})=>{const{participantId:t,tab:n}=(0,u/* useParams */.g)(),[i,S]=(0,d.useState)(""),[D,T]=(0,d.useState)(!1),[M,L]=(0,d.useState)(null),[E,I]=(0,d.useState)(!1),[O,P]=(0,d.useState)(0),[V,F]=(0,d.useState)(0),[U,z]=(0,d.useState)(!1),W=n||"identity",Z=(0,u/* useNavigate */.Zp)();(0,m/* useBlockNavigation */.V)(E);const{workshops:q,paymentMethods:Y,registrationTypes:R,loading:B,sessions:H,error:G}=(0,x/* useApiSpecificData */.Q)(),{participant:J,loading:Q,error:X}=(0,b/* useApiParticipant */.D)(t,e,U,!0),{control:K,register:ee,handleSubmit:te,getValues:ne,setValue:ie,formState:{errors:ae},trigger:se,watch:re}=(0,p/* useForm */.mN)(),oe="1"===J?.participant?.is_online,le=B||Q||D,ce=[i,X,G].filter(Boolean);
// Paypal fess
// Paypal fess
(0,d.useEffect)((()=>{F(V)}),[V]),
// Detect form changes
...
/***/(e,t,n)=>{
// EXPORTS
n.d(t,{A:()=>/* binding */R});// ./src/admin/components/page-contain/index.module.scss
// extracted by mini-css-extract-plugin
...
var D=n(8983),T=n(1448),M=n(8321),L=n(7767),E=n(4976);
...
const V=parseInt(u,10)||250,F=({cd:e})=>{const[t,n]=(0,C.useState)(!1),[i,a]=(0,C.useState)(!0),s=(0,T/* useDispatch */.wA)(),r=(0,L/* useLocation */.zy)(),l=(0,L/* useNavigate */.Zp)(),c=(0/* authSelectors */,T/* useSelector */.d4)(D.Pg.isAdmin),d=(0/* authSelectors */,T/* useSelector */.d4)(D.Pg.isLoc),u=(0/* authSelectors */,T/* useSelector */.d4)(D.Pg.isSoc),[y,v]=(0,M.useSpring)((()=>({right:-V,config:{tension:350,friction:30}})));(0,C.useEffect)((()=>(t?(a(!1),v.start({right:0}),document.body.classList.add("overflow-hidden"),document.documentElement.classList.add("overflow-hidden")):(v.start({right:-V,onRest:()=>a(!0)}),document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")),()=>{document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")})),[t,v]),(0,C.useEffect)((()=>{const e=()=>{n(!1)};return window.addEventListener("resize",e),()=>{window.removeEventListener("resize",e)}}),[]);const j=()=>{n((e=>!e))},N=e=>{l(e),j()};
