...
var M=s(8321),I=s(8983),E=s(1448),$=s(7767),D=s(4976);
...
return(0,S.jsx)("nav",{"aria-label":"breadcrumb",className:V,children:(0,S.jsxs)("ol",{className:o()("breadcrumb"),children:[(0,S.jsx)("li",{className:"breadcrumb-item lh-0",children:(0/* Link */,S.jsx)(D.N_,{to:"/admin/dashboard",children:(0/* IoHomeOutline */,S.jsx)(H.M14,{className:"me-1"})})}),t.map(((e,s)=>(0,S.jsx)("li",{className:o()("breadcrumb-item",{active:s===t.length-1}),"aria-current":s===t.length-1?"page":void 0,children:s===t.length-1?(0,S.jsx)("b",{children:e.name}):(0/* Link */,S.jsx)(D.N_,{to:e.url,children:e.name})},s)))]})})},B=e=>{let{breadcrumb:t=[],title:s="",rightContent:l,children:r,isMaxWidth:c=!0}=e;const d=s?`${s} | ${R/* conferenceData */.p.name_display} ${R/* conferenceData */.p.year}`:`${R/* conferenceData */.p.name_display} ${R/* conferenceData */.p.year}`;
return(0,S.jsxs)(S.Fragment,{children:[(0/* Helmet */,S.jsxs)(F.mg,{children:[(0,S.jsx)("title",{children:d}),(0,S.jsx)("meta",{name:"robots",content:"noindex"})]}),(0,S.jsxs)("div",{className:o()(a,"position-relative"),children:[(0,S.jsx)(q,{}),(0,S.jsxs)("div",{className:"d-flex flex-row",children:[(0,S.jsx)(O,{cd:R/* conferenceData */.p}),(0,S.jsxs)("div",{className:o()("mx-md-4 my-3 h-100 flex-grow-1 d-flex flex-column px-3 px-md-0",{[`${i} mx-md-auto`]:c}),children:[0!==t.length&&(0,S.jsx)(U,{links:t}),(0,S.jsxs)("div",{className:o()("d-flex justify-content-between align-items-center",n),children:[s&&(0,S.jsx)("h2",{children:s}),l&&(0,S.jsx)("div",{children:l})]}),r]})]})]})]})}}
/***/,
/***/7762:
/***/(e,t,s)=>{
// EXPORTS
...
/* harmony import */const l={xls:(0/* .FaFileExcel */,i.jsx)(a.Ru,{})},o=e=>{let{link:t,className:s,format:a="xls",title:o="Download"}=e;return t.startsWith("/php/")?(0,i.jsxs)("a",{href:t,className:`btn btn-outline-success d-inline-flex align-items-center gap-2 ${s}`,"aria-label":`Download ${o} in ${a.toUpperCase()} format`,children:[l[a]||null," ",o]}):(0/* .Link */,i.jsxs)(n.N_,{className:`btn btn-outline-success d-inline-flex align-items-center gap-2 ${s}`,to:t,"aria-label":`Download ${o} in ${a.toUpperCase()} format`,children:[l[a]||null," ",o]})}}
/***/}]);