...
var r=n(4178),o=n(1083),l=n(7647),c=n(6645),d=n(6540),m=n(2199),u=n(7767),p=n(9785),h=n(7762),x=n(4493),b=n(4972),f=n(4976),g=n(847),_=n(3975),w=n(9156),y=n(8299),v=n(5680),j=n(6538),N=n(5058),k=n(6827),A=n(4668),$=n(5846),C=n(4848);
// EXTERNAL MODULE: ./node_modules/axios/lib/axios.js + 48 modules
// ./src/admin/pages/participants/single/index.js
const D=Array.isArray(h/* conferenceData */.p?.workshops)&&h/* conferenceData */.p.workshops.length>0,T=({isCurOnline:e=!1})=>{const{participantId:t,tab:n}=(0,u/* useParams */.g)(),[i,T]=(0,d.useState)(""),[M,S]=(0,d.useState)(!1),[L,E]=(0,d.useState)(null),[I,O]=(0,d.useState)(!1),[P,F]=(0,d.useState)(0),[V,U]=(0,d.useState)(0),[z,Z]=(0,d.useState)(!1),q=n||"identity",W=(0,u/* useNavigate */.Zp)();(0,m/* useBlockNavigation */.V)(I);const{workshops:Y,paymentMethods:B,registrationTypes:R,loading:H,sessions:G,error:Q}=(0,x/* useApiSpecificData */.Q)(),{participant:X,loading:J,error:K}=(0,b/* useApiParticipant */.D)(t,e,z,!0),{control:ee,register:te,handleSubmit:ne,getValues:ie,setValue:ae,formState:{errors:se},reset:re,trigger:oe,watch:le}=(0,p/* useForm */.mN)(),ce="1"===X?.participant?.is_online,de=H||J||M,me=[i,K,Q].filter(Boolean);
// Detect form changes
// Detect form changes
(0,d.useEffect)((()=>{const e=le((()=>{O(!0)}));return()=>e.unsubscribe()}),[le]);const ue=`/admin/participants/${e?"online":"onsite"}/edit/${t}`;(0,d.useEffect)((()=>{const e=Number.isInteger(Number(t))&&Number(t)>0;!n&&e&&W(`${ue}/summary`,{replace:!0})}),[n,t,W,ue]),(0,d.useEffect)((()=>{"workshops"===n&&!D&&t&&W(`${ue}/summary`,{replace:!0})}),[n,D,t,W,ue]),(0,d.useEffect)((()=>{if(!X||0===G.length)return;const{accommodation:e,arrival:t,contributions:n,extra_options:i,food_other_text:a,food_restrictions:s,participant:r,workshops:o}=X||{},l={},c=r?.dob;if(c){const[e,t,n]=c.split("-");l.dobDay=String(Number(n)),l.dobMonth=String(Number(t)),l.dobYear=e}
...
// ----- extras
i&&(l.excursion="0"===i.excursion?"false":"true",l.buy_tshirt="0"===i.buy_tshirt?"false":"true",l.tshirt_size=i.tshirt_size||""),l.food_restrictions=Array.isArray(s)?s:[],l.food_restrictions_other=a??"",re(l,{keepDirty:!1,keepTouched:!1}),O(!1)}),[X,G,re]);const pe=[{url:"/admin/participants/"+(ce?"online":"onsite"),name:ce?"Online Participants":"On-site Participants"},{url:`/admin/participants/${ce?"online":"onsite"}/${t}/${q}`,name:`${X?.participant?.first_name?X.participant.first_name.charAt(0).toUpperCase()+X.participant.first_name.slice(1):"Participant"} \n        ${X?.participant?.last_name||""} - \n        ${q.charAt(0).toUpperCase()+q.slice(1)}`}],he=X&&B.length>0&&R.length>0,xe=!!X?.participant?.admin_notes;
return(0/* default */,C.jsxs)(l.A,{breadcrumb:pe,isMaxWidth:!0,children:[(0,C.jsxs)("div",{className:"position-relative fw-bolder",children:[de&&(0/* default */,C.jsx)(c.A,{}),me.length>0&&(0,C.jsx)("div",{className:"alert alert-danger fw-bolder",children:(0,C.jsx)("ul",{className:"mb-0",children:me.map(((e,t)=>(0,C.jsx)("li",{children:e},t)))})}),L&&!de&&(0,C.jsx)("div",{className:"alert alert-success",children:L})]}),X&&he&&!de&&(0,C.jsxs)("form",{onSubmit:ne((async e=>{S(!0),T(null),E(null);// Triggers validation on all fields
if(!await oe())return S(!1),void T("Please fill in all required fields.");e.talks=ie("talks")||[],e.posters=ie("posters")||[];const n={...e,total_due:P,paypal_fee:V};try{const e=await o/* default */.A.post(`https://imc2026.imo.net/php/admin/api/update_${ce?"online":"onsite"}_participant.php?id=${t}`,n,{headers:{"Content-Type":"application/json"}});if(!e.data.success)throw new Error(e.data.message||"Failed to update participant.");Z((e=>!e)),E("Participant updated successfully!")}catch(e){T(e.message)}finally{S(!1)}})),children:[(0,C.jsx)("ul",{className:a()("nav nav-tabs mb-3 mt-2",r/* default */.A.tab,"flex-column flex-sm-row"),children:[{key:"summary",label:"Billing"},{key:"identity",label:"Identity"},...D?[{key:"workshops",label:"Workshops"}]:[],...ce?[]:[{key:"arrival",label:"Arrival"}],{key:"contribution",label:"Contribution"},...ce?[{key:"accommodation",label:"Pay. Method"}]:[{key:"accommodation",label:"Acc. & Pay. Method"}],...ce?[]:[{key:"extras",label:"Extras"}],{key:"comments",label:"Comments"},{key:"admin_notes",label:"Marc's notes"}].map((({key:e,label:t})=>(0,C.jsx)("li",{className:"nav-item",children:(0,C.jsx)("a",{className:a()("nav-link",q===e&&r/* default */.A.active),href:`${ue}/${e}`,onClick:t=>{t.preventDefault(),W(`${ue}/${e}`)},children:xe&&"admin_notes"===e?(0,C.jsxs)("span",{className:"position-relative",children:[(0,C.jsx)("span",{className:"position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger",children:"!"}),t]}):(0,C.jsx)(C.Fragment,{children:t})})},e)))}),(0,C.jsxs)("div",{className:a()("tab-content mx-auto",r/* default */.A.contentMxw),children:["identity"===n&&(0,C.jsxs)(C.Fragment,{children:[(0/* default */,C.jsx)(g.A,{isAdmin:!0,isOnline:ce,register:te,errors:se,setValue:ae,trigger:oe}),(0/* default */,C.jsx)(y.A,{isAdmin:!0,register:te,setValue:ae,errors:se,trigger:oe,initialData:X?.participant,watch:le})]}),D&&"workshops"===n&&(0/* default */,C.jsx)(_.A,{isAdmin:!0,isOnline:ce,conferenceData:h/* conferenceData */.p,register:te,errors:se,setValue:ae,trigger:oe,watch:le,workshops:Y}),"arrival"===n&&!ce&&(0/* default */,C.jsx)(w.A,{isAdmin:!0,conferenceData:h/* conferenceData */.p,register:te,errors:se,setValue:ae,trigger:oe}),"contribution"===n&&(0/* default */,C.jsx)(v.A,{isAdmin:!0,isOnline:ce,conferenceData:h/* conferenceData */.p,control:ee,register:te,errors:se,getValues:ie,setValue:ae,watch:le,trigger:oe,sessions:G}),"accommodation"===n&&(0/* default */,C.jsx)(j.A,{isAdmin:!0,isOnline:ce,isEarlyBird:1===X?.participant.is_early_bird||"1"===X?.participant.is_early_bird,conferenceData:h/* conferenceData */.p,control:ee,register:te,errors:se,paymentMethods:B,setValue:ae,registrationTypes:R,trigger:oe}),"extras"===n&&!ce&&(0/* default */,C.jsx)(N.A,{isAdmin:!0,conferenceData:h/* conferenceData */.p,register:te,errors:se,getValues:ie,setValue:ae,trigger:oe,watch:le,control:ee}),"comments"===n&&(0,C.jsx)("div",{className:a()(s,"mx-auto"),children:(0/* default */,C.jsx)(k.A,{isAdmin:!0,isOnline:ce,register:te,errors:se,setValue:ae,trigger:oe})}),(0,C.jsxs)("div",{className:a()(s,"mx-auto","summary"===n&&he?"visible":"invisible h-0 w-0 overflow-hidden"),children:[(0,C.jsxs)("div",{className:"d-flex mt-3 align-items-center justify-content-between w-100 mb-3",children:[(0,C.jsxs)("div",{children:[(0,C.jsxs)("strong",{children:[X?.participant?.first_name?X.participant.first_name.charAt(0).toUpperCase()+X.participant.first_name.slice(1):""," ",X?.participant?.last_name||""]})," ","1"===X.participant.confirmation_sent?(0,C.jsxs)(C.Fragment,{children:["has been confirmed on ",(0,C.jsx)("span",{className:"text-success",children:X.participant.confirmation_date&&(0,$/* formatFullDate */.Lu)(X.participant.confirmation_date)})]}):(0,C.jsx)(C.Fragment,{children:"❌  has NOT been confirmed yet."})]}),"1"!==X.participant.confirmation_sent&&(0,C.jsx)("div",{children:(0/* Link */,C.jsx)(f.N_,{className:"btn btn-outline-success fw-bolder",to:`/admin/participants/${ce?"online":"onsite"}/payment/${t}`,children:"Go to Payments to confirm"})})]}),(0/* default */,C.jsx)(A.A,{isAdmin:!0,isOnline:ce,isEarlyBird:1===X?.participant.is_early_bird||"1"===X?.participant.is_early_bird,conferenceData:h/* conferenceData */.p,getValues:ie,setValue:ae,setTotal:F,setPaypalFee:U,workshops:Y,registrationTypes:R,paymentMethods:B,watch:le})]}),"admin_notes"===n&&(0,C.jsxs)("div",{className:a()(s,"mx-auto mb-3"),children:[(0,C.jsx)("label",{htmlFor:"admin_notes",className:"form-label fw-bold",children:"Admin Notes"}),(0,C.jsx)("textarea",{id:"admin_notes",className:"form-control",placeholder:"Enter your admin notes here",rows:6,...te("admin_notes")}),se.admin_notes&&(0,C.jsx)("div",{className:"text-danger mt-1",children:se.admin_notes.message})]}),(0,C.jsx)("div",{className:"mt-4 d-flex justify-content-end",children:(0,C.jsx)("button",{type:"submit",className:"btn btn-outline-primary fw-bolder",disabled:M,children:M?"Saving...":"Save Changes"})})]})]})]})}}
/***/,
/***/1280:
/***/(e,t,n)=>{
