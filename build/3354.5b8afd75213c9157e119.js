...
return(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)("button",{className:u,onClick:g,children:(0/* SlMenu */,M.jsx)(d.RAm,{className:h})}),!s&&(0,M.jsx)("div",{className:l()(b),onClick:g,onMouseDown:T/* onStopPropagation */._v,onTouchStart:T/* onStopPropagation */._v}),(0,M.jsx)(I.animated.div,{className:l()(p),style:m,children:(0,M.jsxs)("div",{className:l()(f,"d-flex flex-column h-100"),children:[(0,M.jsx)("button",{className:x,onClick:g,children:(0/* SlClose */,M.jsx)(d.ipV,{className:h})}),(0,M.jsxs)("div",{className:"mb-3",children:[(0,M.jsxs)("div",{className:"m-3 text-center",children:[(0,M.jsxs)("h4",{className:"fw-bolder m-0",children:["IMC ",n.year]}),(0,M.jsx)("small",{className:"m-0",children:"ADMIN AREA"})]}),O.map((e=>{const n=r.pathname.startsWith(e.link)||e.subLinks&&e.subLinks.some((e=>r.pathname.startsWith(e.link)));if(!e.hideFromMenu)
