...
/* harmony export */});const n=(e,{interval:t=1e3,retries:a=6}={})=>new Promise(((s,l)=>{e().then(s).catch((r=>{setTimeout((()=>{a?n(e,{interval:1.5*t,retries:a-1}).then(s,l):l(r)}),t)}))}));
/***/},
/***/4265:
/***/(e,t,a)=>{
/* harmony export */a.d(t,{
...
/* harmony import */const l=(e,t)=>{const[a,l]=(0,n.useState)(null),[r,i]=(0,n.useState)(!1);return{deleteParticipant:async(a,n)=>{if(!a)return null;i(!0),l(null);try{const l=await s/* ["default"] */.A.post("https://imc2026.imo.net/php/admin/api/delete_participant.php",{id:a.id,delete_type:n});return l.data.success&&("hard"===n?(e((e=>e.filter((e=>e.id!==a.id)))),t((e=>e.filter((e=>e.id!==a.id))))):(
