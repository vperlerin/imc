...
/* harmony export */});
/* harmony import */var s=a(408),n=a(578),l=a(7647),i=a(6645),r=a(6540),c=a(3388),d=a(7806),o=a(8057),m=a(4848);
/* harmony import */const h=()=>{const[e,t]=(0,r.useState)([]),[a,h]=(0,r.useState)(""),[u,p]=(0,r.useState)("last_name"),[x,j]=(0,r.useState)(null),[f,b]=(0,r.useState)(!1),[g,N]=(0,r.useState)(!1),[_,y]=(0,r.useState)(""),[w,C]=(0,r.useState)(""),{participants:v,loading:S,error:k,setParticipants:D}=(0,c/* .useApiOnsiteParticipants */.E)(!1,!0),{deleteParticipant:A,errorDelete:F,isDeleting:$}=(0,d/* .useApiDeleteParticipant */.A)(D,t);(0,r.useEffect)((()=>{if(a){const e=a.toLowerCase();t(v.filter((t=>(t[u]?String(t[u]).toLowerCase():"").includes(e))))}else t(v)}),[a,u,v]);
// Calculate totals
const L=v.length,P=v.filter((e=>"1"===e.confirmation_sent)).length,E=async e=>{if(x)try{const t=await A(x,e);t?.data?.success?(y(t.data.message||"Participant deleted successfully!"),C("")):C(t?.data?.message||"Impossible to delete the participant for now, please try again later.")}catch(e){C("An unexpected error occurred while deleting the participant.")}finally{
// Close the correct modal depending on type
"soft"===e?b(!1):N(!1),j(null)}};
return(0/* ["default"] */,m.jsxs)(l.A,{breadcrumb:[{url:"/admin/participants/onsite",name:"On-site Participants"}],isMaxWidth:!0,title:"ON-SITE Participants",rightContent:(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)("strong",{children:"Confirmed:"})," ",(0,m.jsx)("strong",{className:"text-success",children:P})," / ",L]}),children:[w&&(0,m.jsx)("div",{className:"alert alert-danger fw-bolder",children:w}),_&&(0,m.jsx)("div",{className:"alert alert-success fw-bolder",children:_}),k&&(0,m.jsx)("p",{className:"alert alert-danger fw-bolder",children:k}),S||$?(0/* ["default"] */,m.jsx)(i.A,{}):(0,m.jsxs)(m.Fragment,{children:[F&&(0,m.jsx)("p",{className:"alert alert-danger",children:F}),(0,m.jsxs)("div",{className:"d-flex flex-column flex-md-row gap-2 mb-3",children:[(0,m.jsxs)("select",{className:"form-select w-auto",value:u,onChange:e=>p(e.target.value),children:[(0,m.jsx)("option",{value:"last_name",children:"Search by Last Name"}),(0,m.jsx)("option",{value:"email",children:"Search by Email"})]}),(0,m.jsxs)("div",{className:"position-relative w-auto",children:[(0,m.jsx)("input",{type:"text",className:"form-control pe-5",placeholder:`Enter ${u.replace("_"," ")}`,value:a,onChange:e=>h(e.target.value)}),(0/* .CiSearch */,m.jsx)(s.Xj1,{className:"position-absolute top-50 end-0 translate-middle-y me-2"})]}),(0/* ["default"] */,m.jsx)(o.A,{className:"ms-auto",link:"https://imc2025.imo.net/php/doc_participants.php"})]}),(0/* ["default"] */,m.jsx)(n.A,{participants:e,onDelete:e=>{j(e),b(!0)}})]}),(f||g)&&(0,m.jsx)("div",{className:"modal-backdrop fade show"}),f&&x&&(0,m.jsx)("div",{className:"modal show d-block",children:(0,m.jsx)("div",{className:"modal-dialog",children:(0,m.jsxs)("div",{className:"modal-content",children:[(0,m.jsxs)("div",{className:"modal-header",children:[(0,m.jsx)("h5",{className:"modal-title",children:"Cancel Registration"}),(0,m.jsx)("button",{type:"button",className:"btn-close",onClick:()=>b(!1)})]}),(0,m.jsx)("div",{className:"modal-body",children:(0,m.jsxs)(m.Fragment,{children:[(0,m.jsxs)("p",{children:["Are you sure you want to cancel ",(0,m.jsxs)("b",{children:[x.first_name," ",x.last_name]}),"'s registration?"]}),(0,m.jsx)("p",{children:(0,m.jsx)("strong",{children:"Choose:"})}),(0,m.jsxs)("ul",{children:[(0,m.jsxs)("li",{children:[(0,m.jsx)("strong",{className:"text-warning",children:"Soft Delete:"})," Keeps record but marks as 'cancelled' - so we can keep track of the reimbursement."]}),(0,m.jsxs)("li",{children:[(0,m.jsx)("strong",{className:"text-danger",children:"Hard Delete:"})," Permanently removes data."]})]})]})}),(0,m.jsxs)("div",{className:"modal-footer",children:[(0,m.jsx)("button",{className:"btn btn-outline-secondary fw-bolder",onClick:()=>b(!1),children:"Cancel"}),(0,m.jsx)("button",{className:"btn btn-outline-warning fw-bolder",onClick:()=>E("soft"),children:"Soft Delete"}),(0,m.jsx)("button",{className:"btn btn-outline-danger fw-bolder ms-auto",onClick:()=>{b(!1),N(!0)},children:"Hard Delete"})]})]})})}),g&&(0,m.jsx)("div",{className:"modal show d-block",children:(0,m.jsx)("div",{className:"modal-dialog",children:(0,m.jsxs)("div",{className:"modal-content",children:[(0,m.jsxs)("div",{className:"modal-header",children:[(0,m.jsx)("h5",{className:"modal-title",children:"Confirm Permanent Deletion"}),(0,m.jsx)("button",{type:"button",className:"btn-close",onClick:()=>N(!1)})]}),(0,m.jsx)("div",{className:"modal-body",children:(0,m.jsxs)("p",{children:[(0,m.jsx)("strong",{children:"Are you absolutely sure?"})," This action cannot be undone."]})}),(0,m.jsxs)("div",{className:"modal-footer",children:[(0,m.jsx)("button",{className:"btn btn-outline-danger  fw-bolder",onClick:()=>{E("hard"),N(!1)},children:"Yes, Delete"}),(0,m.jsx)("button",{className:"btn btn-outline-secondary fw-bolder",onClick:()=>N(!1),children:"No"})]})]})})})]})};
/* harmony default export */}
/***/,
/***/3318:
/***/(e,t,a)=>{
