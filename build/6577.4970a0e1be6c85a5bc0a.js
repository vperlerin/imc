...
var r=n(4178),o=n(1083),l=n(7647),c=n(6645),d=n(6540),m=n(2199),u=n(7767),p=n(9785),h=n(7762),x=n(4493),b=n(4972),f=n(4976),g=n(847),_=n(3975),w=n(9156),v=n(8299),j=n(5680),y=n(6538),k=n(5058),N=n(6827),A=n(4668),S=n(5846),L=n(4848);
// EXTERNAL MODULE: ./node_modules/axios/lib/axios.js + 48 modules
// ./src/admin/pages/participants/single/index.js
const M=({isCurOnline:e=!1})=>{const{participantId:t,tab:n}=(0,u/* useParams */.g)(),[i,M]=(0,d.useState)(""),[C,$]=(0,d.useState)(!1),[D,E]=(0,d.useState)(null),[O,P]=(0,d.useState)(!1),[V,I]=(0,d.useState)(0),[T,z]=(0,d.useState)(0),[F,W]=(0,d.useState)(!1),q=n||"identity",R=(0,u/* useNavigate */.Zp)();(0,m/* useBlockNavigation */.V)(O);const{workshops:U,paymentMethods:B,registrationTypes:H,loading:Y,sessions:G,error:Z}=(0,x/* useApiSpecificData */.Q)(),{participant:J,loading:Q,error:X}=(0,b/* useApiParticipant */.D)(t,e,F,!0),{control:K,register:ee,handleSubmit:te,getValues:ne,setValue:ie,formState:{errors:se},trigger:ae,watch:re}=(0,p/* useForm */.mN)(),oe="1"===J?.participant?.is_online,le=Y||Q||C,ce=[i,X,Z].filter(Boolean);
// Paypal fess
// Paypal fess
(0,d.useEffect)((()=>{z(T)}),[T]),
// Detect form changes
// Detect form changes
(0,d.useEffect)((()=>{const e=re((()=>{P(!0)}));return()=>e.unsubscribe()}),[re]),(0,d.useEffect)((()=>{n||R(`/admin/participants/onsite/${t}/summary`,{replace:!0})}),[n,t,R]),(0,d.useEffect)((()=>{if(!J||0===G.length)return;
...
void 0!==e.can_be_public&&ie("can_be_public",e.can_be_public?"true":"false"),t&&Array.isArray(t)){const e=t.map((e=>String(e.id)));ie("workshops",e)}
