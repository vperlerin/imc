...
const h=e=>{let{workshopId:t}=e;const[s,h]=(0,l.useState)(""),[p,u]=(0,l.useState)("all"),[x,b]=(0,l.useState)(null),[f,g]=(0,l.useState)("asc"),{participants:j,loading:_}=(e=>{const[t,s]=(0,l.useState)([]),[a,n]=(0,l.useState)(!0),[i,c]=(0,l.useState)(null);// Re-fetch when workshopId changes
...
let S=j||[];if("all"!==p&&(S=S.filter((e=>"online"===p?"1"===e.is_online:"0"===e.is_online))),s){const e=s.toLowerCase();S=S.filter((t=>(t[k]?String(t[k]).toLowerCase():"").includes(e)))}
// Sort participants based on selected column
return x&&(S=[...S].sort(((e,t)=>{let s=e[x]??"",a=t[x]??"";
// Convert values for proper sorting
return["created_at"].includes(x)?(s=new Date(s).getTime()||0,a=new Date(a).getTime()||0):(s=s.toString().toLowerCase(),a=a.toString().toLowerCase()),s<a?"asc"===f?-1:1:s>a?"asc"===f?1:-1:0}))),(0/* default */,m.jsx)(n.A,{breadcrumb:y,isMaxWidth:!0,title:N?N.title:"Workshop Participants",children:_||w?(0/* default */,m.jsx)(i.A,{}):(0,m.jsxs)(m.Fragment,{children:[(0,m.jsxs)("div",{className:"d-flex gap-2 mb-3",children:[(0,m.jsxs)("select",{className:"form-select w-auto",value:p,onChange:e=>u(e.target.value),children:[(0,m.jsx)("option",{value:"all",children:"All"}),(0,m.jsx)("option",{value:"online",children:"Online"}),(0,m.jsx)("option",{value:"onsite",children:"On-Site"})]}),(0,m.jsxs)("div",{className:"position-relative w-auto",children:[(0,m.jsx)("input",{type:"text",className:"form-control pe-5",placeholder:`Enter ${k.replace("_"," ")}`,value:s,onChange:e=>h(e.target.value)}),(0/* CiSearch */,m.jsx)(a.Xj1,{className:"position-absolute top-50 end-0 translate-middle-y me-2"})]}),(0/* default */,m.jsx)(d.A,{className:"ms-auto",link:`https://imc2025.imo.net/php/doc_workshops.php?workshop_id=${t}`})]}),(0,m.jsx)("div",{className:"table-responsive",style:{maxWidth:"calc(100vw - 2rem)"},children:(0,m.jsxs)("table",{className:"table table-striped",children:[(0,m.jsx)("thead",{children:(0,m.jsxs)("tr",{children:[(0,m.jsx)("th",{className:"sortable",onClick:()=>C("created_at"),children:"Reg. Date"}),(0,m.jsx)("th",{className:"sortable",onClick:()=>C("is_online"),children:"Type"}),(0,m.jsx)("th",{className:"sortable",onClick:()=>C("last_name"),children:"Name"}),(0,m.jsx)("th",{className:"sortable",onClick:()=>C("registration_type_description"),children:"Reg. Type"}),(0,m.jsx)("th",{className:"sortable",onClick:()=>C("confirmation_sent"),children:"Confirmed"})]})}),(0,m.jsx)("tbody",{children:S.length>0?S.map((e=>(0,m.jsxs)("tr",{children:[(0,m.jsx)("td",{children:e.created_at.split(" ")[0]}),(0,m.jsx)("td",{children:"0"===e.is_online?"ON-SITE":"ONLINE"}),(0,m.jsxs)("td",{children:[e.title," ",e.first_name," ",e.last_name]}),(0,m.jsx)("td",{children:e.registration_type_description||"n/a"}),(0,m.jsx)("td",{children:"1"===e.confirmation_sent?"✅":"❌"})]},e.id))):(0,m.jsx)("tr",{children:(0,m.jsx)("td",{colSpan:"8",className:"text-center",children:"No participants found for this workshop."})})})]})})]})})};
...
/* harmony import */const l=()=>{const[e,t]=(0,n.useState)([]),[s,l]=(0,n.useState)([]),[r,o]=(0,n.useState)([]),[c,d]=(0,n.useState)([]),[m,h]=(0,n.useState)(!0),[p,u]=(0,n.useState)(null);// Runs only once when the component mounts
return(0,n.useEffect)((()=>{(async()=>{try{const e=await(0,a/* .retry */.L)((()=>i/* ["default"] */.A.get("https://imc2025.imo.net/php/get_specific_data.php")));if(!e.data.success)throw new Error(e.data.message||"Failed to fetch specific IMC data. Please, refresh the page.");t(e.data.data.workshops||[]),l(e.data.data.payment_methods||[]),o(e.data.data.registration_types||[]),d(e.data.data.sessions||[])}catch(e){u(e.message||"Failed to fetch specific IMC data. Please, refresh the page.")}finally{h(!1)}})()}),[]),{workshops:e,paymentMethods:s,registrationTypes:r,sessions:c,loading:m,error:p}};
/***/},
/***/7647:
/***/(e,t,s)=>{
// EXPORTS
...
// extracted by mini-css-extract-plugin
/* harmony default export */const h="300px",p="index-module__menuBtn--iHux0",u="index-module__menuCloseBtn--jCTip",x="index-module__menuIcon--i9Mwv",b="index-module__swipeWrap--a2OL4",f="index-module__menuOpenOverlay--caMms",g="index-module__menu--veCcg",j="index-module__active--EYt3Y",_="index-module__footer--O9Npd",v="index-module__menuItem--eqnJw",w="index-module__menuItemTitle--O6gep",k="index-module__active--Hl_ax",N="index-module__caret--U_US2",y="index-module__rotate--pnUGY",C="index-module__menuItemsHolder--aPOed";
// EXTERNAL MODULE: ./node_modules/react/index.js
var S=s(6540),L=s(4848);
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
// ./src/admin/components/header/menu/item/index.js
const M=S.forwardRef(((e,t)=>{let{children:s,className:a,goTo:n=null,isLinkActive:i,title:l,url:o=null}=e;const[c,d]=(0,S.useState)(i),[m,h]=(0,S.useState)("0px"),p=(0,S.useRef)(null);(0,S.useEffect)((()=>{s&&h(c?`${p.current.scrollHeight}px`:"0px")}),[s,c,p]);const u=e=>(0,L.jsx)("div",{className:r()(e.className,c&&y),children:(0,L.jsx)("svg",{viewBox:"0 0 320 512",xmlns:"http://www.w3.org/2000/svg",children:(0,L.jsx)("path",{d:"M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z",fill:e.fill})})});
return(0,L.jsxs)("div",{className:r()(v,"d-flex flex-column",a),ref:t,children:[(0,L.jsxs)("a",{className:r()(w,"d-flex justify-content-between w-100 align-items-center px-3",i&&k),href:o||void 0,onClick:e=>{e.preventDefault(),s?d(!c):n&&o&&n(o)},children:[(0,L.jsx)("span",{className:"d-flex align-items-center",children:(0,L.jsx)("b",{children:l})}),s&&(0,L.jsx)(u,{className:N})]}),s&&(0,L.jsx)("div",{className:C,ref:p,style:s&&{maxHeight:`${m}`},children:s})]})}));
/* harmony default export */
...
const $=parseInt(h,10)||250,R=e=>{let{cd:t}=e;const[s,a]=(0,S.useState)(!1),[n,i]=(0,S.useState)(!0),l=(0,E/* useDispatch */.wA)(),o=(0,T/* useLocation */.zy)(),c=(0,T/* useNavigate */.Zp)(),[d,h]=(0,A.useSpring)((()=>({right:-$,config:{tension:350,friction:30}})));(0,S.useEffect)((()=>(s?(i(!1),h.start({right:0}),document.body.classList.add("overflow-hidden"),document.documentElement.classList.add("overflow-hidden")):(h.start({right:-$,onRest:()=>i(!0)}),document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")),()=>{document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")})),[s,h]),(0,S.useEffect)((()=>{const e=()=>{a(!1)};return window.addEventListener("resize",e),()=>{window.removeEventListener("resize",e)}}),[]);const v=()=>{a((e=>!e))},w=e=>{c(e),v()};
return(0,L.jsxs)(L.Fragment,{children:[(0,L.jsx)("button",{className:p,onClick:v,children:(0/* SlMenu */,L.jsx)(m.RAm,{className:x})}),!n&&(0,L.jsx)("div",{className:r()(f),onClick:v,onMouseDown:O/* onStopPropagation */._v,onTouchStart:O/* onStopPropagation */._v}),(0,L.jsx)(A.animated.div,{className:r()(b),style:d,children:(0,L.jsxs)("div",{className:r()(g,"d-flex flex-column h-100"),children:[(0,L.jsx)("button",{className:u,onClick:v,children:(0/* SlClose */,L.jsx)(m.ipV,{className:x})}),(0,L.jsxs)("div",{className:"mb-3",children:[(0,L.jsxs)("div",{className:"m-3 text-center",children:[(0,L.jsxs)("h4",{className:"fw-bolder m-0",children:["IMC ",t.year]}),(0,L.jsx)("small",{className:"m-0",children:"ADMIN AREA"})]}),D.map((e=>{const t=o.pathname.startsWith(e.link)||e.subLinks&&e.subLinks.some((e=>o.pathname.startsWith(e.link)));if(!e.hideFromMenu)
