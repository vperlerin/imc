...
const p=({workshopId:e})=>{const[t,s]=(0,n.useState)(""),[p,m]=(0,n.useState)("all"),[u,f]=(0,n.useState)(null),[g,x]=(0,n.useState)("asc"),{participants:j,loading:w}=(e=>{const[t,s]=(0,n.useState)([]),[a,i]=(0,n.useState)(!0),[r,o]=(0,n.useState)(null);// Re-fetch when workshopId changes
return(0,n.useEffect)((()=>{if(!e)return i(!1),void o("Workshop ID is required.");(async()=>{try{const t=await(0,l/* retry */.L)((()=>c/* default */.A.get("https://imc2026.imo.net/php/api/get_workshops_participants.php",{params:{workshop_id:e}})));if(!t.data.success||!Array.isArray(t.data.data))throw new Error(t.data.message||"Database access error, please try again.");s(t.data.data)}catch(e){o(e.message||"Failed to fetch participants. Please refresh the page.")}finally{i(!1)}})()}),[e]),{participants:t,loading:a,error:r,setParticipants:s}})(e),{workshops:_,loading:k}=(0,o/* useApiSpecificData */.Q)(),y="last_name",S=_?.find((t=>t.id===String(e))),v=[{url:"/admin/participants/workshops/",name:`${S?S.title:"Workshop"} Participants`}],N=e=>{u===e?x("asc"===g?"desc":"asc"):(f(e),x("asc"))};
