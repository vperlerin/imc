...
const D=parseInt(u,10)||250,R=({cd:e})=>{const[n,i]=(0,L.useState)(!1),[s,t]=(0,L.useState)(!0),l=(0,S/* useDispatch */.wA)(),a=(0,O/* useLocation */.zy)(),r=(0,O/* useNavigate */.Zp)(),c=(0/* authSelectors */,S/* useSelector */.d4)(I.Pg.isAdmin),d=(0/* authSelectors */,S/* useSelector */.d4)(I.Pg.isLoc),u=(0/* authSelectors */,S/* useSelector */.d4)(I.Pg.isSoc),[j,_]=(0,E.useSpring)((()=>({right:-D,config:{tension:350,friction:30}})));(0,L.useEffect)((()=>(n?(t(!1),_.start({right:0}),document.body.classList.add("overflow-hidden"),document.documentElement.classList.add("overflow-hidden")):(_.start({right:-D,onRest:()=>t(!0)}),document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")),()=>{document.body.classList.remove("overflow-hidden"),document.documentElement.classList.remove("overflow-hidden")})),[n,_]),(0,L.useEffect)((()=>{const e=()=>{i(!1)};return window.addEventListener("resize",e),()=>{window.removeEventListener("resize",e)}}),[]);const k=()=>{i((e=>!e))},N=e=>{r(e),k()};
return(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)("button",{className:x,onClick:k,children:(0/* SlMenu */,M.jsx)(m.RAm,{className:h})}),!s&&(0,M.jsx)("div",{className:o()(f),onClick:k,onMouseDown:T/* onStopPropagation */._v,onTouchStart:T/* onStopPropagation */._v}),(0,M.jsx)(E.animated.div,{className:o()(b),style:j,children:(0,M.jsxs)("div",{className:o()(g,"d-flex flex-column h-100"),children:[(0,M.jsx)("button",{className:p,onClick:k,children:(0/* SlClose */,M.jsx)(m.ipV,{className:h})}),(0,M.jsxs)("div",{className:"mb-3",children:[(0,M.jsxs)("div",{className:"m-3 text-center",children:[(0,M.jsxs)("h4",{className:"fw-bolder m-0",children:["IMC ",e.year]}),(0,M.jsx)("small",{className:"m-0",children:"ADMIN AREA"})]}),z.map((e=>{const n=a.pathname.startsWith(e.link)||e.subLinks&&e.subLinks.some((e=>a.pathname.startsWith(e.link)));return c||d&&e?.allowed?.includes("loc")||u&&e?.allowed?.includes("soc")?// Hide the menu item if not allowed 
...
// extracted by mini-css-extract-plugin
/* harmony default export */const V="breadcrumb-module__nav--atkeN",B=({links:e=[]})=>(0/* authSelectors */,S/* useSelector */.d4)(I.Pg.isAdmin)?(0,M.jsx)("nav",{"aria-label":"breadcrumb",className:V,children:(0,M.jsxs)("ol",{className:o()("breadcrumb"),children:[(0,M.jsx)("li",{className:"breadcrumb-item lh-0",children:(0/* Link */,M.jsx)(P.N_,{to:"/admin/dashboard",children:(0/* IoHomeOutline */,M.jsx)(H.M14,{className:"me-1"})})}),e.map(((n,i)=>(0,M.jsx)("li",{className:o()("breadcrumb-item",{active:i===e.length-1}),"aria-current":i===e.length-1?"page":void 0,children:i===e.length-1?(0,M.jsx)("b",{children:n.name}):(0/* Link */,M.jsx)(P.N_,{to:n.url,children:n.name})},i)))]})}):null,U=({breadcrumb:e=[],title:n="",rightContent:i,children:a,isMaxWidth:r=!0})=>{const c=n?`${n} | ${q/* conferenceData */.p.name_display} ${q/* conferenceData */.p.year}`:`${q/* conferenceData */.p.name_display} ${q/* conferenceData */.p.year}`;
return(0,M.jsxs)(M.Fragment,{children:[(0/* Helmet */,M.jsxs)(F.mg,{children:[(0,M.jsx)("title",{children:c}),(0,M.jsx)("meta",{name:"robots",content:"noindex"})]}),(0,M.jsxs)("div",{className:o()(s,"position-relative"),children:[(0,M.jsx)(W,{}),(0,M.jsxs)("div",{className:"d-flex flex-row",children:[(0,M.jsx)(R,{cd:q/* conferenceData */.p}),(0,M.jsxs)("div",{className:o()("mx-md-4 my-3 h-100 flex-grow-1 d-flex flex-column px-3 px-md-0",{[`${l} mx-md-auto`]:r}),children:[0!==e.length&&(0,M.jsx)(B,{links:e}),(!!n||!!i)&&(0,M.jsxs)("div",{className:o()("d-flex justify-content-between align-items-center",t),children:[n&&(0,M.jsx)("h2",{children:n}),i&&(0,M.jsx)("div",{children:i})]}),a]})]})]})]})}}
/***/,
/***/7762:
/***/(e,n,i)=>{
// EXPORTS
