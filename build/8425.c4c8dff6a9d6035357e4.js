...
const d=e=>{let{participants:t,withActions:n=!0,customActions:a=null,onDelete:d=null}=e;const[m,h]=(0,o.useState)(null),[u,x]=(0,o.useState)("asc"),p=e=>{m===e?x("asc"===u?"desc":"asc"):(h(e),x("asc"))},_=[...t].sort(((e,t)=>{if(!m)return 0;let n=e[m],s=t[m];
