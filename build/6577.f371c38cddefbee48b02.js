...
const T=({isCurOnline:e=!1})=>{const{participantId:t,tab:n}=(0,u/* useParams */.g)(),[i,T]=(0,d.useState)(""),[D,S]=(0,d.useState)(!1),[M,L]=(0,d.useState)(null),[E,I]=(0,d.useState)(!1),[O,F]=(0,d.useState)(0),[P,V]=(0,d.useState)(0),[U,z]=(0,d.useState)(!1),Z=n||"identity",W=(0,u/* useNavigate */.Zp)();(0,m/* useBlockNavigation */.V)(E);const{workshops:q,paymentMethods:B,registrationTypes:Y,loading:R,sessions:H,error:G}=(0,x/* useApiSpecificData */.Q)(),{participant:J,loading:Q,error:X}=(0,b/* useApiParticipant */.D)(t,e,U,!0),{control:K,register:ee,handleSubmit:te,getValues:ne,setValue:ie,formState:{errors:ae},reset:se,trigger:re,watch:oe}=(0,p/* useForm */.mN)(),le="1"===J?.participant?.is_online,ce=R||Q||D,de=[i,X,G].filter(Boolean);
// Paypal fess
// Paypal fess
(0,d.useEffect)((()=>{V(P)}),[P]),
// Detect form changes
// Detect form changes
(0,d.useEffect)((()=>{const e=oe((()=>{I(!0)}));return()=>e.unsubscribe()}),[oe]),(0,d.useEffect)((()=>{const e=Number.isInteger(Number(t))&&Number(t)>0;!n&&e&&W(`/admin/participants/onsite/edit/${t}/summary`,{replace:!0})}),[n,t,W]),(0,d.useEffect)((()=>{if(!J||0===H.length)return;const{participant:e,workshops:t,arrival:n,contributions:i,accommodation:a,extra_options:s}=J||{},r={},o=e?.dob;if(o){const[e,t,n]=o.split("-");r.dobDay=String(Number(n)),r.dobMonth=String(Number(t)),r.dobYear=e}
// ----- other participant fields
e&&Object.entries(e).forEach((([e,t])=>{"dob"!==e&&null!=t&&(r[e]=t)})),
// ----- boolean mapping
void 0!==e?.can_be_public&&(r.can_be_public=Boolean(Number(e.can_be_public))),
// ----- workshops
Array.isArray(t)&&(r.workshops=t.map((e=>String(e.id)))),
// ----- arrival
n&&Object.entries(n).forEach((([e,t])=>{null!=t&&(r[e]=e.includes("hour")||e.includes("minute")?String(t).padStart(2,"0"):t)}));
// ----- contributions
const l=(i||[]).filter((e=>"talk"===e.type)).map((e=>({...e}))),c=(i||[]).filter((e=>"poster"===e.type)).map((e=>({...e})));r.talks=l,r.posters=c,r.wantsToContribute=l.length>0||c.length>0?"true":"false",
// ----- accommodation
a?.registration_type_id&&(r.registration_type_id=String(a.registration_type_id)),
// ----- extras
s&&(r.excursion="0"===s.excursion?"false":"true",r.buy_tshirt="0"===s.buy_tshirt?"false":"true",r.tshirt_size=s.tshirt_size||""),se(r,{keepDirty:!1,keepTouched:!1}),I(!1)}),[J,H,se]);const me=[{url:"/admin/participants/"+(le?"online":"onsite"),name:le?"Online Participants":"On-site Participants"},{url:`/admin/participants/${le?"online":"onsite"}/${t}/${Z}`,name:`${J?.participant?.first_name?J.participant.first_name.charAt(0).toUpperCase()+J.participant.first_name.slice(1):"Participant"} \n        ${J?.participant?.last_name||""} - \n        ${Z.charAt(0).toUpperCase()+Z.slice(1)}`}],ue=J&&B.length>0&&q.length>0&&Y.length>0,pe=!!J?.participant?.admin_notes;
return(0/* default */,$.jsxs)(l.A,{breadcrumb:me,isMaxWidth:!0,children:[(0,$.jsxs)("div",{className:"position-relative fw-bolder",children:[ce&&(0/* default */,$.jsx)(c.A,{}),de.length>0&&(0,$.jsx)("div",{className:"alert alert-danger fw-bolder",children:(0,$.jsx)("ul",{className:"mb-0",children:de.map(((e,t)=>(0,$.jsx)("li",{children:e},t)))})}),M&&!ce&&(0,$.jsx)("div",{className:"alert alert-success",children:M})]}),J&&ue&&!ce&&(0,$.jsxs)("form",{onSubmit:te((async e=>{S(!0),T(null),L(null);// Triggers validation on all fields
if(!await re())return S(!1),void T("Please fill in all required fields.");e.talks=ne("talks")||[],e.posters=ne("posters")||[];const n={...e,total_due:O,paypal_fee:P};try{const e=await o/* default */.A.post(`https://imc2026.imo.net/php/admin/api/update_${le?"online":"onsite"}_participant.php?id=${t}`,n,{headers:{"Content-Type":"application/json"}});if(!e.data.success)throw new Error(e.data.message||"Failed to update participant.");z((e=>!e)),L("Participant updated successfully!")}catch(e){T(e.message)}finally{S(!1)}})),children:[(0,$.jsx)("ul",{className:a()("nav nav-tabs mb-3 mt-2",r/* default */.A.tab,"flex-column flex-sm-row"),children:[{key:"summary",label:"Billing"},{key:"identity",label:"Identity"},{key:"workshops",label:"Workshops"},...le?[]:[{key:"arrival",label:"Arrival"}],{key:"contribution",label:"Contribution"},...le?[{key:"accommodation",label:"Pay. Method"}]:[{key:"accommodation",label:"Acc. & Pay. Method"}],...le?[]:[{key:"extras",label:"Extras"}],{key:"comments",label:"Comments"},{key:"admin_notes",label:"Marc's notes"}].map((({key:e,label:n})=>(0,$.jsx)("li",{className:"nav-item",children:(0,$.jsx)("a",{className:a()("nav-link",Z===e&&r/* default */.A.active),href:`/admin/participants/onsite/edit/${t}/${e}`,onClick:n=>{n.preventDefault(),W(`/admin/participants/onsite/edit/${t}/${e}`)},children:pe&&"admin_notes"===e?(0,$.jsxs)("span",{className:"position-relative",children:[(0,$.jsx)("span",{className:"position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger",children:"!"}),n]}):(0,$.jsx)($.Fragment,{children:n})})},e)))}),(0,$.jsxs)("div",{className:a()("tab-content mx-auto",r/* default */.A.contentMxw),children:["identity"===n&&(0,$.jsxs)($.Fragment,{children:[(0/* default */,$.jsx)(g.A,{isAdmin:!0,isOnline:le,register:ee,errors:ae,setValue:ie,trigger:re}),(0/* default */,$.jsx)(y.A,{isAdmin:!0,register:ee,setValue:ie,errors:ae,trigger:re,initialData:J?.participant,watch:oe})]}),"workshops"===n&&(0/* default */,$.jsx)(w.A,{isAdmin:!0,isOnline:le,conferenceData:h/* conferenceData */.p,register:ee,errors:ae,setValue:ie,trigger:re,watch:oe,workshops:q}),"arrival"===n&&!le&&(0/* default */,$.jsx)(_.A,{isAdmin:!0,conferenceData:h/* conferenceData */.p,register:ee,errors:ae,setValue:ie,trigger:re}),"contribution"===n&&(0/* default */,$.jsx)(v.A,{isAdmin:!0,isOnline:le,conferenceData:h/* conferenceData */.p,control:K,register:ee,errors:ae,getValues:ne,setValue:ie,watch:oe,trigger:re,sessions:H}),"accommodation"===n&&(0/* default */,$.jsx)(j.A,{isAdmin:!0,isOnline:le,isEarlyBird:1===J?.participant.is_early_bird||"1"===J?.participant.is_early_bird,conferenceData:h/* conferenceData */.p,control:K,register:ee,errors:ae,paymentMethods:B,setValue:ie,registrationTypes:Y,trigger:re}),"extras"===n&&!le&&(0/* default */,$.jsx)(N.A,{isAdmin:!0,conferenceData:h/* conferenceData */.p,register:ee,errors:ae,getValues:ne,setValue:ie,trigger:re,watch:oe,control:K}),"comments"===n&&(0,$.jsx)("div",{className:a()(s,"mx-auto"),children:(0/* default */,$.jsx)(k.A,{isAdmin:!0,isOnline:le,register:ee,errors:ae,setValue:ie,trigger:re})}),(0,$.jsxs)("div",{className:a()(s,"mx-auto","summary"===n&&ue?"visible":"invisible h-0 w-0 overflow-hidden"),children:[(0,$.jsxs)("div",{className:"d-flex mt-3 align-items-center justify-content-between w-100 mb-3",children:[(0,$.jsxs)("div",{children:[(0,$.jsxs)("strong",{children:[J?.participant?.first_name?J.participant.first_name.charAt(0).toUpperCase()+J.participant.first_name.slice(1):""," ",J?.participant?.last_name||""]})," ","1"===J.participant.confirmation_sent?(0,$.jsxs)($.Fragment,{children:["has been confirmed on ",(0,$.jsx)("span",{className:"text-success",children:J.participant.confirmation_date&&(0,C/* formatFullDate */.Lu)(J.participant.confirmation_date)})]}):(0,$.jsx)($.Fragment,{children:"❌  has NOT been confirmed yet."})]}),"1"!==J.participant.confirmation_sent&&(0,$.jsx)("div",{children:(0/* Link */,$.jsx)(f.N_,{className:"btn btn-outline-success fw-bolder",to:`/admin/participants/${le?"online":"onsite"}/payment/${t}`,children:"Go to Payments to confirm"})})]}),(0/* default */,$.jsx)(A.A,{isAdmin:!0,isOnline:le,isEarlyBird:1===J?.participant.is_early_bird||"1"===J?.participant.is_early_bird,conferenceData:h/* conferenceData */.p,getValues:ne,setValue:ie,setTotal:F,setPaypalFee:V,workshops:q,registrationTypes:Y,paymentMethods:B,watch:oe})]}),"admin_notes"===n&&(0,$.jsxs)("div",{className:a()(s,"mx-auto mb-3"),children:[(0,$.jsx)("label",{htmlFor:"admin_notes",className:"form-label fw-bold",children:"Admin Notes"}),(0,$.jsx)("textarea",{id:"admin_notes",className:"form-control",placeholder:"Enter your admin notes here",rows:6,...ee("admin_notes")}),ae.admin_notes&&(0,$.jsx)("div",{className:"text-danger mt-1",children:ae.admin_notes.message})]}),(0,$.jsx)("div",{className:"mt-4 d-flex justify-content-end",children:(0,$.jsx)("button",{type:"submit",className:"btn btn-outline-primary fw-bolder",disabled:D,children:D?"Saving...":"Save Changes"})})]})]})]})};
...
var D=n(8983),S=n(1448),M=n(8321),L=n(7767),E=n(4976);
