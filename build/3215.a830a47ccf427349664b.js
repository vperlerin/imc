...
/* harmony export */});
/* harmony import */var n=a(578),s=a(6942),l=a.n(s),i=a(4178),r=a(7647),c=a(6645),o=a(6540),d=a(408),m=a(3388),h=a(7806),u=a(7767),p=a(8057),x=a(4848);
/* harmony import */const f=()=>{const{tab:e}=(0,u/* .useParams */.g)(),[t,a]=(0,o.useState)(e||"unconfirmed"),[s,f]=(0,o.useState)([]),[j,b]=(0,o.useState)(""),[N,g]=(0,o.useState)("last_name"),[y,_]=(0,o.useState)(null),[w,C]=(0,o.useState)(!1),[v,D]=(0,o.useState)(!1),[k,$]=(0,o.useState)(""),[S,F]=(0,o.useState)(""),A=(0,u/* .useNavigate */.Zp)(),{participants:T,loading:U,error:P,setParticipants:E}=(0,m/* .useApiOnsiteParticipants */.E)(!1,!0),{deleteParticipant:L,errorDelete:Z,isDeleting:I}=(0,h/* .useApiDeleteParticipant */.A)(E,f);

(0,o.useEffect)((()=>{a(e||"unconfirmed")}),[e]),(0,o.useEffect)((()=>{const e=T.filter((e=>"confirmed"===t?"1"===e.confirmation_sent&&"cancelled"!==e.status:"cancelled"===t?"cancelled"===e.status:"1"!==e.confirmation_sent&&"cancelled"!==e.status));if(j){const t=j.toLowerCase();f(e.filter((e=>(e[N]?String(e[N]).toLowerCase():"").includes(t))))}else f(e)}),[j,N,T,t]);
// Calculate totals
const M=T.filter((e=>"cancelled"===e.status)).length,R=T.filter((e=>"1"===e.confirmation_sent&&"cancelled"!==e.status)).length,Y=T.filter((e=>"1"!==e.confirmation_sent&&"cancelled"!==e.status)).length,H=async e=>{if(y)try{const t=await L(y,e);t?.data?.success?($(t.data.message||"Participant deleted successfully!"),F("")):F(t?.data?.message||"Impossible to delete the participant for now, please try again later.")}catch(e){F("An unexpected error occurred while deleting the participant.")}finally{
// Close the correct modal depending on type
"soft"===e?C(!1):D(!1),_(null)}};
return(0/* ["default"] */,x.jsxs)(r.A,{breadcrumb:[{url:"/admin/participants/onsite",name:"On-site Participants"}],isMaxWidth:!0,title:"ON-SITE Participants",rightContent:(0,x.jsx)(x.Fragment,{children:(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)("strong",{children:"Confirmed:"})," ",(0,x.jsx)("strong",{className:"text-success",children:R})," ","| ",(0,x.jsx)("strong",{children:"Unconfirmed:"})," ",(0,x.jsx)("strong",{className:"text-warning",children:Y})," ","| ",(0,x.jsx)("strong",{children:"Cancelled:"})," ",(0,x.jsx)("strong",{className:"text-danger",children:M})," ","| ",(0,x.jsx)("strong",{children:"Total:"})," ",(0,x.jsx)("strong",{children:T.length})]})}),children:[S&&(0,x.jsx)("div",{className:"alert alert-danger fw-bolder",children:S}),k&&(0,x.jsx)("div",{className:"alert alert-success fw-bolder",children:k}),P&&(0,x.jsx)("p",{className:"alert alert-danger fw-bolder",children:P}),U||I?(0/* ["default"] */,x.jsx)(c.A,{}):(0,x.jsxs)(x.Fragment,{children:[Z&&(0,x.jsx)("p",{className:"alert alert-danger",children:Z}),(0,x.jsxs)("div",{className:"d-flex flex-column flex-md-row gap-2 mb-3",children:[(0,x.jsxs)("select",{className:"form-select w-auto",value:N,onChange:e=>g(e.target.value),children:[(0,x.jsx)("option",{value:"last_name",children:"Search by Last Name"}),(0,x.jsx)("option",{value:"email",children:"Search by Email"})]}),(0,x.jsxs)("div",{className:"position-relative w-auto",children:[(0,x.jsx)("input",{type:"text",className:"form-control pe-5",placeholder:`Enter ${N.replace("_"," ")}`,value:j,onChange:e=>b(e.target.value)}),(0/* .CiSearch */,x.jsx)(d.Xj1,{className:"position-absolute top-50 end-0 translate-middle-y me-2"})]}),(0/* ["default"] */,x.jsx)(p.A,{className:"ms-auto",link:"https://imc2025.imo.net/php/doc_participants.php"})]}),(0,x.jsxs)("ul",{className:l()("nav nav-tabs mb-3 mt-2",i/* ["default"] */.A.tab,"flex-column flex-sm-row w-100"),children:[(0,x.jsx)("li",{className:"nav-item",children:(0,x.jsxs)("a",{className:`nav-link ${"unconfirmed"===t?i/* ["default"] */.A.active:""}`,href:"/admin/participants/onsite",onClick:e=>{e.preventDefault(),A("/admin/participants/onsite")},children:["Unconfirmed",(0,x.jsx)("span",{className:"badge text-bg-warning ms-2",children:Y})]})}),(0,x.jsx)("li",{className:"nav-item",children:(0,x.jsxs)("a",{className:`nav-link ${"confirmed"===t?i/* ["default"] */.A.active:""}`,href:"/admin/participants/onsite/confirmed",onClick:e=>{e.preventDefault(),A("/admin/participants/onsite/confirmed")},children:["Confirmed",(0,x.jsx)("span",{className:"badge text-bg-success ms-2",children:R})]})}),(0,x.jsx)("li",{className:"nav-item",children:(0,x.jsxs)("a",{className:`nav-link ${"cancelled"===t?i/* ["default"] */.A.active:""}`,href:"/admin/participants/onsite/cancelled",onClick:e=>{e.preventDefault(),A("/admin/participants/onsite/cancelled")},children:["Cancelled",(0,x.jsx)("span",{className:"badge text-bg-danger ms-2",children:M})]})})]}),(0/* ["default"] */,x.jsx)(n.A,{participants:s,onDelete:e=>{_(e),C(!0)}})]}),(w||v)&&(0,x.jsx)("div",{className:"modal-backdrop fade show"}),w&&y&&(0,x.jsx)("div",{className:"modal show d-block",children:(0,x.jsx)("div",{className:"modal-dialog",children:(0,x.jsxs)("div",{className:"modal-content",children:[(0,x.jsxs)("div",{className:"modal-header",children:[(0,x.jsx)("h5",{className:"modal-title",children:"Cancel Registration"}),(0,x.jsx)("button",{type:"button",className:"btn-close",onClick:()=>C(!1)})]}),(0,x.jsx)("div",{className:"modal-body",children:(0,x.jsxs)(x.Fragment,{children:[(0,x.jsxs)("p",{children:["Are you sure you want to cancel ",(0,x.jsxs)("b",{children:[y.first_name," ",y.last_name]}),"'s registration?"]}),(0,x.jsx)("p",{children:(0,x.jsx)("strong",{children:"Choose:"})}),(0,x.jsxs)("ul",{children:[(0,x.jsxs)("li",{children:[(0,x.jsx)("strong",{className:"text-warning",children:"Soft Delete:"})," Keeps record but marks as 'cancelled' - so we can keep track of the reimbursement."]}),(0,x.jsxs)("li",{children:[(0,x.jsx)("strong",{className:"text-danger",children:"Hard Delete:"})," Permanently removes data."]})]})]})}),(0,x.jsxs)("div",{className:"modal-footer",children:[(0,x.jsx)("button",{className:"btn btn-outline-secondary fw-bolder",onClick:()=>C(!1),children:"Cancel"}),(0,x.jsx)("button",{className:"btn btn-outline-warning fw-bolder",onClick:()=>H("soft"),children:"Soft Delete"}),(0,x.jsx)("button",{className:"btn btn-outline-danger fw-bolder ms-auto",onClick:()=>{C(!1),D(!0)},children:"Hard Delete"})]})]})})}),v&&(0,x.jsx)("div",{className:"modal show d-block",children:(0,x.jsx)("div",{className:"modal-dialog",children:(0,x.jsxs)("div",{className:"modal-content",children:[(0,x.jsxs)("div",{className:"modal-header",children:[(0,x.jsx)("h5",{className:"modal-title",children:"Confirm Permanent Deletion"}),(0,x.jsx)("button",{type:"button",className:"btn-close",onClick:()=>D(!1)})]}),(0,x.jsx)("div",{className:"modal-body",children:(0,x.jsxs)("p",{children:[(0,x.jsx)("strong",{children:"Are you absolutely sure?"})," This action cannot be undone."]})}),(0,x.jsxs)("div",{className:"modal-footer",children:[(0,x.jsx)("button",{className:"btn btn-outline-danger  fw-bolder",onClick:()=>{H("hard"),D(!1)},children:"Yes, Delete"}),(0,x.jsx)("button",{className:"btn btn-outline-secondary fw-bolder",onClick:()=>D(!1),children:"No"})]})]})})})]})};
/* harmony default export */}
/***/,
/***/3318:
/***/(e,t,a)=>{
