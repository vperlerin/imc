...
/* harmony export */});const s=(e,{interval:a=1e3,retries:t=6}={})=>new Promise(((r,o)=>{e().then(r).catch((l=>{setTimeout((()=>{t?s(e,{interval:1.5*a,retries:t-1}).then(r,o):o(l)}),a)}))}));
/***/},
/***/5071:
/***/(e,a,t)=>{
// ESM COMPAT FLAG
