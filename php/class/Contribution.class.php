...
class ContributionManager {
    ...
    public function saveContributions($participantId, $talks, $posters) {
        foreach ($talks as $talk) {
            ...
            ")->execute([
                $participantId, $talk['title'], $talk['authors'], $talk['abstract'], $talk['session'], $talk['duration'], $talk['paperDate']
            ]);
        }
        ...
        foreach ($posters as $poster) {
            ...
            ")->execute([
                $participantId, $poster['title'], $poster['authors'], $poster['abstract'], $poster['session'], $poster['paperDate']
            ]);
        }
    }
}
